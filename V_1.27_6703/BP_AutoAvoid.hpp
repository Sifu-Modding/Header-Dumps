#ifndef UE4SS_SDK_BP_AutoAvoid_HPP
#define UE4SS_SDK_BP_AutoAvoid_HPP

class UBP_AutoAvoid_C : public UBP_GameplayCheatMaster_C
{
    ...
    void ExecuteUbergraph_BP_AutoAvoid(int32 EntryPoint);
}; // Size: 0x48
