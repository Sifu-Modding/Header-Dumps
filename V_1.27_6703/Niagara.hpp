...
{
    class UNiagaraComponent* NiagaraComponent;                                        // 0x02B0 (size: 0x8)
    uint8 bDestroyOnSystemFinish;                                                     // 0x02B8 (size: 0x1)
...
{
    class UNiagaraSystem* System;                                                     // 0x02B0 (size: 0x8)
    ENiagaraPreviewGridResetMode ResetMode;                                           // 0x02B8 (size: 0x1)
    class UNiagaraPreviewAxis* PreviewAxisX;                                          // 0x02C0 (size: 0x8)
    class UNiagaraPreviewAxis* PreviewAxisY;                                          // 0x02C8 (size: 0x8)
    TSubclassOf<class ANiagaraPreviewBase> PreviewClass;                              // 0x02D0 (size: 0x8)
    float SpacingX;                                                                   // 0x02D8 (size: 0x4)
    float SpacingY;                                                                   // 0x02DC (size: 0x4)
    int32 NumX;                                                                       // 0x02E0 (size: 0x4)
    int32 NumY;                                                                       // 0x02E4 (size: 0x4)
    TArray<class UChildActorComponent*> PreviewComponents;                            // 0x02E8 (size: 0x10)
...
{
    class UNiagaraSystem* Asset;                                                      // 0x0490 (size: 0x8)
    ENiagaraTickBehavior TickBehavior;                                                // 0x0498 (size: 0x1)
    FNiagaraUserRedirectionParameterStore OverrideParameters;                         // 0x04A0 (size: 0xC8)
    uint8 bForceSolo;                                                                 // 0x0568 (size: 0x1)
    uint8 bEnableGpuComputeDebug;                                                     // 0x0568 (size: 0x1)
    uint8 bAutoDestroy;                                                               // 0x0594 (size: 0x1)
    uint8 bRenderingEnabled;                                                          // 0x0594 (size: 0x1)
    uint8 bAutoManageAttachment;                                                      // 0x0594 (size: 0x1)
    uint8 bAutoAttachWeldSimulatedBodies;                                             // 0x0594 (size: 0x1)
    float MaxTimeBeforeForceUpdateTransform;                                          // 0x0598 (size: 0x4)
    TArray<FNiagaraMaterialOverride> EmitterMaterials;                                // 0x05A0 (size: 0x10)
    FNiagaraComponentOnSystemFinished OnSystemFinished;                               // 0x05B8 (size: 0x10)
    void OnNiagaraSystemFinished(class UNiagaraComponent* PSystem);
    TWeakObjectPtr<class USceneComponent> AutoAttachParent;                           // 0x05C8 (size: 0x8)
    FName AutoAttachSocketName;                                                       // 0x05D0 (size: 0x8)
    EAttachmentRule AutoAttachLocationRule;                                           // 0x05D8 (size: 0x1)
    EAttachmentRule AutoAttachRotationRule;                                           // 0x05D9 (size: 0x1)
    EAttachmentRule AutoAttachScaleRule;                                              // 0x05DA (size: 0x1)
