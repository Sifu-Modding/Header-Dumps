...
{
    class UWidgetAnimation* RiseAgeAnimFade;                                          // 0x0398 (size: 0x8)
    class UWidgetAnimation* RiseAgeAnim;                                              // 0x03A0 (size: 0x8)
    class UWidgetAnimation* ReduceAgeAnim;                                            // 0x03A8 (size: 0x8)
    class UTextBlock* AgeDeathTxt;                                                    // 0x03B0 (size: 0x8)
    class UProgressBar* AgePercent;                                                   // 0x03B8 (size: 0x8)
    class UTextBlock* ChineseTxt;                                                     // 0x03C0 (size: 0x8)
    class UImage* LineBottom;                                                         // 0x03C8 (size: 0x8)
    class UImage* LineBottom_Shadow;                                                  // 0x03D0 (size: 0x8)
    class UImage* LineTop;                                                            // 0x03D8 (size: 0x8)
    class UImage* LineTop_Shadow;                                                     // 0x03E0 (size: 0x8)
    class UTextBlock* NextAgeText;                                                    // 0x03E8 (size: 0x8)
    class UTextBlock* PreviousAgeText;                                                // 0x03F0 (size: 0x8)
    FText PreviousAge;                                                                // 0x03F8 (size: 0x18)
    FText CurrentAge;                                                                 // 0x0410 (size: 0x18)
    bool InDeath;                                                                     // 0x0428 (size: 0x1)
    bool bOverrideColor;                                                              // 0x0429 (size: 0x1)
    bool bBlack;                                                                      // 0x042A (size: 0x1)
    bool bEstheticOnly;                                                               // 0x042B (size: 0x1)
    bool bAlwaysShow;                                                                 // 0x042C (size: 0x1)
    int32 StoredPreviousAge;                                                          // 0x0430 (size: 0x4)
    int32 StoredNextAge;                                                              // 0x0434 (size: 0x4)
    bool Temp_bool_Variable;                                                          // 0x0438 (size: 0x1)
    FBP_HUD_Age_CK2Node_CreateDelegate_OutputDelegate K2Node_CreateDelegate_OutputDelegate; // 0x043C (size: 0x10)
    ...
    bool K2Node_Event_IsDesignTime;                                                   // 0x044C (size: 0x1)
    EGameOptionTypes K2Node_CustomEvent_eGameOptionType;                              // 0x044D (size: 0x1)
    bool K2Node_Select_Default;                                                       // 0x044E (size: 0x1)
