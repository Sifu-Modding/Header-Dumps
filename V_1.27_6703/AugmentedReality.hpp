...
{
    int32 BufferSizePerChunk;                                                         // 0x03A0 (size: 0x4)
...
{
    TArray<uint8> PreviewImageData;                                                   // 0x0320 (size: 0x10)
    TArray<uint8> ARWorldData;                                                        // 0x0330 (size: 0x10)
    int32 PreviewImageBytesTotal;                                                     // 0x0340 (size: 0x4)
    int32 ARWorldBytesTotal;                                                          // 0x0344 (size: 0x4)
    int32 PreviewImageBytesDelivered;                                                 // 0x0348 (size: 0x4)
    int32 ARWorldBytesDelivered;                                                      // 0x034C (size: 0x4)
...
{
    class UAREnvironmentCaptureProbe* CaptureProbe;                                   // 0x02C0 (size: 0x8)
...
{
    FGuid NativeID;                                                                   // 0x0208 (size: 0x10)
    bool bUseDefaultReplication;                                                      // 0x0248 (size: 0x1)
    class UMaterialInterface* DefaultMeshMaterial;                                    // 0x0250 (size: 0x8)
    class UMaterialInterface* DefaultWireframeMeshMaterial;                           // 0x0258 (size: 0x8)
    class UMRMeshComponent* MRMeshComponent;                                          // 0x0260 (size: 0x8)
    class UARTrackedGeometry* MyTrackedGeometry;                                      // 0x0268 (size: 0x8)
...
{
    EARTextureType TextureType;                                                       // 0x0138 (size: 0x1)
    float Timestamp;                                                                  // 0x013C (size: 0x4)
    FGuid ExternalTextureGuid;                                                        // 0x0140 (size: 0x10)
    FVector2D Size;                                                                   // 0x0150 (size: 0x8)

}; // Size: 0x158

class UAREnvironmentProbeComponent : public UARComponent
{
    FAREnvironmentProbeUpdatePayload ReplicatedPayload;                               // 0x0290 (size: 0x30)
...
{
    EARFaceTransformMixing TransformSetting;                                          // 0x0288 (size: 0x1)
    bool bUpdateVertexNormal;                                                         // 0x0289 (size: 0x1)
    bool bFaceOutOfScreen;                                                            // 0x028A (size: 0x1)
    FARFaceUpdatePayload ReplicatedPayload;                                           // 0x0290 (size: 0x40)
...
{
    FARGeoAnchorUpdatePayload ReplicatedPayload;                                      // 0x0290 (size: 0x70)
...
{
    FARImageUpdatePayload ReplicatedPayload;                                          // 0x0290 (size: 0x60)
...
{
    FARLifeCycleComponentOnARActorSpawnedDelegate OnARActorSpawnedDelegate;           // 0x0208 (size: 0x10)
    void InstanceARActorSpawnedDelegate(UClass* ComponentClass, FGuid NativeID, class AARActor* SpawnedActor);
    FARLifeCycleComponentOnARActorToBeDestroyedDelegate OnARActorToBeDestroyedDelegate; // 0x0218 (size: 0x10)
...
{
    FARMeshUpdatePayload ReplicatedPayload;                                           // 0x0290 (size: 0x60)
...
{
    FARObjectUpdatePayload ReplicatedPayload;                                         // 0x0290 (size: 0x30)
...
{
    FARPlaneUpdatePayload ReplicatedPayload;                                          // 0x0290 (size: 0x80)
...
{
    FARPointUpdatePayload ReplicatedPayload;                                          // 0x0288 (size: 0x1)
...
{
    FARPoseUpdatePayload ReplicatedPayload;                                           // 0x0290 (size: 0x40)
...
{
    FARQRCodeUpdatePayload ReplicatedPayload;                                         // 0x0290 (size: 0x70)
...
{
    EARTextureType TextureType;                                                       // 0x00E0 (size: 0x1)
    float Timestamp;                                                                  // 0x00E4 (size: 0x4)
    FGuid ExternalTextureGuid;                                                        // 0x00E8 (size: 0x10)
    FVector2D Size;                                                                   // 0x00F8 (size: 0x8)

}; // Size: 0x100

class UARTextureCameraDepth : public UARTexture
{
    EARDepthQuality DepthQuality;                                                     // 0x0100 (size: 0x1)
    EARDepthAccuracy DepthAccuracy;                                                   // 0x0101 (size: 0x1)
    bool bIsTemporallySmoothed;                                                       // 0x0102 (size: 0x1)
...
{
    FARTrackableNotifyComponentOnAddTrackedGeometry OnAddTrackedGeometry;             // 0x00C0 (size: 0x10)
    void TrackableDelegate(class UARTrackedGeometry* TrackedGeometry);
    FARTrackableNotifyComponentOnUpdateTrackedGeometry OnUpdateTrackedGeometry;       // 0x00D0 (size: 0x10)
    void TrackableDelegate(class UARTrackedGeometry* TrackedGeometry);
    FARTrackableNotifyComponentOnRemoveTrackedGeometry OnRemoveTrackedGeometry;       // 0x00E0 (size: 0x10)
    void TrackableDelegate(class UARTrackedGeometry* TrackedGeometry);
    FARTrackableNotifyComponentOnAddTrackedPlane OnAddTrackedPlane;                   // 0x00F0 (size: 0x10)
    void TrackablePlaneDelegate(class UARPlaneGeometry* TrackedPlane);
    FARTrackableNotifyComponentOnUpdateTrackedPlane OnUpdateTrackedPlane;             // 0x0100 (size: 0x10)
    void TrackablePlaneDelegate(class UARPlaneGeometry* TrackedPlane);
    FARTrackableNotifyComponentOnRemoveTrackedPlane OnRemoveTrackedPlane;             // 0x0110 (size: 0x10)
    void TrackablePlaneDelegate(class UARPlaneGeometry* TrackedPlane);
    FARTrackableNotifyComponentOnAddTrackedPoint OnAddTrackedPoint;                   // 0x0120 (size: 0x10)
    void TrackablePointDelegate(class UARTrackedPoint* TrackedPoint);
    FARTrackableNotifyComponentOnUpdateTrackedPoint OnUpdateTrackedPoint;             // 0x0130 (size: 0x10)
    void TrackablePointDelegate(class UARTrackedPoint* TrackedPoint);
    FARTrackableNotifyComponentOnRemoveTrackedPoint OnRemoveTrackedPoint;             // 0x0140 (size: 0x10)
    void TrackablePointDelegate(class UARTrackedPoint* TrackedPoint);
    FARTrackableNotifyComponentOnAddTrackedImage OnAddTrackedImage;                   // 0x0150 (size: 0x10)
    void TrackableImageDelegate(class UARTrackedImage* TrackedImage);
    FARTrackableNotifyComponentOnUpdateTrackedImage OnUpdateTrackedImage;             // 0x0160 (size: 0x10)
    void TrackableImageDelegate(class UARTrackedImage* TrackedImage);
    FARTrackableNotifyComponentOnRemoveTrackedImage OnRemoveTrackedImage;             // 0x0170 (size: 0x10)
    void TrackableImageDelegate(class UARTrackedImage* TrackedImage);
    FARTrackableNotifyComponentOnAddTrackedFace OnAddTrackedFace;                     // 0x0180 (size: 0x10)
    void TrackableFaceDelegate(class UARFaceGeometry* TrackedFace);
    FARTrackableNotifyComponentOnUpdateTrackedFace OnUpdateTrackedFace;               // 0x0190 (size: 0x10)
    void TrackableFaceDelegate(class UARFaceGeometry* TrackedFace);
    FARTrackableNotifyComponentOnRemoveTrackedFace OnRemoveTrackedFace;               // 0x01A0 (size: 0x10)
    void TrackableFaceDelegate(class UARFaceGeometry* TrackedFace);
    FARTrackableNotifyComponentOnAddTrackedEnvProbe OnAddTrackedEnvProbe;             // 0x01B0 (size: 0x10)
    void TrackableEnvProbeDelegate(class UAREnvironmentCaptureProbe* TrackedEnvProbe);
    FARTrackableNotifyComponentOnUpdateTrackedEnvProbe OnUpdateTrackedEnvProbe;       // 0x01C0 (size: 0x10)
    void TrackableEnvProbeDelegate(class UAREnvironmentCaptureProbe* TrackedEnvProbe);
    FARTrackableNotifyComponentOnRemoveTrackedEnvProbe OnRemoveTrackedEnvProbe;       // 0x01D0 (size: 0x10)
    void TrackableEnvProbeDelegate(class UAREnvironmentCaptureProbe* TrackedEnvProbe);
    FARTrackableNotifyComponentOnAddTrackedObject OnAddTrackedObject;                 // 0x01E0 (size: 0x10)
    void TrackableObjectDelegate(class UARTrackedObject* TrackedObject);
    FARTrackableNotifyComponentOnUpdateTrackedObject OnUpdateTrackedObject;           // 0x01F0 (size: 0x10)
    void TrackableObjectDelegate(class UARTrackedObject* TrackedObject);
    FARTrackableNotifyComponentOnRemoveTrackedObject OnRemoveTrackedObject;           // 0x0200 (size: 0x10)
    void TrackableObjectDelegate(class UARTrackedObject* TrackedObject);
