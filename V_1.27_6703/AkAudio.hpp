...
{
    AkAcousticPortalState InitialState;                                               // 0x02E8 (size: 0x1)
    float ObstructionRefreshInterval;                                                 // 0x02EC (size: 0x4)
    TEnumAsByte<ECollisionChannel> ObstructionCollisionChannel;                       // 0x02F0 (size: 0x1)
...
{
    class UAkAudioEvent* AkAudioEvent;                                                // 0x02B0 (size: 0x8)
    class UAkComponent* AkComponent;                                                  // 0x02B8 (size: 0x8)
    bool StopWhenOwnerIsDestroyed;                                                    // 0x02C0 (size: 0x1)
    bool AutoPost;                                                                    // 0x02C1 (size: 0x1)
...
{
    uint8 bEnabled;                                                                   // 0x02E8 (size: 0x1)
    class UAkAuxBus* AuxBus;                                                          // 0x02F0 (size: 0x8)
    FString AuxBusName;                                                               // 0x02F8 (size: 0x10)
    float SendLevel;                                                                  // 0x0308 (size: 0x4)
    float FadeRate;                                                                   // 0x030C (size: 0x4)
    float Priority;                                                                   // 0x0310 (size: 0x4)
    class UAkLateReverbComponent* LateReverbComponent;                                // 0x0318 (size: 0x8)

}; // Size: 0x320

class AAkSpatialAudioVolume : public AVolume
{
    class UAkSurfaceReflectorSetComponent* SurfaceReflectorSet;                       // 0x02E8 (size: 0x8)
    class UAkLateReverbComponent* LateReverb;                                         // 0x02F0 (size: 0x8)
    class UAkRoomComponent* Room;                                                     // 0x02F8 (size: 0x8)

}; // Size: 0x300

class AAkSpotReflector : public AActor
{
    class UAkAuxBus* EarlyReflectionAuxBus;                                           // 0x02B0 (size: 0x8)
    FString EarlyReflectionAuxBusName;                                                // 0x02B8 (size: 0x10)
    class UAkAcousticTexture* AcousticTexture;                                        // 0x02C8 (size: 0x8)
    float DistanceScalingFactor;                                                      // 0x02D0 (size: 0x4)
    float Level;                                                                      // 0x02D4 (size: 0x4)
...
{
    TArray<class UAkAssetDataSwitchContainerData*> SwitchContainers;                  // 0x0078 (size: 0x10)
    class UAkGroupValue* DefaultGroupValue;                                           // 0x0088 (size: 0x8)
...
{
    TArray<class UAkMediaAsset*> MediaList;                                           // 0x0068 (size: 0x10)
...
class UAkAudioBank : public UAkAssetBase
{
    ...
    bool bIsLocalized;                                                                // 0x00F8 (size: 0x1)
    class UAkAssetPlatformData* CurrentLocalizedPlatformAssetData;                    // 0x0100 (size: 0x8)

}; // Size: 0x130

class UAkAudioEvent : public UAkAssetBase
{
    TMap<class FString, class TSoftObjectPtr<UAkAssetPlatformData>> LocalizedPlatformAssetDataMap; // 0x0050 (size: 0x50)
...
{
    float MaxAttenuationRadius;                                                       // 0x0090 (size: 0x4)
    bool IsInfinite;                                                                  // 0x0094 (size: 0x1)
    float MinimumDuration;                                                            // 0x0098 (size: 0x4)
    float MaximumDuration;                                                            // 0x009C (size: 0x4)
    TMap<class FString, class UAkAssetDataSwitchContainer*> LocalizedMedia;           // 0x00A0 (size: 0x50)
    TSet<UAkAudioEvent*> PostedEvents;                                                // 0x00F0 (size: 0x50)
    TSet<UAkAuxBus*> UserDefinedSends;                                                // 0x0140 (size: 0x50)
    TSet<UAkTrigger*> PostedTriggers;                                                 // 0x0190 (size: 0x50)
    TSet<UAkGroupValue*> GroupValues;                                                 // 0x01E0 (size: 0x50)
...
{
    ECheckBoxState CheckedState;                                                      // 0x04B8 (size: 0x1)
    FAkCheckBoxCheckedStateDelegate CheckedStateDelegate;                             // 0x04BC (size: 0x10)
    ECheckBoxState GetCheckBoxState();
    FCheckBoxStyle WidgetStyle;                                                       // 0x04D0 (size: 0x580)
    TEnumAsByte<EHorizontalAlignment> HorizontalAlignment;                            // 0x0A50 (size: 0x1)
    bool IsFocusable;                                                                 // 0x0A51 (size: 0x1)
    FAkBoolPropertyToControl ThePropertyToControl;                                    // 0x0A58 (size: 0x10)
    FAkWwiseItemToControl ItemToControl;                                              // 0x0A68 (size: 0x40)
    FAkCheckBoxAkOnCheckStateChanged AkOnCheckStateChanged;                           // 0x0AA8 (size: 0x10)
    void AkOnCheckBoxComponentStateChanged(bool bIsChecked);
    FAkCheckBoxOnItemDropped OnItemDropped;                                           // 0x0AB8 (size: 0x10)
    void OnWwiseItemDropDetected(FGuid ItemDroppedID);
    FAkCheckBoxOnPropertyDropped OnPropertyDropped;                                   // 0x0AC8 (size: 0x10)
...
class UAkComponent : public UAkGameObject
{
    ...
    class UAkAuxBus* EarlyReflectionAuxBus;                                           // 0x0238 (size: 0x8)
    FString EarlyReflectionAuxBusName;                                                // 0x0240 (size: 0x10)
    int32 EarlyReflectionOrder;                                                       // 0x0250 (size: 0x4)
    float EarlyReflectionBusSendGain;                                                 // 0x0254 (size: 0x4)
    float EarlyReflectionMaxPathLength;                                               // 0x0258 (size: 0x4)
    float roomReverbAuxBusGain;                                                       // 0x025C (size: 0x4)
    int32 diffractionMaxEdges;                                                        // 0x0260 (size: 0x4)
    int32 diffractionMaxPaths;                                                        // 0x0264 (size: 0x4)
    float diffractionMaxPathLength;                                                   // 0x0268 (size: 0x4)
    uint8 DrawFirstOrderReflections;                                                  // 0x026C (size: 0x1)
    uint8 DrawSecondOrderReflections;                                                 // 0x026C (size: 0x1)
    uint8 DrawHigherOrderReflections;                                                 // 0x026C (size: 0x1)
    uint8 DrawDiffraction;                                                            // 0x026C (size: 0x1)
    bool StopWhenOwnerDestroyed;                                                      // 0x0270 (size: 0x1)
    float AttenuationScalingFactor;                                                   // 0x0274 (size: 0x4)
    float OcclusionRefreshInterval;                                                   // 0x0278 (size: 0x4)
    bool bUseReverbVolumes;                                                           // 0x027C (size: 0x1)
    bool bUpdateReverbVolumesLocation;                                                // 0x027D (size: 0x1)
...
{
    AkMeshType MeshType;                                                              // 0x0208 (size: 0x1)
    int32 LOD;                                                                        // 0x020C (size: 0x4)
    float WeldingThreshold;                                                           // 0x0210 (size: 0x4)
    TMap<class UMaterialInterface*, class FAkGeometrySurfaceOverride> StaticMeshSurfaceOverride; // 0x0218 (size: 0x50)
    FAkGeometrySurfaceOverride CollisionMeshSurfaceOverride;                          // 0x0268 (size: 0x10)
    uint8 bEnableDiffraction;                                                         // 0x0278 (size: 0x1)
    uint8 bEnableDiffractionOnBoundaryEdges;                                          // 0x0278 (size: 0x1)
    class AActor* AssociatedRoom;                                                     // 0x0280 (size: 0x8)
    FAkGeometryData GeometryData;                                                     // 0x0298 (size: 0x50)
...
class UAkHololensInitializationSettings : public UObject
{
    FAkCommonInitializationSettingsWithSampleRate CommonSettings;                     // 0x0030 (size: 0x68)
    FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;           // 0x0098 (size: 0x28)
    FAkHololensAdvancedInitializationSettings AdvancedSettings;                       // 0x00C0 (size: 0x40)
...
class UAkIOSInitializationSettings : public UObject
{
    ...
    FAkAdvancedInitializationSettings AdvancedSettings;                               // 0x00D0 (size: 0x34)
...
{
    TArray<FAkPluginInfo> PluginInfos;                                                // 0x0078 (size: 0x10)
...
class UAkLateReverbComponent : public USceneComponent
{
    ...
    float SendLevel;                                                                  // 0x0228 (size: 0x4)
    float FadeRate;                                                                   // 0x022C (size: 0x4)
    float Priority;                                                                   // 0x0230 (size: 0x4)
    class UAkLateReverbComponent* NextLowerPriorityComponent;                         // 0x0238 (size: 0x8)
...
class UAkPS5InitializationSettings : public UObject
{
    FAkCommonInitializationSettings CommonSettings;                                   // 0x0030 (size: 0x60)
    FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;           // 0x0090 (size: 0x28)
    FAkPS5AdvancedInitializationSettings AdvancedSettings;                            // 0x00B8 (size: 0x3C)
...
class UAkRoomComponent : public UAkGameObject
{
    ...
    class UAkRoomComponent* NextLowerPriorityComponent;                               // 0x0230 (size: 0x8)
    float Priority;                                                                   // 0x0238 (size: 0x4)
    float WallOcclusion;                                                              // 0x023C (size: 0x4)
    float AuxSendLevel;                                                               // 0x0240 (size: 0x4)
    bool AutoPost;                                                                    // 0x0244 (size: 0x1)
...
class UAkSettings : public UObject
{
    ...
    bool SplitMediaPerFolder;                                                         // 0x00A9 (size: 0x1)
    bool UseEventBasedPackaging;                                                      // 0x00AA (size: 0x1)
    bool EnableAutomaticAssetSynchronization;                                         // 0x00AB (size: 0x1)
    FString CommandletCommitMessage;                                                  // 0x00B0 (size: 0x10)
    TMap<class FString, class FText> MapOfWWiseCulture;                               // 0x00C0 (size: 0x50)
    TMap<class FString, class FString> UnrealCultureToWwiseCulture;                   // 0x0110 (size: 0x50)
    bool AskedToUseNewAssetManagement;                                                // 0x0160 (size: 0x1)
    bool bEnableMultiCoreRendering;                                                   // 0x0161 (size: 0x1)
    bool MigratedEnableMultiCoreRendering;                                            // 0x0162 (size: 0x1)
    bool FixupRedirectorsDuringMigration;                                             // 0x0163 (size: 0x1)
    FDirectoryPath WwiseWindowsInstallationPath;                                      // 0x0168 (size: 0x10)
    FFilePath WwiseMacInstallationPath;                                               // 0x0178 (size: 0x10)
    float ReverbVolumeUpdateDelay;                                                    // 0x0188 (size: 0x4)
...
{
    uint8 bEnableSurfaceReflectors;                                                   // 0x0208 (size: 0x1)
    TArray<FAkPoly> AcousticPolys;                                                    // 0x0210 (size: 0x10)
    uint8 bEnableDiffraction;                                                         // 0x0220 (size: 0x1)
    uint8 bEnableDiffractionOnBoundaryEdges;                                          // 0x0220 (size: 0x1)
    class AActor* AssociatedRoom;                                                     // 0x0228 (size: 0x8)
...
class UAkXSXInitializationSettings : public UObject
{
    ...
    FAkCommunicationSettingsWithSystemInitialization CommunicationSettings;           // 0x0098 (size: 0x28)
    FAkXSXAdvancedInitializationSettings AdvancedSettings;                            // 0x00C0 (size: 0x3C)
...
{
    bool bReplicates;                                                                 // 0x00FA (size: 0x1)
...
class UMovieSceneAkTrack : public UMovieSceneTrack
{
    ...
    uint8 bIsAMasterTrack;                                                            // 0x0088 (size: 0x1)
