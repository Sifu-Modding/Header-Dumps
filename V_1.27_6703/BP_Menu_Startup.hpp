...
class UBP_Menu_Startup_C : public UStartupMenu
{
    ...
    class UBP_Notif_Currency_C* BP_Notif_Currency;                                    // 0x04B0 (size: 0x8)
    class UBP_Notif_CustomOn_C* BP_Notif_CustomOn;                                    // 0x04B8 (size: 0x8)
    class UBP_Menu_Popup_Validation_C* BP_PopupPlayWithoutSaving;                     // 0x04C0 (size: 0x8)
    class UBP_VersionWidget_C* BP_VersionWidget;                                      // 0x04C8 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnArena;                                               // 0x04D0 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnContinue;                                            // 0x04D8 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnCredits;                                             // 0x04E0 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnLoadSave;                                            // 0x04E8 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnMainNewGame;                                         // 0x04F0 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnModifiers;                                           // 0x04F8 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnNewGame;                                             // 0x0500 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnOptions;                                             // 0x0508 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnPressStartSimple;                                    // 0x0510 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnPressTrainingRoom;                                   // 0x0518 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnQuit;                                                // 0x0520 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnReplayEditor;                                        // 0x0528 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnShowArenaSelection;                                  // 0x0530 (size: 0x8)
    class UBP_Btn_TitleBtn_C* BtnStory;                                               // 0x0538 (size: 0x8)
    class UHorizontalBox* HorizontalBox_GamerTag;                                     // 0x0540 (size: 0x8)
    class UHorizontalBox* HorizontalBox_Notifs_Arena;                                 // 0x0548 (size: 0x8)
    class UHorizontalBox* InputTips;                                                  // 0x0550 (size: 0x8)
    class UImage* LineImage;                                                          // 0x0558 (size: 0x8)
    class ULoading_Checkpoint_Background_C* Loading_Checkpoint_Background;            // 0x0560 (size: 0x8)
    class UCanvasPanel* MainMenu;                                                     // 0x0568 (size: 0x8)
    class UVerticalBox* MenuBox;                                                      // 0x0570 (size: 0x8)
    class UImage* Modifiers_Lock_Icon;                                                // 0x0578 (size: 0x8)
    class UVerticalBox* PreArenaSelection;                                            // 0x0580 (size: 0x8)
    class UCanvasPanel* PressStart;                                                   // 0x0588 (size: 0x8)
    class UHorizontalBox* SkipButtonHorizontalBox;                                    // 0x0590 (size: 0x8)
    class UVerticalBox* StoryBox;                                                     // 0x0598 (size: 0x8)
    class UWidgetSwitcher* SubMenuSwitcher;                                           // 0x05A0 (size: 0x8)
    class UTextBlock* TextBlock_GamerTag;                                             // 0x05A8 (size: 0x8)
    class UTextBlock* TextClearStory;                                                 // 0x05B0 (size: 0x8)
    TArray<EMenuEnum> MenuToKeepAmb;                                                  // 0x05B8 (size: 0x10)
    bool bStarted;                                                                    // 0x05C8 (size: 0x1)
    bool bSaveLoaded;                                                                 // 0x05C9 (size: 0x1)
    FBP_Menu_Startup_CLocalOnSaveLoadedEventDispatcher LocalOnSaveLoadedEventDispatcher; // 0x05D0 (size: 0x10)
    void LocalOnSaveLoadedEventDispatcher(ELoadResult _eLoadResult);
    bool NewGameAsked;                                                                // 0x05E0 (size: 0x1)
    bool IsUsingBackgroundToMask3D;                                                   // 0x05E1 (size: 0x1)
    bool IsInSelectHideoutMap;                                                        // 0x05E2 (size: 0x1)
    bool WaitingImpostorsStabilization;                                               // 0x05E3 (size: 0x1)
    bool StorySubMenuOpened;                                                          // 0x05E4 (size: 0x1)
    TEnumAsByte<StartupMenu_Submenu> CurrentSubMenu;                                  // 0x05E5 (size: 0x1)
    FGameplayTagContainer CurrentMapOptions;                                          // 0x05E8 (size: 0x20)
    bool IsLeavingMap;                                                                // 0x0608 (size: 0x1)
    TSoftObjectPtr<ABP_TrainingManager_C> Training Manager;                           // 0x0610 (size: 0x28)
    TSoftObjectPtr<ASCPlayerStart> PlayerStart;                                       // 0x0638 (size: 0x28)
    bool bWaitingToGoToStoryMap;                                                      // 0x0660 (size: 0x1)
    bool ConfirmationPopupOpened;                                                     // 0x0661 (size: 0x1)
    bool CanSkipArenaIntro;                                                           // 0x0662 (size: 0x1)
    ...
    void SmokeAmbientInMenu(const EMenuEnum& MenuToFind);
    void RefreshCustomModeLock();
    void SetupMusicInArenaChallenge();
    void SetupMusicInArenaMenu();
    void RefreshCustomModeFeedback();
    ...
    void BndEvt__BP_Menu_Startup_BtnModifiers_K2Node_ComponentBoundEvent_15_ButtonUserWidgetClickDelegate__DelegateSignature(class UButtonUserWidget* _button, bool _bWithMouse);
    void BndEvt__BP_Menu_Startup_BtnModifiers_K2Node_ComponentBoundEvent_16_ButtonUserWidgetDelegate__DelegateSignature(class UButtonUserWidget* _button, EFocusCause _eCause);
    void BndEvt__BP_Menu_Startup_BtnModifiers_K2Node_ComponentBoundEvent_17_ButtonUserWidgetDelegate__DelegateSignature(class UButtonUserWidget* _button, EFocusCause _eCause);
