...
class UBP_LibraryAchievements_C : public UBlueprintFunctionLibrary
{
    ...
    void Plateform Pourcentage Completion(int32 bpp__Value__pf, int32 bpp__ClompetionValue__pf, class UObject* bpp____WorldContext__pf, float& bpp__OutputPourcentage__pf, float& bpp__OutputDebug__pf);
    ...
    void Achievement_Completed(FString bpp__AchievementID__pf__const, class APlayerController* bpp__PlayerController__pf, bool bpp__bIgnoreRunLegit__pf, class UObject* bpp____WorldContext__pf);
