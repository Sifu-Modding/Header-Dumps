...
class AInteractiveFoliageActor : public AStaticMeshActor
{
    ...
    FVector TouchingActorEntryPosition;                                               // 0x02C8 (size: 0xC)
    FVector FoliageVelocity;                                                          // 0x02D4 (size: 0xC)
    FVector FoliageForce;                                                             // 0x02E0 (size: 0xC)
    FVector FoliagePosition;                                                          // 0x02EC (size: 0xC)
    float FoliageDamageImpulseScale;                                                  // 0x02F8 (size: 0x4)
    float FoliageTouchImpulseScale;                                                   // 0x02FC (size: 0x4)
    float FoliageStiffness;                                                           // 0x0300 (size: 0x4)
    float FoliageStiffnessQuadratic;                                                  // 0x0304 (size: 0x4)
    float FoliageDamping;                                                             // 0x0308 (size: 0x4)
    float MaxDamageImpulse;                                                           // 0x030C (size: 0x4)
    float MaxTouchImpulse;                                                            // 0x0310 (size: 0x4)
    float MaxForce;                                                                   // 0x0314 (size: 0x4)
    float Mass;                                                                       // 0x0318 (size: 0x4)
...
{
    class AProceduralFoliageVolume* ProceduralFoliageVolume;                          // 0x02E8 (size: 0x8)
...
{
    FFoliageInstancedStaticMeshComponentOnInstanceTakePointDamage OnInstanceTakePointDamage; // 0x06C0 (size: 0x10)
    ...
    FFoliageInstancedStaticMeshComponentOnInstanceTakeRadialDamage OnInstanceTakeRadialDamage; // 0x06D0 (size: 0x10)
    ...
    FGuid GenerationGuid;                                                             // 0x06E0 (size: 0x10)
...
class UFoliageType : public UObject
{
    ...
    uint8 bForceReceiveShadow;                                                        // 0x0148 (size: 0x1)
    uint8 bCastShadowAsTwoSided;                                                      // 0x0148 (size: 0x1)
    uint8 bReceivesDecals;                                                            // 0x0149 (size: 0x1)
    ...
    FBodyInstance BodyInstance;                                                       // 0x0158 (size: 0x190)
    TEnumAsByte<EHasCustomNavigableGeometry::Type> CustomNavigableGeometry;           // 0x02E8 (size: 0x1)
    FLightingChannels LightingChannels;                                               // 0x02E9 (size: 0x1)
    uint8 bRenderCustomDepth;                                                         // 0x02EC (size: 0x1)
    ERendererStencilMask CustomDepthStencilWriteMask;                                 // 0x02F0 (size: 0x1)
    int32 CustomDepthStencilValue;                                                    // 0x02F4 (size: 0x4)
    int32 TranslucencySortPriority;                                                   // 0x02F8 (size: 0x4)
    float CollisionRadius;                                                            // 0x02FC (size: 0x4)
    float ShadeRadius;                                                                // 0x0300 (size: 0x4)
    int32 NumSteps;                                                                   // 0x0304 (size: 0x4)
    float InitialSeedDensity;                                                         // 0x0308 (size: 0x4)
    float AverageSpreadDistance;                                                      // 0x030C (size: 0x4)
    float SpreadVariance;                                                             // 0x0310 (size: 0x4)
    int32 SeedsPerStep;                                                               // 0x0314 (size: 0x4)
    int32 DistributionSeed;                                                           // 0x0318 (size: 0x4)
    float MaxInitialSeedOffset;                                                       // 0x031C (size: 0x4)
    bool bCanGrowInShade;                                                             // 0x0320 (size: 0x1)
    bool bSpawnsInShade;                                                              // 0x0321 (size: 0x1)
    float MaxInitialAge;                                                              // 0x0324 (size: 0x4)
    float MaxAge;                                                                     // 0x0328 (size: 0x4)
    float OverlapPriority;                                                            // 0x032C (size: 0x4)
    FFloatInterval ProceduralScale;                                                   // 0x0330 (size: 0x8)
    FRuntimeFloatCurve ScaleCurve;                                                    // 0x0338 (size: 0x88)
    int32 ChangeCount;                                                                // 0x03C0 (size: 0x4)
    uint8 ReapplyDensity;                                                             // 0x03C4 (size: 0x1)
    uint8 ReapplyRadius;                                                              // 0x03C4 (size: 0x1)
    uint8 ReapplyAlignToNormal;                                                       // 0x03C4 (size: 0x1)
    uint8 ReapplyRandomYaw;                                                           // 0x03C4 (size: 0x1)
    uint8 ReapplyScaling;                                                             // 0x03C4 (size: 0x1)
    uint8 ReapplyScaleX;                                                              // 0x03C4 (size: 0x1)
    uint8 ReapplyScaleY;                                                              // 0x03C4 (size: 0x1)
    uint8 ReapplyScaleZ;                                                              // 0x03C4 (size: 0x1)
    uint8 ReapplyRandomPitchAngle;                                                    // 0x03C5 (size: 0x1)
    uint8 ReapplyGroundSlope;                                                         // 0x03C5 (size: 0x1)
    uint8 ReapplyHeight;                                                              // 0x03C5 (size: 0x1)
    uint8 ReapplyLandscapeLayers;                                                     // 0x03C5 (size: 0x1)
    uint8 ReapplyZOffset;                                                             // 0x03C5 (size: 0x1)
    uint8 ReapplyCollisionWithWorld;                                                  // 0x03C5 (size: 0x1)
    uint8 ReapplyVertexColorMask;                                                     // 0x03C5 (size: 0x1)
    uint8 bEnableDensityScaling;                                                      // 0x03C5 (size: 0x1)
    uint8 bEnableDiscardOnLoad;                                                       // 0x03C6 (size: 0x1)
    TArray<class URuntimeVirtualTexture*> RuntimeVirtualTextures;                     // 0x03C8 (size: 0x10)
    int32 VirtualTextureCullMips;                                                     // 0x03D8 (size: 0x4)
    ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType;                  // 0x03DC (size: 0x1)

}; // Size: 0x3E0

class UFoliageType_Actor : public UFoliageType
{
    TSubclassOf<class AActor> ActorClass;                                             // 0x03E0 (size: 0x8)
    bool bShouldAttachToBaseComponent;                                                // 0x03E8 (size: 0x1)

}; // Size: 0x3F0

class UFoliageType_InstancedStaticMesh : public UFoliageType
{
    class UStaticMesh* Mesh;                                                          // 0x03E0 (size: 0x8)
    TArray<class UMaterialInterface*> OverrideMaterials;                              // 0x03E8 (size: 0x10)
    TSubclassOf<class UFoliageInstancedStaticMeshComponent> ComponentClass;           // 0x03F8 (size: 0x8)
...
{
    class UProceduralFoliageSpawner* FoliageSpawner;                                  // 0x00C0 (size: 0x8)
    float TileOverlap;                                                                // 0x00C8 (size: 0x4)
    class AVolume* SpawningVolume;                                                    // 0x00D0 (size: 0x8)
    FGuid ProceduralGuid;                                                             // 0x00D8 (size: 0x10)
