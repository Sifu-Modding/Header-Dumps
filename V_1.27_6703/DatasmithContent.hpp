...
{
    EDatasmithAreaLightActorType LightType;                                           // 0x02B0 (size: 0x1)
    EDatasmithAreaLightActorShape LightShape;                                         // 0x02B1 (size: 0x1)
    FVector2D Dimensions;                                                             // 0x02B4 (size: 0x8)
    float Intensity;                                                                  // 0x02BC (size: 0x4)
    ELightUnits IntensityUnits;                                                       // 0x02C0 (size: 0x1)
    FLinearColor Color;                                                               // 0x02C4 (size: 0x10)
    float Temperature;                                                                // 0x02D4 (size: 0x4)
    class UTextureLightProfile* IESTexture;                                           // 0x02D8 (size: 0x8)
    bool bUseIESBrightness;                                                           // 0x02E0 (size: 0x1)
    float IESBrightnessScale;                                                         // 0x02E4 (size: 0x4)
    FRotator Rotation;                                                                // 0x02E8 (size: 0xC)
    float SourceRadius;                                                               // 0x02F4 (size: 0x4)
    float SourceLength;                                                               // 0x02F8 (size: 0x4)
    float AttenuationRadius;                                                          // 0x02FC (size: 0x4)
    float SpotlightInnerAngle;                                                        // 0x0300 (size: 0x4)
    float SpotlightOuterAngle;                                                        // 0x0304 (size: 0x4)

}; // Size: 0x310

class ADatasmithImportedSequencesActor : public AActor
{
    TArray<class ULevelSequence*> ImportedSequences;                                  // 0x02B0 (size: 0x10)
...
{
    class UDatasmithScene* Scene;                                                     // 0x02B0 (size: 0x8)
    TMap<class FName, class TSoftObjectPtr<AActor>> RelatedActors;                    // 0x02B8 (size: 0x50)
