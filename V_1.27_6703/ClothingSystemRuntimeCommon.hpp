...
{
    FClothPhysicalMeshData PhysicalMeshData;                                          // 0x0000 (size: 0x108)
    FClothCollisionData CollisionData;                                                // 0x0108 (size: 0x40)
    bool bUseMultipleInfluences;                                                      // 0x0148 (size: 0x1)
    float SkinningKernelRadius;                                                       // 0x014C (size: 0x4)
...
class UClothLODDataCommon_Legacy : public UObject
{
    ...
    FClothPhysicalMeshData ClothPhysicalMeshData;                                     // 0x0030 (size: 0x108)
    FClothCollisionData CollisionData;                                                // 0x0138 (size: 0x40)
...
class UClothingAssetCommon : public UClothingAssetBase
{
    ...
    class UClothConfigBase* ClothSharedSimConfig;                                     // 0x00A0 (size: 0x8)
    class UClothConfigBase* ClothSimConfig;                                           // 0x00A8 (size: 0x8)
    class UClothConfigBase* ChaosClothSimConfig;                                      // 0x00B0 (size: 0x8)
    TArray<class UClothLODDataCommon_Legacy*> ClothLODData;                           // 0x00B8 (size: 0x10)
    TArray<FClothLODDataCommon> LODData;                                              // 0x00C8 (size: 0x10)
    TArray<int32> LodMap;                                                             // 0x00D8 (size: 0x10)
    TArray<FName> UsedBoneNames;                                                      // 0x00E8 (size: 0x10)
    TArray<int32> UsedBoneIndices;                                                    // 0x00F8 (size: 0x10)
    int32 ReferenceBoneIndex;                                                         // 0x0108 (size: 0x4)
    class UClothingAssetCustomData* CustomData;                                       // 0x0110 (size: 0x8)
    FClothConfig_Legacy ClothConfig;                                                  // 0x0118 (size: 0xD4)
