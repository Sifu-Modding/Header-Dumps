...
{
    int32 PlayerIndex;                                                                // 0x0490 (size: 0x4)
    EControllerHand Hand;                                                             // 0x0494 (size: 0x1)
    FName MotionSource;                                                               // 0x0498 (size: 0x8)
    uint8 bDisableLowLatencyUpdate;                                                   // 0x04A0 (size: 0x1)
    ETrackingStatus CurrentTrackingStatus;                                            // 0x04A4 (size: 0x1)
    bool bDisplayDeviceModel;                                                         // 0x04A5 (size: 0x1)
    FName DisplayModelSource;                                                         // 0x04A8 (size: 0x8)
    class UStaticMesh* CustomDisplayMesh;                                             // 0x04B0 (size: 0x8)
    TArray<class UMaterialInterface*> DisplayMeshMaterialOverrides;                   // 0x04B8 (size: 0x10)
    class UPrimitiveComponent* DisplayComponent;                                      // 0x0530 (size: 0x8)
...
{
    FVRNotificationsComponentHMDTrackingInitializingAndNeedsHMDToBeTrackedDelegate HMDTrackingInitializingAndNeedsHMDToBeTrackedDelegate; // 0x00C0 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDTrackingInitializedDelegate HMDTrackingInitializedDelegate; // 0x00D0 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDRecenteredDelegate HMDRecenteredDelegate;             // 0x00E0 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDLostDelegate HMDLostDelegate;                         // 0x00F0 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDReconnectedDelegate HMDReconnectedDelegate;           // 0x0100 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDConnectCanceledDelegate HMDConnectCanceledDelegate;   // 0x0110 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDPutOnHeadDelegate HMDPutOnHeadDelegate;               // 0x0120 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentHMDRemovedFromHeadDelegate HMDRemovedFromHeadDelegate;   // 0x0130 (size: 0x10)
    void VRNotificationsDelegate();
    FVRNotificationsComponentVRControllerRecenteredDelegate VRControllerRecenteredDelegate; // 0x0140 (size: 0x10)
    void VRNotificationsDelegate();
