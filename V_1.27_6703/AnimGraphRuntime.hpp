...
{
    FPoseLink BasePose;                                                               // 0x0160 (size: 0x10)
    int32 LODThreshold;                                                               // 0x0170 (size: 0x4)
    FName SourceSocketName;                                                           // 0x0174 (size: 0x8)
    FName PivotSocketName;                                                            // 0x017C (size: 0x8)
    FVector LookAtLocation;                                                           // 0x0184 (size: 0xC)
    FVector SocketAxis;                                                               // 0x0190 (size: 0xC)
    float Alpha;                                                                      // 0x019C (size: 0x4)
...
{
    float NormalizedTime;                                                             // 0x00F8 (size: 0x4)
...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
    ...
    float PlayRate;                                                                   // 0x0054 (size: 0x4)
    bool bLoop;                                                                       // 0x0058 (size: 0x1)
    bool bResetPlayTimeWhenBlendSpaceChanges;                                         // 0x0059 (size: 0x1)
    float StartPosition;                                                              // 0x005C (size: 0x4)
    class UBlendSpaceBase* BlendSpace;                                                // 0x0060 (size: 0x8)
    class UBlendSpaceBase* PreviousBlendSpace;                                        // 0x00F0 (size: 0x8)
...
struct FAnimNode_CopyPoseFromMesh : public FAnimNode_PoseSnapshot
{
    TWeakObjectPtr<class USkeletalMeshComponent> SourceMeshComponent;                 // 0x0090 (size: 0x8)
    uint8 bUseAttachedParent;                                                         // 0x0098 (size: 0x1)
    uint8 bCopyCurves;                                                                // 0x0098 (size: 0x1)
    bool bCopyCustomAttributes;                                                       // 0x0099 (size: 0x1)
    uint8 bUseMeshPose;                                                               // 0x009A (size: 0x1)
    FName RootBoneToCopy;                                                             // 0x009C (size: 0x8)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
    ...
    TArray<FBoneReference> OnlyDriveBones;                                            // 0x00B8 (size: 0x10)
    TArray<FPoseDriverTarget> PoseTargets;                                            // 0x00C8 (size: 0x10)
    FBoneReference EvalSpaceBone;                                                     // 0x0108 (size: 0x10)
    FRBFParams RBFParams;                                                             // 0x0118 (size: 0x2C)
    EPoseDriverSource DriveSource;                                                    // 0x0144 (size: 0x1)
    EPoseDriverOutput DriveOutput;                                                    // 0x0145 (size: 0x1)
    uint8 bOnlyDriveSelectedBones;                                                    // 0x0146 (size: 0x1)
    int32 LODThreshold;                                                               // 0x0148 (size: 0x4)

}; // Size: 0x150

struct FAnimNode_PoseHandler : public FAnimNode_AssetPlayerBase
{
    class UPoseAsset* PoseAsset;                                                      // 0x0048 (size: 0x8)
...
{
    class UAnimSequenceBase* Sequence;                                                // 0x0048 (size: 0x8)
    float ExplicitTime;                                                               // 0x0050 (size: 0x4)
    bool bShouldLoop;                                                                 // 0x0054 (size: 0x1)
    bool bTeleportToExplicitTime;                                                     // 0x0055 (size: 0x1)
    TEnumAsByte<ESequenceEvalReinit::Type> ReinitializationBehavior;                  // 0x0056 (size: 0x1)
    float StartPosition;                                                              // 0x0058 (size: 0x4)
