...
class AActor : public UObject
{
    ...
    uint8 bHostMigrationInProgress;
...
class USceneComponent : public UActorComponent
{
    ...
    uint8 bVisible;
    uint8 bAllowUpdateInPrediction;
...
class UReplayReplicationComponentBase : public UActorComponent
{
};
...
struct FBodyInstance : public FBodyInstanceCore
{
    ...
    TArray<FName> CombinedCollisionProfileNames;
    FCollisionResponseContainer SavedCollisionResponseCustom;
    TEnumAsByte<ECollisionEnabled::Type> SavedCollisionEnabledCustom;
...
class UPrimitiveComponent : public USceneComponent
{
    ...
    EReflectionQuality ReflectionCaptureQuality;
    ...
    void SetRenderInMainView(bool bValue);
    ...
    void SetChannel2(bool bChannel);
    void SetChannel1(bool bChannel);
    void SetChannel0(bool bChannel);
    ...
    void RemoveCollisionProfileNameToCombined(FName InCollisionProfileName, bool bUpdateOverlaps);
    ...
    TArray<FName> GetCopyCombinedCollisionProfileNames();
    ...
    void AddCollisionProfileNameToCombined(FName InCollisionProfileName, bool bUpdateOverlaps);
...
class USkinnedMeshComponent : public UMeshComponent
{
    ...
    void SetOverrideBoneTranslationRetargetingMode(FName BoneName, TEnumAsByte<EBoneTranslationRetargetingMode::Type> NewRetargetingMode, bool bChildrenToo);
    ...
    void RemoveOverrideBoneTranslationRetargetingMode(FName BoneName, bool bChildrenToo);
...
class USkeletalMeshComponent : public USkinnedMeshComponent
{
    ...
    void SetAnimationMode(TEnumAsByte<EAnimationMode::Type> InAnimationMode, bool bPreventAnimScriptInstanceClear, bool bPreventAnimScriptInitialization);
    ...
    void PlayAnimation(class UAnimationAsset* NewAnimToPlay, bool bLooping, bool bPreventAnimScriptInstanceClear, bool bPreventAnimScriptInitialization, bool bRecordInReplay);
    ...
    void ForceSimulationDurationNextUpdate(float InDuration);
    void ForceNextClothSimulationOnBonesTransformRefreshed(bool bForceClothSimulation);
    void ForceNextClothingSimulationTickWhenPaused(float DeltaTimeMultiplier);
...
struct FAnimNotifyRuntime
{
    FAnimNotifyEventReference Notify;
...
class UAnimInstance : public UObject
{
    ...
    TArray<FAnimNotifyRuntimeCopy> ActiveAnimNotify;
    TArray<FAnimNotifyRuntimeCopy> ActivePredictionAnimNotifyState;
    TArray<FAnimNotifyRuntimeCopy> ActivePredictionAnimNotify;
    EAnimInstanceType AnimInstanceType;
    TArray<FAnimNotifyRuntimeCopy> ActiveAnimNotifyState;
    ...
    float GetInstanceStateWeight(int32 MachineIndex, int32 StateIndex, bool bRecomputeAtCall);
...
class AController : public AActor
{
    ...
    void SetControlRotation(const FRotator& NewRotation, bool bPrediction);
    ...
    void OnRep_PlayerState(class APlayerState* OldPlayerState);
    void OnRep_Pawn();
...
class APlayerController : public AController
{
    ...
    void SetAdvancedVibrationEnabled(bool bInEnabled);
    ...
    void ServerNotifyControllerReceived();
    ...
    void ClientRestartHostMigration(class APawn* NewPawn);
...
struct FPostProcessSettings
{
    ...
    uint8 bOverride_AmbientOcclusionWorldSpaceNormalScale;
    ...
    float AmbientOcclusionWorldSpaceNormalScale;
    uint8 RayTracingAO;
...
class USceneCaptureComponent : public USceneComponent
{
    ...
    ESceneCapturePrimitiveRenderFrequency eCaptureFrequency;
    uint8 bRequiresSceneClear;
    uint8 bPostProcessAlpha;
...
class ACharacter : public APawn
{
    ...
    void ServerMoveOld(float OldTimeStamp, FVector_NetQuantize10 OldAccel, uint8 OldMoveFlags, uint8 OldMoveStatus, uint8 OldStickValue);
    void ServerMoveNoBase(float Timestamp, FVector_NetQuantize10 InAccel, FVector_NetQuantize100 ClientLoc, uint8 CompressedMoveFlags, uint8 ClientRoll, bool bInSync, uint32 View, uint8 ClientMovementMode, uint8 ClientMoveStatus, uint8 ClientStickValue);
    void ServerMoveDualNoBase(float TimeStamp0, FVector_NetQuantize10 InAccel0, uint8 PendingFlags, uint32 View0, float Timestamp, FVector_NetQuantize10 InAccel, FVector_NetQuantize100 ClientLoc, uint8 NewFlags, uint8 ClientRoll, bool bInSync, uint32 View, uint8 ClientMovementMode, uint8 ClientMoveStatus, uint8 ClientStickValue);
    void ServerMoveDualHybridRootMotion(float TimeStamp0, FVector_NetQuantize10 InAccel0, uint8 PendingFlags, uint32 View0, float Timestamp, FVector_NetQuantize10 InAccel, FVector_NetQuantize100 ClientLoc, uint8 NewFlags, bool bClientInSync, uint8 ClientRoll, uint32 View, class UPrimitiveComponent* ClientMovementBase, FName ClientBaseBoneName, uint8 ClientMovementMode, uint8 ClientMoveStatus, uint8 ClientStickValue);
    void ServerMoveDual(float TimeStamp0, FVector_NetQuantize10 InAccel0, uint8 PendingFlags, uint32 View0, float Timestamp, FVector_NetQuantize10 InAccel, FVector_NetQuantize100 ClientLoc, uint8 NewFlags, uint8 ClientRoll, bool bInSync, uint32 View, class UPrimitiveComponent* ClientMovementBase, FName ClientBaseBoneName, uint8 ClientMovementMode, uint8 ClientMoveStatus, uint8 ClientStickValue);
    void ServerMove(float Timestamp, FVector_NetQuantize10 InAccel, FVector_NetQuantize100 ClientLoc, uint8 CompressedMoveFlags, uint8 ClientRoll, bool bInSync, uint32 View, class UPrimitiveComponent* ClientMovementBase, FName ClientBaseBoneName, uint8 ClientMovementMode, uint8 ClientMoveStatus, uint8 ClientStickValue);
...
class AGameModeBase : public AInfo
{
    ...
    TSubclassOf<class APlayerController> SpectatorPlayerControllerClass;
...
{
    EAnimInstanceType AnimInstanceType;
    EAnimNotifyPredictionBehavior PredictionBehavior;
...
struct FWuguanCustomLightingUserParameters
{
    float GeneralBlend;
    float LightMax;
    float LightMin;
    float LightFadeMax;
    float LightMaxForced;
    float LightFadeMin;
    float LightMinForced;
    float UpRemapPower;
    float UpMaxFrequency;
    float UpExpStepFade;
    float DownRemapPower;
    float DownMaxFrequency;
    float DownExpStepFade;
...
class ULightComponent : public ULightComponentBase
{
    ...
    FWuguanCustomLightingUserParameters WuguanLightParameters;
...
class UCharacterMovementComponent : public UPawnMovementComponent
{
    ...
    bool bRemoveCollisionOnNavWalking;
...
class AReplayReplicationProxyBase : public AActor
{
};
...
class UEngine : public UObject
{
    ...
    class UMaterial* ShadedLevelColorationUnlitMaskedMaterial;
    FString ShadedLevelColorationUnlitMaskedMaterialName;
...
class APlayerCameraManager : public AActor
{
    ...
    class UMatineeCameraShake* StartMatineeCameraShakeFromSource(TSubclassOf<class UMatineeCameraShake> ShakeClass, class UCameraShakeSourceComponent* SourceComponent, float Scale, ECameraShakePlaySpace PlaySpace, FRotator UserPlaySpaceRot);
    class UMatineeCameraShake* StartMatineeCameraShake(TSubclassOf<class UMatineeCameraShake> ShakeClass, float Scale, ECameraShakePlaySpace PlaySpace, FRotator UserPlaySpaceRot);
...
struct FMaterialInstanceBasePropertyOverrides
{
    ...
    uint8 bOverride_AlwaysHasVelocity;
    uint8 bAlwaysHasVelocity;
    uint8 bOverride_SeparateTranslucency;
    uint8 bSeparateTranslucency;
    uint8 bOverride_bForceDisablePixelShaderInDepthPasses;
    float fForceDisablePixelShaderInDepthPasses;
...
class UAnimationSettings : public UDeveloperSettings
{
    ...
    TMap<class FName, class FLinearColor> DefaultAnimNotifyTracks;
...
struct FBakedAnimationState
{
    ...
    TArray<int32> LookUpNodeIndices;
    int32 StateIndex;
    int32 StartNotify;
    int32 EndNotify;
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
    ...
    TEnumAsByte<EBlendType::Type> BlendType;
...
{
    TArray<int32> BoneIndexToTrackMapTable;
    int32 NumFrames;
...
struct FBlendProfileBoneEntry
{
    FBoneReference BoneReference;
    float BlendScale;
    EBlendProfileEditMode Mode;
    FVector BlendScaleTranslation;
    FVector BlendScaleRotation;
...
class UBlendProfile : public UObject
{
    ...
    TMap<int32, int32> MapBoneIndexToBoneEntry;
...
class IBoneReferenceContainerInterface : public IInterface
{
};
...
class UDataTable : public UObject
{
    ...
    uint8 bAllowMerge;
    uint8 bIgnoreTooFewColumns;
    uint8 bMergeRemovesMissingRows;
    uint8 bIgnoreMissingColumnNames;
    uint8 bIgnoreMissingRowNames;
...
class UTexture2D : public UTexture
{
    ...
    int32 Blueprint_GetSourceSizeY();
    int32 Blueprint_GetSourceSizeX();
...
class UGameplayStatics : public UBlueprintFunctionLibrary
{
    ...
    class UParticleSystemComponent* SpawnEmitterAttached(class UParticleSystem* EmitterTemplate, class USceneComponent* AttachToComponent, FName AttachPointName, FVector Location, FRotator Rotation, FVector Scale, TEnumAsByte<EAttachLocation::Type> LocationType, bool bAutoDestroy, EPSCPoolMethod PoolingMethod, bool bAutoActivate, bool bReplicates);
    class UParticleSystemComponent* SpawnEmitterAtLocation(const class UObject* WorldContextObject, class UParticleSystem* EmitterTemplate, FVector Location, FRotator Rotation, FVector Scale, bool bAutoDestroy, EPSCPoolMethod PoolingMethod, bool bAutoActivateSystem, bool bReplicates);
    ...
    void SetEnableMainViewRendering(const class UObject* WorldContextObject, bool bEnable);
    ...
    bool GetEnableMainViewRendering(const class UObject* WorldContextObject);
...
class UKismetSystemLibrary : public UBlueprintFunctionLibrary
{
    ...
    void K2_ClearAndInvalidateTimerHandleArray(class UObject* WorldContextObject, TArray<FTimerHandle>& HandleArray);
    ...
    bool IsLowPerformanceModeActive();
...
class UMaterial : public UMaterialInterface
{
    ...
    TEnumAsByte<EBlendMode> BlendMode;
    TEnumAsByte<EMaterialWuguanCustomLightingMode> WuguanCustomLightingMode;
    bool bSwitchOffSSAO;
    bool bRecieveCSM;
    ...
    FColorMaterialInput MultiOpacity;
...
class UPhysicsSettings : public UPhysicsSettingsCore
{
    ...
    int32 ClothForcedSimulationFramePerSecond;
...
class APlayAnimationReplicationDummy : public AActor
{
    class UPlayAnimationReplication* m_PlayAnimationReplicationComponent;

};

struct FPlayAnimationReplicationInfo
{
    class USkeletalMeshComponent* m_SkeletalComp;
    class UAnimationAsset* m_AnimAssetToPlay;
    float m_fPosition;

};

class UPlayAnimationReplication : public UReplayReplicationComponentBase
{
    TArray<FPlayAnimationReplicationInfo> m_PlayAnimationReplicationInfo;

    void OnRep_PlayAnimationReplicationInfo();
    void BPF_RecordPlayAnimation(class USkeletalMeshComponent* _skeletalToAnimate, class UAnimationAsset* _animAssetToPlay, float _fStartPosition);
};
...
class UPoseableMeshComponent : public USkinnedMeshComponent
{
    ...
    bool ApplyPoseFromSnapshot(const FPoseSnapshot& _PoseSnapshot);
};
...
class URendererSettings : public UDeveloperSettings
{
    ...
    uint8 bFastBuildShaderCompilation;
...
class USkyLightComponent : public ULightComponentBase
{
    ...
    FWuguanCustomLightingUserParameters WuguanGlobalLightParameters;
    class UTextureCube* BlendDestinationCubemap;

    void SetWuguanCustomLightingValues(FWuguanCustomLightingUserParameters CustomLightingParameters);
    void SetVolumetricScatteringIntensity(float NewIntensity);
    ...
    void SetIntensity(float NewIntensity);
    void SetIndirectLightingIntensity(float NewIntensity);
    void SetGeneralBlend(float InWuguanBlend);
...
class USubObjectsRegisterComponent : public UActorComponent
{
};
...
class UVFXReplication : public UReplayReplicationComponentBase
{

    void MulticastSpawnEmitterAttached(const class UParticleSystem* _emitterTemplate, const class USceneComponent* _attachToComponent, const FName& _attachPointName, const FVector& _vLocation, const FRotator& _rotation, const FVector& _vScale, TEnumAsByte<EAttachLocation::Type> _locationType, bool _bAutoDestroy, bool _bAutoActivateSystem);
    void MulticastSpawnEmitterAtLocation(const class UParticleSystem* _emitterTemplate, const FVector& _vLocation, const FRotator& _rotation, const FVector& _vScale, bool _bAutoDestroy, bool _bAutoActivateSystem);
};
