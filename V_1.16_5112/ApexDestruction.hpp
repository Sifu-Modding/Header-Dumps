...
class UDestructibleComponent : public USkinnedMeshComponent
{
    ...
    class UDestructibleMesh* LowEndDestructibleMesh;
    ...
    FDestructibleComponentOnComponentSilentFracture OnComponentSilentFracture;
    void ComponentFractureSignature(const FVector& HitPoint, const FVector& HitDirection);
    float ApexChunksMaxDistanceThreshold;
    float ApexChunksUpdateSleepInterval;
    FDestructibleComponentOnWakeStateChanged OnWakeStateChanged;
    void DestructibleWakeStateDelegate(bool bIsAwake);
    class UDestructibleSnapshot* Snapshot;
