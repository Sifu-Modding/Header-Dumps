...
class UBP_GameFlow_Library_C : public UBlueprintFunctionLibrary
{
    ...
    void OpenArenaMenuMap(bool bpp__SaveMapChange__pf, bool bpp__GotoChallengeSelection__pf, bool bpp__bShowArenaMenu__pf, bool bpp__WandToReloadFirstSave__pf, class UObject* bpp____WorldContext__pf);
    ...
    FGameplayTagContainer GetCurrentMapOptions(class UObject* bpp____WorldContext__pf);
}; // Size: 0x28
