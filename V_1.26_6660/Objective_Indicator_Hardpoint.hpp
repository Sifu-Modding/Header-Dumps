...
class UObjective_Indicator_Hardpoint_C : public USCUserWidget
{
    ...
    bool Should NOTDisplay;                                                           // 0x0394 (size: 0x1)
    bool Initialized;                                                                 // 0x0395 (size: 0x1)
    FGeometry WidgetSize;                                                             // 0x0398 (size: 0x38)
    float HUDEllipticRadiusY;                                                         // 0x03D0 (size: 0x4)

    void GetBlackBarRatio(float& BlackBarRatio);
