...
{
    FGuid PinId;                                                                      // 0x02B0 (size: 0x10)
    bool bVisibilityOverride;                                                         // 0x02C0 (size: 0x1)
...
{
    bool bInfoActorsVisibilityOverride;                                               // 0x02B0 (size: 0x1)
    TMap<class FGuid, class AMagicLeapARPinInfoActorBase*> AllInfoActors;             // 0x02B8 (size: 0x50)
    TSubclassOf<class AMagicLeapARPinInfoActorBase> ClassToSpawn;                     // 0x0310 (size: 0x8)
...
{
    FString ObjectUID;                                                                // 0x0208 (size: 0x10)
    int32 UserIndex;                                                                  // 0x0218 (size: 0x4)
    EMagicLeapAutoPinType AutoPinType;                                                // 0x021C (size: 0x1)
    bool bShouldPinActor;                                                             // 0x021D (size: 0x1)
    TSubclassOf<class UMagicLeapARPinSaveGame> PinDataClass;                          // 0x0220 (size: 0x8)
    TSet<EMagicLeapARPinType> SearchPinTypes;                                         // 0x0228 (size: 0x50)
    class USphereComponent* SearchVolume;                                             // 0x0278 (size: 0x8)
    FMagicLeapARPinComponentOnPersistentEntityPinned OnPersistentEntityPinned;        // 0x0280 (size: 0x10)
    void PersistentEntityPinned(bool bRestoredOrSynced);
    FMagicLeapARPinComponentOnPersistentEntityPinLost OnPersistentEntityPinLost;      // 0x0290 (size: 0x10)
    void PersistentEntityPinLost();
    FMagicLeapARPinComponentOnPinDataLoadAttemptCompleted OnPinDataLoadAttemptCompleted; // 0x02A0 (size: 0x10)
    void MagicLeapARPinDataLoadAttemptCompleted(bool bDataRestored);
    FGuid PinnedCFUID;                                                                // 0x02B0 (size: 0x10)
    class USceneComponent* PinnedSceneComponent;                                      // 0x02C0 (size: 0x8)
    class UMagicLeapARPinSaveGame* PinData;                                           // 0x02C8 (size: 0x8)
