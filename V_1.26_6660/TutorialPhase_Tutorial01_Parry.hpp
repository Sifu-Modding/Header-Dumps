#ifndef UE4SS_SDK_TutorialPhase_Tutorial01_Parry_HPP
#define UE4SS_SDK_TutorialPhase_Tutorial01_Parry_HPP

class ATutorialPhase_Tutorial01_Parry_C : public ATutorial_Phase_C
{
    ...
    void ResetHighlight();
    void DelayEnd();
    void ExecuteUbergraph_TutorialPhase_Tutorial01_Parry(int32 EntryPoint);
}; // Size: 0x409
