...
{
    class UMediaTexture* MediaTexture;                                                // 0x00C0 (size: 0x8)
    class UMediaPlayer* MediaPlayer;                                                  // 0x00C8 (size: 0x8)
...
{
    EMediaSoundChannels Channels;                                                     // 0x06D0 (size: 0x4)
    bool DynamicRateAdjustment;                                                       // 0x06D4 (size: 0x1)
    float RateAdjustmentFactor;                                                       // 0x06D8 (size: 0x4)
    FFloatRange RateAdjustmentRange;                                                  // 0x06DC (size: 0x10)
    class UMediaPlayer* MediaPlayer;                                                  // 0x06F0 (size: 0x8)
...
{
    TEnumAsByte<TextureAddress> AddressX;                                             // 0x00E0 (size: 0x1)
    TEnumAsByte<TextureAddress> AddressY;                                             // 0x00E1 (size: 0x1)
    bool AutoClear;                                                                   // 0x00E2 (size: 0x1)
    FLinearColor ClearColor;                                                          // 0x00E4 (size: 0x10)
    bool EnableGenMips;                                                               // 0x00F4 (size: 0x1)
    uint8 NumMips;                                                                    // 0x00F5 (size: 0x1)
    bool NewStyleOutput;                                                              // 0x00F6 (size: 0x1)
    TEnumAsByte<MediaTextureOutputFormat> OutputFormat;                               // 0x00F7 (size: 0x1)
    float CurrentAspectRatio;                                                         // 0x00F8 (size: 0x4)
    TEnumAsByte<MediaTextureOrientation> CurrentOrientation;                          // 0x00FC (size: 0x1)
    class UMediaPlayer* MediaPlayer;                                                  // 0x0100 (size: 0x8)
