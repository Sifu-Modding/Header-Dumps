#ifndef UE4SS_SDK_BP_RelentlessGoons_HPP
#define UE4SS_SDK_BP_RelentlessGoons_HPP

class UBP_RelentlessGoons_C : public UBP_GameplayCheatMaster_C
{
    ...
    void ExecuteUbergraph_BP_RelentlessGoons(int32 EntryPoint);
}; // Size: 0x48
