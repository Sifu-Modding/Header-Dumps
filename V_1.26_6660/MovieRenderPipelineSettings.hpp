...
{
    FSoftClassPath BurnInClass;                                                       // 0x0048 (size: 0x18)
    bool bCompositeOntoFinalImage;                                                    // 0x0060 (size: 0x1)
    class UTextureRenderTarget2D* RenderTarget;                                       // 0x0090 (size: 0x8)
    class UMoviePipelineBurnInWidget* BurnInWidgetInstance;                           // 0x0098 (size: 0x8)
...
{
    class UTextureRenderTarget2D* RenderTarget;                                       // 0x0058 (size: 0x8)
