...
{
    class USkeletalMeshComponent* Mesh;                                               // 0x0310 (size: 0x8)
    class UWheeledVehicleMovementComponent* VehicleMovement;                          // 0x0318 (size: 0x8)
...
{
    class UWheeledVehicleMovementComponent* WheeledVehicleMovementComponent;          // 0x0BA0 (size: 0x8)
...
{
    uint8 bDeprecatedSpringOffsetMode;                                                // 0x0150 (size: 0x1)
    uint8 bReverseAsBrake;                                                            // 0x0150 (size: 0x1)
    uint8 bUseRVOAvoidance;                                                           // 0x0150 (size: 0x1)
    uint8 bRawHandbrakeInput;                                                         // 0x0150 (size: 0x1)
    uint8 bRawGearUpInput;                                                            // 0x0150 (size: 0x1)
    uint8 bRawGearDownInput;                                                          // 0x0150 (size: 0x1)
    uint8 bWasAvoidanceUpdated;                                                       // 0x0154 (size: 0x1)
    float Mass;                                                                       // 0x0158 (size: 0x4)
    TArray<FWheelSetup> WheelSetups;                                                  // 0x0160 (size: 0x10)
    float DragCoefficient;                                                            // 0x0170 (size: 0x4)
    float ChassisWidth;                                                               // 0x0174 (size: 0x4)
    float ChassisHeight;                                                              // 0x0178 (size: 0x4)
    float DragArea;                                                                   // 0x017C (size: 0x4)
    float EstimatedMaxEngineSpeed;                                                    // 0x0180 (size: 0x4)
    float MaxEngineRPM;                                                               // 0x0184 (size: 0x4)
    float DebugDragMagnitude;                                                         // 0x0188 (size: 0x4)
    FVector InertiaTensorScale;                                                       // 0x018C (size: 0xC)
    float MinNormalizedTireLoad;                                                      // 0x0198 (size: 0x4)
    float MinNormalizedTireLoadFiltered;                                              // 0x019C (size: 0x4)
    float MaxNormalizedTireLoad;                                                      // 0x01A0 (size: 0x4)
    float MaxNormalizedTireLoadFiltered;                                              // 0x01A4 (size: 0x4)
    float ThresholdLongitudinalSpeed;                                                 // 0x01A8 (size: 0x4)
    int32 LowForwardSpeedSubStepCount;                                                // 0x01AC (size: 0x4)
    int32 HighForwardSpeedSubStepCount;                                               // 0x01B0 (size: 0x4)
    TArray<class UVehicleWheel*> Wheels;                                              // 0x01B8 (size: 0x10)
    float RVOAvoidanceRadius;                                                         // 0x01E0 (size: 0x4)
    float RVOAvoidanceHeight;                                                         // 0x01E4 (size: 0x4)
    float AvoidanceConsiderationRadius;                                               // 0x01E8 (size: 0x4)
    float RVOSteeringStep;                                                            // 0x01EC (size: 0x4)
    float RVOThrottleStep;                                                            // 0x01F0 (size: 0x4)
    int32 AvoidanceUID;                                                               // 0x01F4 (size: 0x4)
    FNavAvoidanceMask AvoidanceGroup;                                                 // 0x01F8 (size: 0x4)
    FNavAvoidanceMask GroupsToAvoid;                                                  // 0x01FC (size: 0x4)
    FNavAvoidanceMask GroupsToIgnore;                                                 // 0x0200 (size: 0x4)
    float AvoidanceWeight;                                                            // 0x0204 (size: 0x4)
    FVector PendingLaunchVelocity;                                                    // 0x0208 (size: 0xC)
    FReplicatedVehicleState ReplicatedState;                                          // 0x0214 (size: 0x14)
    float RawSteeringInput;                                                           // 0x022C (size: 0x4)
    float RawThrottleInput;                                                           // 0x0230 (size: 0x4)
    float RawBrakeInput;                                                              // 0x0234 (size: 0x4)
    float SteeringInput;                                                              // 0x0238 (size: 0x4)
    float ThrottleInput;                                                              // 0x023C (size: 0x4)
    float BrakeInput;                                                                 // 0x0240 (size: 0x4)
    float HandbrakeInput;                                                             // 0x0244 (size: 0x4)
    float IdleBrakeInput;                                                             // 0x0248 (size: 0x4)
    float StopThreshold;                                                              // 0x024C (size: 0x4)
    float WrongDirectionThreshold;                                                    // 0x0250 (size: 0x4)
    FVehicleInputRate ThrottleInputRate;                                              // 0x0254 (size: 0x8)
    FVehicleInputRate BrakeInputRate;                                                 // 0x025C (size: 0x8)
    FVehicleInputRate HandbrakeInputRate;                                             // 0x0264 (size: 0x8)
    FVehicleInputRate SteeringInputRate;                                              // 0x026C (size: 0x8)
    class AController* OverrideController;                                            // 0x0298 (size: 0x8)
...
{
    FVehicleEngineData EngineSetup;                                                   // 0x02A0 (size: 0xA0)
    FVehicleDifferential4WData DifferentialSetup;                                     // 0x0340 (size: 0x1C)
    float AckermannAccuracy;                                                          // 0x035C (size: 0x4)
    FVehicleTransmissionData TransmissionSetup;                                       // 0x0360 (size: 0x30)
    FRuntimeFloatCurve SteeringCurve;                                                 // 0x0390 (size: 0x88)
