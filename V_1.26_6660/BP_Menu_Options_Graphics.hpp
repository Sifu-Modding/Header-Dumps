...
class UBP_Menu_Options_Graphics_C : public UGraphOptionsMenu
{
    ...
    class UScrollBox* GraphicsScroll;                                                 // 0x0928 (size: 0x8)
    class UBP_Btn_InputTip_C* InputTip_AutoDetect;                                    // 0x0930 (size: 0x8)
    class UBP_Btn_InputTip_C* InputTip_Back;                                          // 0x0938 (size: 0x8)
    class UBP_Btn_SpinBox_C* NVidia_DLSS;                                             // 0x0940 (size: 0x8)
    class UBP_Btn_SpinBox_C* Opt_RenderRes;                                           // 0x0948 (size: 0x8)
    class UBP_Btn_SpinBox_C* Opt_Resolution;                                          // 0x0950 (size: 0x8)
    class UBP_Btn_SpinBox_C* Opt_VSync;                                               // 0x0958 (size: 0x8)
    class UBP_Btn_SpinBox_C* Opt_Window;                                              // 0x0960 (size: 0x8)
    class UBP_Btn_SpinBox_C* Scala_AntiAliasing;                                      // 0x0968 (size: 0x8)
    class UBP_Btn_SpinBox_C* Scala_Effects;                                           // 0x0970 (size: 0x8)
    class UBP_Btn_SpinBox_C* Scala_Foliage;                                           // 0x0978 (size: 0x8)
    class UBP_Btn_SpinBox_C* Scala_PostProcess;                                       // 0x0980 (size: 0x8)
    class UBP_Btn_SpinBox_C* Scala_Shadows;                                           // 0x0988 (size: 0x8)
    class UBP_Btn_SpinBox_C* Scala_Textures;                                          // 0x0990 (size: 0x8)
    class UBP_Btn_SpinBox_C* Scala_ViewDistance;                                      // 0x0998 (size: 0x8)
    class UBP_Btn_SpinBox_C* FocusedOption;                                           // 0x09A0 (size: 0x8)
    TArray<UDLSSMode> CurrentlySupportedDLSSModes;                                    // 0x09A8 (size: 0x10)
    TMap<class UDLSSMode, class FText> DLSSTitles;                                    // 0x09B8 (size: 0x50)
    TMap<class UDLSSMode, class FText> DLSSTooltips;                                  // 0x0A08 (size: 0x50)
    TMap<TEnumAsByte<EWindowMode::Type>, FText> WindowModeTooltips;                   // 0x0A58 (size: 0x50)
