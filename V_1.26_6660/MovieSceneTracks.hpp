...
{
    FMovieSceneByteChannel ByteCurve;                                                 // 0x0038 (size: 0x98)
...
{
    TSubclassOf<class UMatineeCameraShake> ShakeClass;                                // 0x0000 (size: 0x8)
...
{
    FName SlotName;                                                                   // 0x0080 (size: 0x8)
...
{
    FMovieSceneByteChannel EnumCurve;                                                 // 0x0038 (size: 0x98)
...
{
    FMovieSceneIntegerChannel IntegerCurve;                                           // 0x0038 (size: 0x90)
    EMovieSceneBlendType BlendType;                                                   // 0x00C8 (size: 0x1)
...
{
    FMovieSceneFloatChannel ComponentCurves;                                          // 0x0038 (size: 0x280)
    int32 NumChannelsUsed;                                                            // 0x02B8 (size: 0x4)
    EMovieSceneBlendType BlendType;                                                   // 0x02BC (size: 0x1)
...
{
    bool bPreviewOnly;                                                                // 0x0118 (size: 0x1)
    bool bApplyMeshOffset;                                                            // 0x0119 (size: 0x1)
    FName ChildComponentName;                                                         // 0x011C (size: 0x8)
    FName AttachSocketName;                                                           // 0x0124 (size: 0x8)
    FName AttachComponentName;                                                        // 0x012C (size: 0x8)
    EAttachmentRule AttachmentLocationRule;                                           // 0x0134 (size: 0x1)
    EAttachmentRule AttachmentRotationRule;                                           // 0x0135 (size: 0x1)
    EAttachmentRule AttachmentScaleRule;                                              // 0x0136 (size: 0x1)
    EDetachmentRule DetachmentLocationRule;                                           // 0x0137 (size: 0x1)
    EDetachmentRule DetachmentRotationRule;                                           // 0x0138 (size: 0x1)
    EDetachmentRule DetachmentScaleRule;                                              // 0x0139 (size: 0x1)
...
{
    TArray<class UMovieSceneSection*> ConstraintSections;                             // 0x0078 (size: 0x10)
...
{
    TArray<class UMovieSceneSection*> AudioSections;                                  // 0x0080 (size: 0x10)
...
{
    FMovieSceneByteChannel ByteCurve;                                                 // 0x00E8 (size: 0x98)

}; // Size: 0x180

class UMovieSceneByteTrack : public UMovieScenePropertyTrack
{
    class UEnum* Enum;                                                                // 0x00B0 (size: 0x8)
...
{
    TArray<class UMovieSceneSection*> CameraAnimSections;                             // 0x0080 (size: 0x10)
...
{
    bool bCanBlend;                                                                   // 0x0078 (size: 0x1)
...
class UMovieSceneCameraShakeSection : public UMovieSceneSection
{
    ...
    TSubclassOf<class UMatineeCameraShake> ShakeClass;                                // 0x0108 (size: 0x8)
...
{
    TArray<class UMovieSceneSection*> CameraShakeSections;                            // 0x0080 (size: 0x10)
...
{
    FString ShotDisplayName;                                                          // 0x0160 (size: 0x10)
    FText DisplayName;                                                                // 0x0170 (size: 0x18)
    bool bSimulateClothesOnFirstFrame;                                                // 0x0188 (size: 0x1)
...
{
    FMovieSceneFloatChannel RedCurve;                                                 // 0x00E8 (size: 0xA0)
    FMovieSceneFloatChannel GreenCurve;                                               // 0x0188 (size: 0xA0)
    FMovieSceneFloatChannel BlueCurve;                                                // 0x0228 (size: 0xA0)
    FMovieSceneFloatChannel AlphaCurve;                                               // 0x02C8 (size: 0xA0)

}; // Size: 0x368

class UMovieSceneColorTrack : public UMovieScenePropertyTrack
{
    bool bIsSlateColor;                                                               // 0x00B0 (size: 0x1)
...
class UMovieSceneComponentMaterialBySlotNameTrack : public UMovieSceneMaterialTrack
{
...
{
    int32 MaterialIndex;                                                              // 0x0090 (size: 0x4)
...
{
    FMovieSceneByteChannel EnumCurve;                                                 // 0x00E8 (size: 0x98)
...
class UMovieSceneEventTrack : public UMovieSceneNameableTrack
{
    ...
    EFireEventsAtPosition EventPosition;                                              // 0x0084 (size: 0x1)
    TArray<class UMovieSceneSection*> Sections;                                       // 0x0088 (size: 0x10)
...
{
    FMovieSceneIntegerChannel IntegerCurve;                                           // 0x00E8 (size: 0x90)
...
{
    class UMaterialParameterCollection* MPC;                                          // 0x0090 (size: 0x8)
...
class UMovieSceneMeshMaterialBySlotNameTrack : public UMovieScenePropertyTrack
{
    FName SlotName;                                                                   // 0x00B0 (size: 0x8)
...
{
    UClass* PropertyClass;                                                            // 0x00B0 (size: 0x8)
...
{
    TArray<class UMovieSceneSection*> ParticleSections;                               // 0x0080 (size: 0x10)
...
class UMovieScenePreviewSpawnTrack : public UMovieSceneSpawnTrack
{
}; // Size: 0x98
...
{
    class UMovieScenePropertyInstantiatorSystem* InstantiatorSystem;                  // 0x0040 (size: 0x8)

}; // Size: 0x50

class UMovieScenePropertyTrack : public UMovieSceneNameableTrack
{
    class UMovieSceneSection* SectionToKey;                                           // 0x0078 (size: 0x8)
    FMovieScenePropertyBinding PropertyBinding;                                       // 0x0080 (size: 0x14)
...
{
    TArray<class UMovieSceneSection*> AnimationSections;                              // 0x0080 (size: 0x10)
    bool bUseLegacySectionIndexBlend;                                                 // 0x0090 (size: 0x1)
    FMovieSceneSkeletalAnimRootMotionTrackParams RootMotionParams;                    // 0x0098 (size: 0x30)
    bool bBlendFirstChildOfRoot;                                                      // 0x00C8 (size: 0x1)
...
{
    FMovieSceneFloatChannel Curves;                                                   // 0x00E8 (size: 0x280)
    int32 ChannelsUsed;                                                               // 0x0368 (size: 0x4)

}; // Size: 0x370

class UMovieSceneVectorTrack : public UMovieScenePropertyTrack
{
    int32 NumChannelsUsed;                                                            // 0x00B0 (size: 0x4)
