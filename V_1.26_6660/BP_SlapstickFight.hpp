#ifndef UE4SS_SDK_BP_SlapstickFight_HPP
#define UE4SS_SDK_BP_SlapstickFight_HPP

class UBP_SlapstickFight_C : public UBP_GameplayCheatMaster_C
{
    ...
    void ExecuteUbergraph_BP_SlapstickFight(int32 EntryPoint);
}; // Size: 0x48
