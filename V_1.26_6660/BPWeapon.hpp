...
class ABPWeapon_C : public ABaseWeapon
{
    ...
    TMap<class EThrowableState, class FWeaponTickInfo> WeaponTickInfos;               // 0x0900 (size: 0x50)
    float fVelocityOnHit;                                                             // 0x0950 (size: 0x4)
    float fVelocityThresholdOnHit;                                                    // 0x0954 (size: 0x4)
    ...
    void PlayBounceSFX(float fVelocity);
