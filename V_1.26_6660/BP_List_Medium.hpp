...
class UBP_List_Medium_C : public USCUserWidget
{
    ...
    void InitCheatList(TArray<FGameplayTag>& CheatTags, bool AddStartingAge, int32 StartingAge, int32 MaximumCheats, bool DisplayAllMovesets);
    void ClearEntries();
    void TryUpdateTagEntryOrAdd(FGameplayTag GameplayTag, bool DisplayMovesetName);
