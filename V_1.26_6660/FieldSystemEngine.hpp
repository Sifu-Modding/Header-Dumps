...
{
    class UFieldSystemComponent* FieldSystemComponent;                                // 0x02B0 (size: 0x8)

}; // Size: 0x2C0

class UBoxFalloff : public UFieldNodeFloat
{
    float Magnitude;                                                                  // 0x00C0 (size: 0x4)
    float MinRange;                                                                   // 0x00C4 (size: 0x4)
    float MaxRange;                                                                   // 0x00C8 (size: 0x4)
    float Default;                                                                    // 0x00CC (size: 0x4)
...
{
    class UFieldNodeBase* Culling;                                                    // 0x00C0 (size: 0x8)
    class UFieldNodeBase* Field;                                                      // 0x00C8 (size: 0x8)
    TEnumAsByte<EFieldCullingOperationType> Operation;                                // 0x00D0 (size: 0x1)
...
{
    class UFieldSystem* FieldSystem;                                                  // 0x0490 (size: 0x8)
    TArray<TSoftObjectPtr<AChaosSolverActor>> SupportedSolvers;                       // 0x04A8 (size: 0x10)
...
{
    int32 Iterations;                                                                 // 0x00C0 (size: 0x4)
...
{
    TEnumAsByte<EFieldResolutionType> ResolutionType;                                 // 0x00C0 (size: 0x1)
...
{
    float MinRange;                                                                   // 0x00C0 (size: 0x4)
    float MaxRange;                                                                   // 0x00C4 (size: 0x4)
    FTransform Transform;                                                             // 0x00D0 (size: 0x30)
...
{
    float Magnitude;                                                                  // 0x00C0 (size: 0x4)
    class UFieldNodeBase* RightField;                                                 // 0x00C8 (size: 0x8)
    class UFieldNodeBase* LeftField;                                                  // 0x00D0 (size: 0x8)
    TEnumAsByte<EFieldOperationType> Operation;                                       // 0x00D8 (size: 0x1)
...
class UPlaneFalloff : public UFieldNodeFloat
{
    ...
    float MaxRange;                                                                   // 0x00C8 (size: 0x4)
    float Default;                                                                    // 0x00CC (size: 0x4)
    float Distance;                                                                   // 0x00D0 (size: 0x4)
    FVector Position;                                                                 // 0x00D4 (size: 0xC)
    FVector Normal;                                                                   // 0x00E0 (size: 0xC)
    TEnumAsByte<EFieldFalloffType> Falloff;                                           // 0x00EC (size: 0x1)
...
class URadialFalloff : public UFieldNodeFloat
{
    ...
    float MaxRange;                                                                   // 0x00C8 (size: 0x4)
    float Default;                                                                    // 0x00CC (size: 0x4)
    float Radius;                                                                     // 0x00D0 (size: 0x4)
    FVector Position;                                                                 // 0x00D4 (size: 0xC)
    TEnumAsByte<EFieldFalloffType> Falloff;                                           // 0x00E0 (size: 0x1)
...
class URadialIntMask : public UFieldNodeInt
{
    ...
    int32 InteriorValue;                                                              // 0x00D0 (size: 0x4)
    int32 ExteriorValue;                                                              // 0x00D4 (size: 0x4)
    TEnumAsByte<ESetMaskConditionType> SetMaskCondition;                              // 0x00D8 (size: 0x1)
...
{
    class UFieldNodeInt* IntField;                                                    // 0x00C0 (size: 0x8)
...
{
    class UFieldNodeFloat* FloatField;                                                // 0x00C0 (size: 0x8)
...
{
    int32 Magnitude;                                                                  // 0x00C0 (size: 0x4)
...
{
    float Magnitude;                                                                  // 0x00C0 (size: 0x4)
    FVector Direction;                                                                // 0x00C4 (size: 0xC)
