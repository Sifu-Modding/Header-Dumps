...
class UBP_WGSaveObjectGameData_C : public UWGSaveObjectGameData
{
    ...
    FRerollCheatSaveInfo RerollCheatInfo;                                             // 0x0630 (size: 0x10)
    TArray<ESaveEntryTypes> CheatsUpdated;                                            // 0x0640 (size: 0x10)
    class USCSaveObjectGameData* K2Node_Event__inSaveTo;                              // 0x0650 (size: 0x8)
    int32 K2Node_Event__iTestMask;                                                    // 0x0658 (size: 0x4)
