...
class UBP_Menu_Popup_Validation_C : public UPopupWidget
{
    ...
    class UVerticalBox* PaddingBox_1;                                                 // 0x0448 (size: 0x8)
    class UTextBlock* PrimaryField;                                                   // 0x0450 (size: 0x8)
    class UTextBlock* PrimaryField_1;                                                 // 0x0458 (size: 0x8)
    class UTextBlock* SecondaryField;                                                 // 0x0460 (size: 0x8)
    class UWidgetSwitcher* SecondarySwitcher;                                         // 0x0468 (size: 0x8)
    class UBorder* SecondWarning;                                                     // 0x0470 (size: 0x8)
    class USizeBox* SizeBoxContent;                                                   // 0x0478 (size: 0x8)
    class UTextBlock* TitleField;                                                     // 0x0480 (size: 0x8)
    class UImage* WarningImg;                                                         // 0x0488 (size: 0x8)
    class UImage* WarningImg_1;                                                       // 0x0490 (size: 0x8)
    class UBP_Btn_InputBtn_C* YesBtnHorizontal;                                       // 0x0498 (size: 0x8)
    class UBP_Btn_InputBtn_C* YesBtnVertical;                                         // 0x04A0 (size: 0x8)
    class UTexture2D* BackgroundHovered;                                              // 0x04A8 (size: 0x8)
    class UTexture2D* BackgroundNormal;                                               // 0x04B0 (size: 0x8)
    FLinearColor NormalTint;                                                          // 0x04B8 (size: 0x10)
    FBP_Menu_Popup_Validation_CYesClicked YesClicked;                                 // 0x04C8 (size: 0x10)
    void YesClicked();
    FBP_Menu_Popup_Validation_CNoClicked NoClicked;                                   // 0x04D8 (size: 0x10)
    void NoClicked();
    FText TitleText;                                                                  // 0x04E8 (size: 0x18)
    FText PrimaryText;                                                                // 0x0500 (size: 0x18)
    FText SecondaryText;                                                              // 0x0518 (size: 0x18)
    FText YesText;                                                                    // 0x0530 (size: 0x18)
    FText NoText;                                                                     // 0x0548 (size: 0x18)
    FBP_Menu_Popup_Validation_COnHideAnimationFinished OnHideAnimationFinished;       // 0x0560 (size: 0x10)
    void OnHideAnimationFinished();
    bool Animated;                                                                    // 0x0570 (size: 0x1)
    bool VerticalButtons;                                                             // 0x0571 (size: 0x1)
    bool Warning;                                                                     // 0x0572 (size: 0x1)
    float HideAnimationPlayRate;                                                      // 0x0574 (size: 0x4)
    bool PlayAnimationOnHidden;                                                       // 0x0578 (size: 0x1)
    bool LastResultValidated;                                                         // 0x0579 (size: 0x1)

    void ShowAdditionalWarning(bool Show);
