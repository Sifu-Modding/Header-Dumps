...
{
    uint8 bIsNetDirty;                                                                // 0x00CC (size: 0x1)
    TArray<class UGameplayTask*> SimulatedTasks;                                      // 0x00D0 (size: 0x10)
    TArray<class UGameplayTask*> TaskPriorityQueue;                                   // 0x00E0 (size: 0x10)
    TArray<class UGameplayTask*> TickingTasks;                                        // 0x0100 (size: 0x10)
    TArray<class UGameplayTask*> KnownTasks;                                          // 0x0110 (size: 0x10)
    FGameplayTasksComponentOnClaimedResourcesChange OnClaimedResourcesChange;         // 0x0120 (size: 0x10)
