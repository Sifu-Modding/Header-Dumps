...
enum class EArenaUnlockingBehavior {
    AllStarsCount = 0,
    OnlyPreviousBatchStarsCount = 1,
    EArenaUnlockingBehavior_MAX = 2,
};
...
enum class EDeadZoneTypes {
    Collision = 0,
    CharacterOcclusion = 1,
    Merged = 2,
    EDeadZoneTypes_MAX = 3,
};
...
enum class EGameOptionTypes {
    ...
    ReduceEffectIntensity = 41,
    UseSmallScreenSize = 42,
    Count = 43,
    None = 44,
    EGameOptionTypes_MAX = 45,
};
...
enum class ESCDateTimeTextStyle {
    Default = 0,
    Short = 1,
    Medium = 2,
    Long = 3,
    Full = 4,
    ESCDateTimeTextStyle_MAX = 5,
};
...
enum class ESpecificForceSavecDeprecationPart {
    SkillConsolidationLevel = 0,
    ESpecificForceSavecDeprecationPart_MAX = 1,
};
...
enum class EStartObjectiveReason {
    TimerElapsed = 0,
    PlayerMoved = 1,
    EStartObjectiveReason_MAX = 2,
};
...
enum class ETraversalComputationBehavior {
    Complete = 0,
    FirstImpactOnly = 1,
    SpecificTraversalTypeChecksOnyly = 2,
    ETraversalComputationBehavior_MAX = 3,
};
...
enum class EWorldTravelLoadSaveStrategy {
    ...
    LoadOnly = 2,
    SaveThenLoad = 3,
    UseDefaultSaveMode = 4,
    EWorldTravelLoadSaveStrategy_MAX = 5,
};
