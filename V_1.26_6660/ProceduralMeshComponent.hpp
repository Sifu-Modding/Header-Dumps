...
{
    bool bUseComplexAsSimpleCollision;                                                // 0x04C0 (size: 0x1)
    bool bUseAsyncCooking;                                                            // 0x04C1 (size: 0x1)
    class UBodySetup* ProcMeshBodySetup;                                              // 0x04C8 (size: 0x8)
    TArray<FProcMeshSection> ProcMeshSections;                                        // 0x04D0 (size: 0x10)
    TArray<FKConvexElem> CollisionConvexElems;                                        // 0x04E0 (size: 0x10)
    FBoxSphereBounds LocalBounds;                                                     // 0x04F0 (size: 0x1C)
    TArray<class UBodySetup*> AsyncBodySetupQueue;                                    // 0x0510 (size: 0x10)
