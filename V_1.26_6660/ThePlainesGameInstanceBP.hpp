...
class UThePlainesGameInstanceBP_C : public UThePlainesGameInstance
{
    ...
    int32 SchoolGameModeRequirement;                                                  // 0x0588 (size: 0x4)
    TArray<class UAkAudioBank*> GenericSoundBanks;                                    // 0x0590 (size: 0x10)
    FName mapTap;                                                                     // 0x05A0 (size: 0x8)
    int32 iSnapshotID;                                                                // 0x05A8 (size: 0x4)
    TArray<class UMaterialInterface*> LevelSelectMaterials_Transient;                 // 0x05B0 (size: 0x10)
    TArray<TSoftObjectPtr<UMaterialInterface>> LevelSelectMaterials_TempSoftRef;      // 0x05C0 (size: 0x10)
    class UUserWidget* gameIntentPopup;                                               // 0x05D0 (size: 0x8)
