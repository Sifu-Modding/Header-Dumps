...
{
    FEnvelopeFollowerListenerOnEnvelopeFollowerUpdate OnEnvelopeFollowerUpdate;       // 0x00C0 (size: 0x10)
...
{
    float Frequency;                                                                  // 0x06D0 (size: 0x4)
    float Volume;                                                                     // 0x06D4 (size: 0x4)
