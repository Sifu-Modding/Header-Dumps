...
class ATransformGizmoActor : public AGizmoActor
{
    ...
    class UPrimitiveComponent* UniformScale;                                          // 0x02F8 (size: 0x8)
    class UPrimitiveComponent* AxisScaleX;                                            // 0x0300 (size: 0x8)
    class UPrimitiveComponent* AxisScaleY;                                            // 0x0308 (size: 0x8)
    class UPrimitiveComponent* AxisScaleZ;                                            // 0x0310 (size: 0x8)
    class UPrimitiveComponent* PlaneScaleYZ;                                          // 0x0318 (size: 0x8)
    class UPrimitiveComponent* PlaneScaleXZ;                                          // 0x0320 (size: 0x8)
    class UPrimitiveComponent* PlaneScaleXY;                                          // 0x0328 (size: 0x8)
...
class UBaseBrushTool : public UMeshSurfacePointTool
{
    ...
    FBrushStampData LastBrushStamp;                                                   // 0x00D0 (size: 0xAC)
    TSoftClassPtr<UBrushBaseProperties> PropertyClass;                                // 0x0190 (size: 0x28)
    class UBrushStampIndicator* BrushStampIndicator;                                  // 0x01B8 (size: 0x8)
...
{
    FVector Direction;                                                                // 0x04B0 (size: 0xC)
    float Gap;                                                                        // 0x04BC (size: 0x4)
    float Length;                                                                     // 0x04C0 (size: 0x4)
    float Thickness;                                                                  // 0x04C4 (size: 0x4)
...
{
    FLinearColor Color;                                                               // 0x0490 (size: 0x10)
    float HoverSizeMultiplier;                                                        // 0x04A0 (size: 0x4)
    float PixelHitDistanceThreshold;                                                  // 0x04A4 (size: 0x4)
...
{
    FVector Origin;                                                                   // 0x04B0 (size: 0xC)
    FQuat Rotation;                                                                   // 0x04C0 (size: 0x10)
    FVector Dimensions;                                                               // 0x04D0 (size: 0xC)
    float LineThickness;                                                              // 0x04DC (size: 0x4)
    bool bRemoveHiddenLines;                                                          // 0x04E0 (size: 0x1)
    bool bEnableAxisFlip;                                                             // 0x04E1 (size: 0x1)

}; // Size: 0x4F0

class UGizmoCircleComponent : public UGizmoBaseComponent
{
    FVector Normal;                                                                   // 0x04B0 (size: 0xC)
    float Radius;                                                                     // 0x04BC (size: 0x4)
    float Thickness;                                                                  // 0x04C0 (size: 0x4)
    int32 NumSides;                                                                   // 0x04C4 (size: 0x4)
    bool bViewAligned;                                                                // 0x04C8 (size: 0x1)
    bool bOnlyAllowFrontFacingHits;                                                   // 0x04C9 (size: 0x1)
...
{
    FVector Normal;                                                                   // 0x04B0 (size: 0xC)
    float HandleSize;                                                                 // 0x04BC (size: 0x4)
    float Thickness;                                                                  // 0x04C0 (size: 0x4)
    FVector Direction;                                                                // 0x04C4 (size: 0xC)
    float Length;                                                                     // 0x04D0 (size: 0x4)
    bool bImageScale;                                                                 // 0x04D4 (size: 0x1)
...
{
    FVector DirectionX;                                                               // 0x04B0 (size: 0xC)
    FVector DirectionY;                                                               // 0x04BC (size: 0xC)
    float OffsetX;                                                                    // 0x04C8 (size: 0x4)
    float OffsetY;                                                                    // 0x04CC (size: 0x4)
    float LengthX;                                                                    // 0x04D0 (size: 0x4)
    float LengthY;                                                                    // 0x04D4 (size: 0x4)
    float Thickness;                                                                  // 0x04D8 (size: 0x4)
    uint8 SegmentFlags;                                                               // 0x04DC (size: 0x1)
