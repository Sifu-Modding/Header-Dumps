#ifndef UE4SS_SDK_BP_SqueakyToy_HPP
#define UE4SS_SDK_BP_SqueakyToy_HPP

class UBP_SqueakyToy_C : public UBP_GameplayCheatMaster_C
{
    ...
    void ExecuteUbergraph_BP_SqueakyToy(int32 EntryPoint);
}; // Size: 0x48
