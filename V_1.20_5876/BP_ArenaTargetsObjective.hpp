...
class UBP_ArenaTargetsObjective_C : public UArenaTargetsObjective
{
    ...
    FBP_ArenaTargetsObjective_COnCounterIncremented OnCounterIncremented;             // 0x02E8 (size: 0x10)
    void OnCounterIncremented(class UBP_ArenaTargetsObjective_C* Objective);
    FBP_ArenaTargetsObjective_COnTargetDown OnTargetDown;                             // 0x02F8 (size: 0x10)
    void OnTargetDown(class AAISpawner* TargetDown);
    bool PlayerPawnReady;                                                             // 0x0308 (size: 0x1)
    FBP_ArenaTargetsObjective_COnPlayerPawnReady OnPlayerPawnReady;                   // 0x0310 (size: 0x10)
