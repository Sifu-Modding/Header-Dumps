...
class ASCCharacter : public ACharacter
{
    ...
    FName m_ImpostorName;                                                             // 0x05A4 (size: 0x8)
    bool m_bCanUnspawn;                                                               // 0x05AC (size: 0x1)
    bool m_bCanSpawnImpostor;                                                         // 0x05AD (size: 0x1)
    bool m_bIsPooled;                                                                 // 0x05AE (size: 0x1)
    bool m_bPooledActorActive;                                                        // 0x05AF (size: 0x1)
    TSubclassOf<class USCCharacterPoseData> m_PoseDataClass;                          // 0x0638 (size: 0x8)
    bool m_bDontCreateClotOnLowerEndPlatforms;                                        // 0x0640 (size: 0x1)
    ECharacterGender m_eGender;                                                       // 0x0641 (size: 0x1)
...
class USCCoreSettings : public UDeveloperSettings
{
    ...
    float m_fMaxAICharacterCorpseTimeout;                                             // 0x076C (size: 0x4)
    int32 m_iMaxAICharacterCorpse;                                                    // 0x0770 (size: 0x4)
    int32 m_iMaxAIImpostors;                                                          // 0x0774 (size: 0x4)
    bool m_bActorPoolsEnabled;                                                        // 0x0778 (size: 0x1)
...
{
    bool m_bEnableDevMode;                                                            // 0x0210 (size: 0x1)
    TArray<class UObject*> m_ObjectToLoadAtBegining;                                  // 0x0288 (size: 0x10)
    class UCurveFloat* m_HudOffsetFromBlackBarWhenAboveDefaultRatioRuntime;           // 0x0298 (size: 0x8)
    class UCurveFloat* m_HudOffsetFromBlackBarWhenBelowDefaultRatioRuntime;           // 0x02A0 (size: 0x8)
