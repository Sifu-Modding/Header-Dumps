...
class UBP_HUD_ComboXP_C : public UInGameNotification
{
    ...
    EAlertLevel K2Node_CustomEvent_eAlertLevel;                                       // 0x04C0 (size: 0x1)
    bool K2Node_SwitchEnum_CmpSuccess;                                                // 0x04C1 (size: 0x1)
    FBP_HUD_ComboXP_CK2Node_CreateDelegate_OutputDelegate_2 K2Node_CreateDelegate_OutputDelegate_2; // 0x04C4 (size: 0x10)
    ...
    FBP_HUD_ComboXP_CK2Node_CreateDelegate_OutputDelegate_6 K2Node_CreateDelegate_OutputDelegate_6; // 0x0504 (size: 0x10)
    ...
    float K2Node_CustomEvent_CurrentSavedHighscore;                                   // 0x0514 (size: 0x4)
    float K2Node_CustomEvent_CurrentLevelScore;                                       // 0x0518 (size: 0x4)
    bool K2Node_CustomEvent_NewHighscoreReached;                                      // 0x051C (size: 0x1)
    float CallFunc_BreakVector2D_X;                                                   // 0x0520 (size: 0x4)
    float CallFunc_BreakVector2D_Y;                                                   // 0x0524 (size: 0x4)
    FBP_HUD_ComboXP_CK2Node_CreateDelegate_OutputDelegate_7 K2Node_CreateDelegate_OutputDelegate_7; // 0x0528 (size: 0x10)
    void AlertLevelChanged(EAlertLevel EAlertLevel);
    float K2Node_CustomEvent_OldValue;                                                // 0x0538 (size: 0x4)
    float K2Node_CustomEvent_NewValue;                                                // 0x053C (size: 0x4)
    FUI_Base_Colors CallFunc_GetUI_Colors_BaseColors;                                 // 0x0540 (size: 0xE8)
    FUI_GameplayColors CallFunc_GetUI_Colors_GameplayColors;                          // 0x0628 (size: 0x160)
    FUI_ElementColors CallFunc_GetUI_Colors_ElementColors;                            // 0x0788 (size: 0x50)
    FSlateColor K2Node_MakeStruct_SlateColor;                                         // 0x07D8 (size: 0x28)
    ECharacterStat K2Node_CustomEvent__type;                                          // 0x0800 (size: 0x1)
    int32 K2Node_CustomEvent__previousValue;                                          // 0x0804 (size: 0x4)
    int32 K2Node_CustomEvent__currentValue;                                           // 0x0808 (size: 0x4)
    FBP_HUD_ComboXP_CK2Node_CreateDelegate_OutputDelegate_8 K2Node_CreateDelegate_OutputDelegate_8; // 0x080C (size: 0x10)
    void ED_OnEfficiencyChanged(float bpp__OldValue__pf, float bpp__NewValue__pf);
    bool K2Node_SwitchEnum_CmpSuccess_1;                                              // 0x081C (size: 0x1)
