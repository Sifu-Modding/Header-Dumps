...
class AFightingPlayerControllerBP_C : public AFightingPlayerController
{
    ...
    class UBP_HUD_ArenaContainer_C* PlayerHudArena;                                   // 0x1440 (size: 0x8)
    class UBP_Menu_Debug_C* DebugMenu;                                                // 0x1448 (size: 0x8)
    FFightingPlayerControllerBP_CFightingPlayerRespawn FightingPlayerRespawn;         // 0x1450 (size: 0x10)
    void FightingPlayerRespawn();
    class UBP_HUD_Tuto_C* PlayerHUDTuto;                                              // 0x1460 (size: 0x8)
    FFightingPlayerControllerBP_CPawnInitialized PawnInitialized;                     // 0x1468 (size: 0x10)
    void PawnInitialized();
    FInteractionTextStruct InteractionTextStruct;                                     // 0x1478 (size: 0x38)
    class UBP_HUD_AutoSave_C* AutoSaveWidget;                                         // 0x14B0 (size: 0x8)
    class UInteractionObjectComponent* InteractionObjectComponent;                    // 0x14B8 (size: 0x8)
    class UWidget* PermanentHUD;                                                      // 0x14C0 (size: 0x8)
    class UGenericErrorPopupWidget* PopupWidget;                                      // 0x14C8 (size: 0x8)
    FText InteractionLockedText;                                                      // 0x14D0 (size: 0x18)
    bool InteractionUseLockedText;                                                    // 0x14E8 (size: 0x1)
    FFightingPlayerControllerBP_CRestartAsked RestartAsked;                           // 0x14F0 (size: 0x10)
    void RestartAsked();
    class ABP_PostCardScreenActor_C* EndPostCardEffet;                                // 0x1500 (size: 0x8)
    FFightingPlayerControllerBP_CSkillTreeAssigned SkillTreeAssigned;                 // 0x1508 (size: 0x10)
    void SkillTreeAssigned();
    class UNEW_BP_HUD_Tutorial_C* NewHUDTutorial;                                     // 0x1518 (size: 0x8)
    FFightingPlayerControllerBP_CSkipToNextTutorialPhase SkipToNextTutorialPhase;     // 0x1520 (size: 0x10)
    void SkipToNextTutorialPhase();
    bool DebugHideDeathMenu;                                                          // 0x1530 (size: 0x1)
    TArray<FMenuRequestStructure> InGameMenuRequests;                                 // 0x1538 (size: 0x10)
    bool HideFocus;                                                                   // 0x1548 (size: 0x1)
    bool HideScoring;                                                                 // 0x1549 (size: 0x1)
    class UBP_HUD_TrainingRoom_C* HUDTraining;                                        // 0x1550 (size: 0x8)
    class UBP_HUD_ReplayRecording_C* ReplayRecordingWidget;                           // 0x1558 (size: 0x8)
