...
{
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x00C0 (size: 0x14)
    class UActorSequence* Sequence;                                                   // 0x00D8 (size: 0x8)
    class UActorSequencePlayer* SequencePlayer;                                       // 0x00E0 (size: 0x8)
