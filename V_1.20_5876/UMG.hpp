...
{
    FMovieSceneFloatChannel TopCurve;                                                 // 0x0038 (size: 0xA0)
    FMovieSceneFloatChannel LeftCurve;                                                // 0x00D8 (size: 0xA0)
    FMovieSceneFloatChannel RightCurve;                                               // 0x0178 (size: 0xA0)
    FMovieSceneFloatChannel BottomCurve;                                              // 0x0218 (size: 0xA0)
...
{
    bool bDistributeItemsEvenly;                                                      // 0x0000 (size: 0x1)
    float AngleBetweenItems;                                                          // 0x0004 (size: 0x4)
    float StartingAngle;                                                              // 0x0008 (size: 0x4)
...
class UDynamicEntryBoxBase : public UWidget
{
    ...
    FRadialBoxSettings RadialBoxSettings;                                             // 0x0138 (size: 0xC)
...
{
    FMovieSceneFloatChannel TopCurve;                                                 // 0x00E8 (size: 0xA0)
    FMovieSceneFloatChannel LeftCurve;                                                // 0x0188 (size: 0xA0)
    FMovieSceneFloatChannel RightCurve;                                               // 0x0228 (size: 0xA0)
    FMovieSceneFloatChannel BottomCurve;                                              // 0x02C8 (size: 0xA0)
...
{
    TArray<FName> BrushPropertyNamePath;                                              // 0x0090 (size: 0x10)
    FName TrackName;                                                                  // 0x00A0 (size: 0x8)
...
class UScrollBox : public UPanelWidget
{
    ...
    void ScrollWidgetIntoView(class UWidget* WidgetToFind, bool AnimateScroll, FVector2D ScrollOffset, EDescendantScrollDestination ScrollDestination, float Padding);
    void ScrollToStart();
    void ScrollToEnd();
...
class USlider : public UWidget
{
    ...
    FSliderOnFocusLostDelegate OnFocusLostDelegate;                                   // 0x04E8 (size: 0x10)
    void OnFocusLostDelegateEvent();
    FSliderOnFocusReceivedDelegate OnFocusReceivedDelegate;                           // 0x04F8 (size: 0x10)
    void OnFocusReceivedDelegateEvent();
...
{
    class UWidgetAnimation* Animation;                                                // 0x0410 (size: 0x8)
    FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                   // 0x0420 (size: 0xE8)
...
class UUserWidget : public UWidget
{
    ...
    bool bInvalidateOnAnimation;                                                      // 0x0120 (size: 0x1)
    FUserWidgetColorAndOpacityDelegate ColorAndOpacityDelegate;                       // 0x0124 (size: 0x10)
    FLinearColor GetLinearColor();
    FSlateColor ForegroundColor;                                                      // 0x0138 (size: 0x28)
    FUserWidgetForegroundColorDelegate ForegroundColorDelegate;                       // 0x0160 (size: 0x10)
    FSlateColor GetSlateColor();
    FUserWidgetOnVisibilityChanged OnVisibilityChanged;                               // 0x0170 (size: 0x10)
    void OnVisibilityChangedEvent(ESlateVisibility InVisibility);
    FMargin Padding;                                                                  // 0x0198 (size: 0x10)
    TArray<class UUMGSequencePlayer*> ActiveSequencePlayers;                          // 0x01A8 (size: 0x10)
    class UUMGSequenceTickManager* AnimationTickManager;                              // 0x01B8 (size: 0x8)
    TArray<class UUMGSequencePlayer*> StoppedSequencePlayers;                         // 0x01C0 (size: 0x10)
    TArray<FNamedSlotBinding> NamedSlotBindings;                                      // 0x01D0 (size: 0x10)
    class UWidgetTree* WidgetTree;                                                    // 0x01E0 (size: 0x8)
    int32 Priority;                                                                   // 0x01E8 (size: 0x4)
    uint8 bSupportsKeyboardFocus;                                                     // 0x01EC (size: 0x1)
    uint8 bIsFocusable;                                                               // 0x01EC (size: 0x1)
    uint8 bStopAction;                                                                // 0x01EC (size: 0x1)
    uint8 bHasScriptImplementedTick;                                                  // 0x01EC (size: 0x1)
    uint8 bHasScriptImplementedPaint;                                                 // 0x01EC (size: 0x1)
    EWidgetTickFrequency TickFrequency;                                               // 0x01F8 (size: 0x1)
    class UInputComponent* InputComponent;                                            // 0x0200 (size: 0x8)
    TArray<FAnimationEventBinding> AnimationCallbacks;                                // 0x0208 (size: 0x10)
...
{
    EWidgetSpace Space;                                                               // 0x04B8 (size: 0x1)
    EWidgetTimingPolicy TimingPolicy;                                                 // 0x04B9 (size: 0x1)
    TSubclassOf<class UUserWidget> WidgetClass;                                       // 0x04C0 (size: 0x8)
    FIntPoint DrawSize;                                                               // 0x04C8 (size: 0x8)
    bool bManuallyRedraw;                                                             // 0x04D0 (size: 0x1)
    bool bRedrawRequested;                                                            // 0x04D1 (size: 0x1)
    float RedrawTime;                                                                 // 0x04D4 (size: 0x4)
    FIntPoint CurrentDrawSize;                                                        // 0x04E0 (size: 0x8)
    bool bDrawAtDesiredSize;                                                          // 0x04E8 (size: 0x1)
    FVector2D Pivot;                                                                  // 0x04EC (size: 0x8)
    bool bReceiveHardwareInput;                                                       // 0x04F4 (size: 0x1)
    bool bWindowFocusable;                                                            // 0x04F5 (size: 0x1)
    EWindowVisibility WindowVisibility;                                               // 0x04F6 (size: 0x1)
    bool bApplyGammaCorrection;                                                       // 0x04F7 (size: 0x1)
    class ULocalPlayer* OwnerPlayer;                                                  // 0x04F8 (size: 0x8)
    FLinearColor BackgroundColor;                                                     // 0x0500 (size: 0x10)
    FLinearColor TintColorAndOpacity;                                                 // 0x0510 (size: 0x10)
    float OpacityFromTexture;                                                         // 0x0520 (size: 0x4)
    EWidgetBlendMode BlendMode;                                                       // 0x0524 (size: 0x1)
    bool bIsTwoSided;                                                                 // 0x0525 (size: 0x1)
    bool TickWhenOffscreen;                                                           // 0x0526 (size: 0x1)
    class UBodySetup* BodySetup;                                                      // 0x0528 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial;                                    // 0x0530 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial_OneSided;                           // 0x0538 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial;                                         // 0x0540 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial_OneSided;                                // 0x0548 (size: 0x8)
    class UMaterialInterface* MaskedMaterial;                                         // 0x0550 (size: 0x8)
    class UMaterialInterface* MaskedMaterial_OneSided;                                // 0x0558 (size: 0x8)
    class UTextureRenderTarget2D* RenderTarget;                                       // 0x0560 (size: 0x8)
    class UMaterialInstanceDynamic* MaterialInstance;                                 // 0x0568 (size: 0x8)
    bool bAddedToScreen;                                                              // 0x0570 (size: 0x1)
    bool bEditTimeUsable;                                                             // 0x0571 (size: 0x1)
    FName SharedLayerName;                                                            // 0x0574 (size: 0x8)
    int32 LayerZOrder;                                                                // 0x057C (size: 0x4)
    EWidgetGeometryMode GeometryMode;                                                 // 0x0580 (size: 0x1)
    float CylinderArcAngle;                                                           // 0x0584 (size: 0x4)
    ETickMode TickMode;                                                               // 0x0588 (size: 0x1)
    class UUserWidget* Widget;                                                        // 0x05B0 (size: 0x8)
...
{
    FWidgetInteractionComponentOnHoveredWidgetChanged OnHoveredWidgetChanged;         // 0x0208 (size: 0x10)
    void OnHoveredWidgetChanged(class UWidgetComponent* WidgetComponent, class UWidgetComponent* PreviousWidgetComponent);
    int32 VirtualUserIndex;                                                           // 0x0228 (size: 0x4)
    int32 PointerIndex;                                                               // 0x022C (size: 0x4)
    TEnumAsByte<ECollisionChannel> TraceChannel;                                      // 0x0230 (size: 0x1)
    float InteractionDistance;                                                        // 0x0234 (size: 0x4)
    EWidgetInteractionSource InteractionSource;                                       // 0x0238 (size: 0x1)
    bool bEnableHitTesting;                                                           // 0x0239 (size: 0x1)
    bool bShowDebug;                                                                  // 0x023A (size: 0x1)
    float DebugSphereLineThickness;                                                   // 0x023C (size: 0x4)
    float DebugLineThickness;                                                         // 0x0240 (size: 0x4)
    FLinearColor DebugColor;                                                          // 0x0244 (size: 0x10)
    FHitResult CustomHitResult;                                                       // 0x02D0 (size: 0x8C)
    FVector2D LocalHitLocation;                                                       // 0x035C (size: 0x8)
    FVector2D LastLocalHitLocation;                                                   // 0x0364 (size: 0x8)
    class UWidgetComponent* HoveredWidgetComponent;                                   // 0x0370 (size: 0x8)
    FHitResult LastHitResult;                                                         // 0x0378 (size: 0x8C)
    bool bIsHoveredWidgetInteractable;                                                // 0x0404 (size: 0x1)
    bool bIsHoveredWidgetFocusable;                                                   // 0x0405 (size: 0x1)
    bool bIsHoveredWidgetHitTestVisible;                                              // 0x0406 (size: 0x1)
