...
class ABP_TPSCharacter_C : public AFightingCharacter
{
    ...
    class ULevelSequenceAnimReplicationComponent* LevelSequenceAnimReplication;       // 0x15A8 (size: 0x8)
    class UParticleSystemComponent* Fx_DiszzyState;                                   // 0x15B0 (size: 0x8)
    class UAkComponent* Ak;                                                           // 0x15B8 (size: 0x8)
    class UPredictionComponent* Prediction;                                           // 0x15C0 (size: 0x8)
    class UBPAttackComponent_C* Attack;                                               // 0x15C8 (size: 0x8)
    class UHitComponent* Hit;                                                         // 0x15D0 (size: 0x8)
    float Timeline_Light_NewTrack_0_C675BB2543B43D8D0A43248F878EC08E;                 // 0x15D8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_Light__Direction_C675BB2543B43D8D0A43248F878EC08E; // 0x15DC (size: 0x1)
    class UTimelineComponent* Timeline_Light;                                         // 0x15E0 (size: 0x8)
    float Parry_RightArm_Alpha_92B20BC542C9B1A65E144E90A552562B;                      // 0x15E8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Parry_RightArm__Direction_92B20BC542C9B1A65E144E90A552562B; // 0x15EC (size: 0x1)
    class UTimelineComponent* Parry_RightArm;                                         // 0x15F0 (size: 0x8)
    float Parry_LeftArm_Alpha_62FF55844B8D250702A82CB178D5C428;                       // 0x15F8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Parry_LeftArm__Direction_62FF55844B8D250702A82CB178D5C428; // 0x15FC (size: 0x1)
    class UTimelineComponent* Parry_LeftArm;                                          // 0x1600 (size: 0x8)
    float Parry_RightLeg_Alpha_A850D2C34FB455862E6445BA7288656E;                      // 0x1608 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Parry_RightLeg__Direction_A850D2C34FB455862E6445BA7288656E; // 0x160C (size: 0x1)
    class UTimelineComponent* Parry_RightLeg;                                         // 0x1610 (size: 0x8)
    float Parry_LeftLeg_Alpha_F88C665148748DE78D3EEB8B98176FB3;                       // 0x1618 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Parry_LeftLeg__Direction_F88C665148748DE78D3EEB8B98176FB3; // 0x161C (size: 0x1)
    class UTimelineComponent* Parry_LeftLeg;                                          // 0x1620 (size: 0x8)
    float Interrupt_LeftArm_Alpha_BC6648294E8618FCC977059874749923;                   // 0x1628 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Interrupt_LeftArm__Direction_BC6648294E8618FCC977059874749923; // 0x162C (size: 0x1)
    class UTimelineComponent* Interrupt_LeftArm;                                      // 0x1630 (size: 0x8)
    float Interrupt_RightArm_Alpha_CA38A5FB4709D80FF95012B47B6E3A71;                  // 0x1638 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Interrupt_RightArm__Direction_CA38A5FB4709D80FF95012B47B6E3A71; // 0x163C (size: 0x1)
    class UTimelineComponent* Interrupt_RightArm;                                     // 0x1640 (size: 0x8)
    float Interrupt_RightLeg_Alpha_E05104EB43437DCAB6FF8DAAC6A2F692;                  // 0x1648 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Interrupt_RightLeg__Direction_E05104EB43437DCAB6FF8DAAC6A2F692; // 0x164C (size: 0x1)
    class UTimelineComponent* Interrupt_RightLeg;                                     // 0x1650 (size: 0x8)
    float Interrupt_LeftLeg_Alpha_5BF0D0354403BA06334B2D8B2251788E;                   // 0x1658 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Interrupt_LeftLeg__Direction_5BF0D0354403BA06334B2D8B2251788E; // 0x165C (size: 0x1)
    class UTimelineComponent* Interrupt_LeftLeg;                                      // 0x1660 (size: 0x8)
    float Timeline_ShadowAvoided_Alpha_02BF697346A8B396585E3B9D15393054;              // 0x1668 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_ShadowAvoided__Direction_02BF697346A8B396585E3B9D15393054; // 0x166C (size: 0x1)
    class UTimelineComponent* Timeline_ShadowAvoided;                                 // 0x1670 (size: 0x8)
    float Timeline_AbsorbLight_End_Dissolve_C95A74094946B500A3D85F9EA4A7498F;         // 0x1678 (size: 0x4)
    float Timeline_AbsorbLight_End_Alpha_C95A74094946B500A3D85F9EA4A7498F;            // 0x167C (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_AbsorbLight_End__Direction_C95A74094946B500A3D85F9EA4A7498F; // 0x1680 (size: 0x1)
    class UTimelineComponent* Timeline_AbsorbLight_End;                               // 0x1688 (size: 0x8)
    float GuardBreak_RightArm_Alpha_6C6053554B5690EC7EEA569DC05D1C95;                 // 0x1690 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> GuardBreak_RightArm__Direction_6C6053554B5690EC7EEA569DC05D1C95; // 0x1694 (size: 0x1)
    class UTimelineComponent* GuardBreak_RightArm;                                    // 0x1698 (size: 0x8)
    float GuardBreak_LeftArm_Alpha_257AAF54478843A761B47F897F786E67;                  // 0x16A0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> GuardBreak_LeftArm__Direction_257AAF54478843A761B47F897F786E67; // 0x16A4 (size: 0x1)
    class UTimelineComponent* GuardBreak_LeftArm;                                     // 0x16A8 (size: 0x8)
    float GuardBreak_RightLeg_Alpha_397765A44981B683023FEC8599824104;                 // 0x16B0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> GuardBreak_RightLeg__Direction_397765A44981B683023FEC8599824104; // 0x16B4 (size: 0x1)
    class UTimelineComponent* GuardBreak_RightLeg;                                    // 0x16B8 (size: 0x8)
    float GuardBreak_LeftLeg_Alpha_A9A5DCEA45B915F1B5E3DFAA2D277379;                  // 0x16C0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> GuardBreak_LeftLeg__Direction_A9A5DCEA45B915F1B5E3DFAA2D277379; // 0x16C4 (size: 0x1)
    class UTimelineComponent* GuardBreak_LeftLeg;                                     // 0x16C8 (size: 0x8)
    float Timeline_Parried_GlobalOpacity_9D7A75994ACE3E87517DA89516D96FA4;            // 0x16D0 (size: 0x4)
    float Timeline_Parried_NewTrack_0_9D7A75994ACE3E87517DA89516D96FA4;               // 0x16D4 (size: 0x4)
    float Timeline_Parried_WaveScale_9D7A75994ACE3E87517DA89516D96FA4;                // 0x16D8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_Parried__Direction_9D7A75994ACE3E87517DA89516D96FA4; // 0x16DC (size: 0x1)
    class UTimelineComponent* Timeline_Parried;                                       // 0x16E0 (size: 0x8)
    float Timeline_Absorb_Dissolve_97E790414C8F30B0177ACFAE616E1ADD;                  // 0x16E8 (size: 0x4)
    float Timeline_Absorb_Alpha_97E790414C8F30B0177ACFAE616E1ADD;                     // 0x16EC (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_Absorb__Direction_97E790414C8F30B0177ACFAE616E1ADD; // 0x16F0 (size: 0x1)
    class UTimelineComponent* Timeline_Absorb;                                        // 0x16F8 (size: 0x8)
    float Timeline_Avoid_Alpha_7A57E72B4AFC72CAE67D8BBCD5C59490;                      // 0x1700 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_Avoid__Direction_7A57E72B4AFC72CAE67D8BBCD5C59490; // 0x1704 (size: 0x1)
    class UTimelineComponent* Timeline_Avoid;                                         // 0x1708 (size: 0x8)
    float PL_RightLeg_Alpha_DDF780584FA215E535E72AB855D7D260;                         // 0x1710 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> PL_RightLeg__Direction_DDF780584FA215E535E72AB855D7D260; // 0x1714 (size: 0x1)
    class UTimelineComponent* PL_RightLeg;                                            // 0x1718 (size: 0x8)
    float PL_LeftLeg_Alpha_4E08FC2844E8F4E0BFB5D3BD41E72E29;                          // 0x1720 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> PL_LeftLeg__Direction_4E08FC2844E8F4E0BFB5D3BD41E72E29; // 0x1724 (size: 0x1)
    class UTimelineComponent* PL_LeftLeg;                                             // 0x1728 (size: 0x8)
    float PL_RightArm_Alpha_BC86B30B42F1A423C8A5448C91674400;                         // 0x1730 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> PL_RightArm__Direction_BC86B30B42F1A423C8A5448C91674400; // 0x1734 (size: 0x1)
    class UTimelineComponent* PL_RightArm;                                            // 0x1738 (size: 0x8)
    float PL_LeftArm_Alpha_E63FBEF547EE841E3294F09303B39F33;                          // 0x1740 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> PL_LeftArm__Direction_E63FBEF547EE841E3294F09303B39F33; // 0x1744 (size: 0x1)
    class UTimelineComponent* PL_LeftArm;                                             // 0x1748 (size: 0x8)
    FVector ImpactCapsulePosition;                                                    // 0x1750 (size: 0xC)
    FVector ImpactDir;                                                                // 0x175C (size: 0xC)
    float HitStunTime;                                                                // 0x1768 (size: 0x4)
    bool StructureJustBroken;                                                         // 0x176C (size: 0x1)
    float AttackDamage;                                                               // 0x1770 (size: 0x4)
    float TargetDist;                                                                 // 0x1774 (size: 0x4)
    FBP_TPSCharacter_CTPSChar_Died TPSChar_Died;                                      // 0x1778 (size: 0x10)
    void TPSChar_Died(class ABP_TPSCharacter_C* Dead TPSCharacter, class AActor* HitInstigator);
    FBP_TPSCharacter_CTPSChar_GuardBroken TPSChar_GuardBroken;                        // 0x1788 (size: 0x10)
    void TPSChar_GuardBroken();
    bool IsGuarding;                                                                  // 0x1798 (size: 0x1)
    FBP_TPSCharacter_CTPSChar_Dodge TPSChar_Dodge;                                    // 0x17A0 (size: 0x10)
    void TPSChar_Dodge();
    FBP_TPSCharacter_CTPSChar_DoParry TPSChar_DoParry;                                // 0x17B0 (size: 0x10)
    void TPSChar_DoParry(EQuadrantTypes ParryQuadrantRegardingTarget, EQuadrantTypes ParryQuadrant);
    FBP_TPSCharacter_CTPSChar_DoDodge TPSChar_DoDodge;                                // 0x17C0 (size: 0x10)
    void TPSChar_DoDodge(FVector DodgeDirection, EQuadrantTypes StartQuadrant, EQuadrantTypes EndQuadrant);
    EHeight HittedHeight;                                                             // 0x17D0 (size: 0x1)
    TArray<FName> ValidImpactBoneNameHigh;                                            // 0x17D8 (size: 0x10)
    TArray<FName> ValidImpactBoneNameMid;                                             // 0x17E8 (size: 0x10)
    TArray<FName> ValidImpactBoneNameLow_L;                                           // 0x17F8 (size: 0x10)
    TArray<FName> ValidImpactBoneNameLow_R;                                           // 0x1808 (size: 0x10)
    FVector WidgetOffset;                                                             // 0x1818 (size: 0xC)
    class ABP_AvoidGhost_01_C* AvoidGhost;                                            // 0x1828 (size: 0x8)
    FVector2D LocalParriedScreenLocation;                                             // 0x1830 (size: 0x8)
    uint8 AttackStrikeNumber;                                                         // 0x1838 (size: 0x1)
    class AActor* HitInstigator;                                                      // 0x1840 (size: 0x8)
    FBP_TPSCharacter_CTPSChar_DoAbsorb TPSChar_DoAbsorb;                              // 0x1848 (size: 0x10)
    void TPSChar_DoAbsorb();
    FBP_TPSCharacter_CTPSChar_DoAvoid TPSChar_DoAvoid;                                // 0x1858 (size: 0x10)
    void TPSChar_DoAvoid(EAvoidType avoidType);
    float PercentRevive;                                                              // 0x1868 (size: 0x4)
    bool IsAbsorbBroken;                                                              // 0x186C (size: 0x1)
    bool AttackInPL;                                                                  // 0x186D (size: 0x1)
    bool IsAttackLethal;                                                              // 0x186E (size: 0x1)
    float AttackSpecialDamageRatio;                                                   // 0x1870 (size: 0x4)
    EAttackMovementType AttackMovement;                                               // 0x1874 (size: 0x1)
    EAttackOrigin AttackOrigin;                                                       // 0x1875 (size: 0x1)
    EAttackPowers AttackPower;                                                        // 0x1876 (size: 0x1)
    bool ShouldDisplayHeadWidget_Lock;                                                // 0x1877 (size: 0x1)
    bool ShouldDisplayHeadWidget_Damage;                                              // 0x1878 (size: 0x1)
    FTimerHandle Timer_HeadWidget;                                                    // 0x1880 (size: 0x8)
    float HeadWidgetRemainTimer;                                                      // 0x1888 (size: 0x4)
    bool ShouldDisplayHeadWidget_Coop;                                                // 0x188C (size: 0x1)
    bool ShouldDisplayHeadWidget_Attacking;                                           // 0x188D (size: 0x1)
    class UBP_HUD_Bars_Coop_C* AttachedHUDCoop;                                       // 0x1890 (size: 0x8)
    FLinearColor Sil_CharColor;                                                       // 0x1898 (size: 0x10)
    FLinearColor OW_CharColor;                                                        // 0x18A8 (size: 0x10)
    FBP_TPSCharacter_CTPSChar_RevivedSuccess TPSChar_RevivedSuccess;                  // 0x18B8 (size: 0x10)
    void TPSChar_RevivedSuccess();
    FBP_TPSCharacter_CTPSChar_Hitted TPSChar_Hitted;                                  // 0x18C8 (size: 0x10)
    void TPSChar_Hitted(class AController* ControllerInstigator, bool IsGuarding);
    bool IsAbsorbAbility;                                                             // 0x18D8 (size: 0x1)
    uint8 E Power Color;                                                              // 0x18D9 (size: 0x1)
    FLinearColor Exh_Chara;                                                           // 0x18DC (size: 0x10)
    FLinearColor Shield_CharColor;                                                    // 0x18EC (size: 0x10)
    bool ShouldDisplayHeadWidget_PvP;                                                 // 0x18FC (size: 0x1)
    TArray<EFXMaterials> CurrentMaterialsStack;                                       // 0x1900 (size: 0x10)
    EFXMaterials CurrentMaterial;                                                     // 0x1910 (size: 0x1)
    EWeaponSlot WeaponSlot;                                                           // 0x1911 (size: 0x1)
    TEnumAsByte<EPhysicalSurface> Surface Type For Whoosh;                            // 0x1912 (size: 0x1)
    class UPointLightComponent* PointLight;                                           // 0x1918 (size: 0x8)
    EImpactType ImpactType;                                                           // 0x1920 (size: 0x1)
    bool ResilientHit;                                                                // 0x1921 (size: 0x1)
    FBP_TPSCharacter_CTPSChar_DrawToRT TPSChar_DrawToRT;                              // 0x1928 (size: 0x10)
    void TPSChar_DrawToRT(class UMaterialInterface* Brush Material, FVector Location, float Size, FRotator Rotation);
    bool IsCritical;                                                                  // 0x1938 (size: 0x1)
    FHitBox LastHitHitBox;                                                            // 0x1940 (size: 0x298)
    FTransform T_HitFX;                                                               // 0x1BE0 (size: 0x30)
    FName N_HitFXName;                                                                // 0x1C10 (size: 0x8)
    TEnumAsByte<HitContexts> HitContext;                                              // 0x1C18 (size: 0x1)
    EGuardType GuardType;                                                             // 0x1C19 (size: 0x1)
    class AActor* InstigatorItem;                                                     // 0x1C20 (size: 0x8)
    bool ShouldDisplayHeadWidget_Force;                                               // 0x1C28 (size: 0x1)
    FBP_TPSCharacter_CTPSChar_AnySuccessParry TPSChar_AnySuccessParry;                // 0x1C30 (size: 0x10)
    void TPSChar_AnySuccessParry();
    FBP_TPSCharacter_CTPSChar_SuccessGuard TPSChar_SuccessGuard;                      // 0x1C40 (size: 0x10)
    void TPSChar_SuccessGuard();
    bool ShouldDisplayHeadWidget_Dizzy;                                               // 0x1C50 (size: 0x1)
    bool ShouldDisplayHeadWidget_StructureBroken;                                     // 0x1C51 (size: 0x1)
    bool ShouldDisplayKnockedDown;                                                    // 0x1C52 (size: 0x1)
    bool IsTakendown;                                                                 // 0x1C53 (size: 0x1)
    UClass* Poolable Decal;                                                           // 0x1C58 (size: 0x8)
    bool Gore Activated;                                                              // 0x1C60 (size: 0x1)
    TArray<class UAnimSequence*> HitAnimsHistory;                                     // 0x1C68 (size: 0x10)
    bool InAvoidSlowMo;                                                               // 0x1C78 (size: 0x1)
    bool DisplayHealth;                                                               // 0x1C79 (size: 0x1)
    class UMaterialInterface* Material Proxy Rain;                                    // 0x1C80 (size: 0x8)
    int32 Proxy Rain Index;                                                           // 0x1C88 (size: 0x4)
    TMap<uint8, FParticleCompArrayStruct> SpawnedParticleCompByOrderIdMap;            // 0x1C90 (size: 0x50)
    bool HitByItem;                                                                   // 0x1CE0 (size: 0x1)
    FBP_TPSCharacter_CED_AvoidSlowmo ED_AvoidSlowmo;                                  // 0x1CE8 (size: 0x10)
    void ED_AvoidSlowmo(bool InAvoidSlomo);
    TArray<FPoseSnapshot> AvoidPoses;                                                 // 0x1CF8 (size: 0x10)
    TArray<FTransform> AvoidPosesTransforms;                                          // 0x1D08 (size: 0x10)
    float AvoidGhostAppearInterval;                                                   // 0x1D18 (size: 0x4)
    FTimerHandle AvoidGhostsTimer;                                                    // 0x1D20 (size: 0x8)
    int32 AvoidGhostsCurrentID;                                                       // 0x1D28 (size: 0x4)
    TArray<TScriptInterface<IHudCarrierListener_C>> Hud Carrier Listener;             // 0x1D30 (size: 0x10)
    FPoseSnapshot SnapShotForAvoid;                                                   // 0x1D40 (size: 0x38)
    bool EnterSuperDizzy;                                                             // 0x1D78 (size: 0x1)
    class USurfacesData_C* SurfacesData;                                              // 0x1D80 (size: 0x8)
    int32 SK_Stencil Base Value;                                                      // 0x1D88 (size: 0x4)
    TArray<class ABP_DecalPoolable_C*> Blood Decal Array;                             // 0x1D90 (size: 0x10)
    bool HitDuringDialog;                                                             // 0x1DA0 (size: 0x1)
    int32 InAvoidSlowMoID;                                                            // 0x1DA4 (size: 0x4)
