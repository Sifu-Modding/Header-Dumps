...
struct FLevelSequencePlayerSnapshot
{
    ...
    bool bSimulateClothesOnFirstFrame;                                                // 0x00B0 (size: 0x1)
    FMovieSceneSequenceID ShotID;                                                     // 0x00B4 (size: 0x4)
...
{
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x02C0 (size: 0x14)
    class ULevelSequencePlayer* SequencePlayer;                                       // 0x02D8 (size: 0x8)
    FSoftObjectPath LevelSequence;                                                    // 0x02E0 (size: 0x18)
...
{
    class ALevelSequenceActor* Sequence;                                              // 0x02B8 (size: 0x8)
    class UMediaComponent* MediaComponent;                                            // 0x02C0 (size: 0x8)
    float ServerStartTimeSeconds;                                                     // 0x02C8 (size: 0x4)
...
{
    FLevelSequencePlayerSnapshot FrameInformation;                                    // 0x0268 (size: 0xB8)
    class ALevelSequenceActor* LevelSequenceActor;                                    // 0x0320 (size: 0x8)
...
class ULevelSequenceDirector : public UObject
{
    ...
    class ULevelSequence* LevelSequence;                                              // 0x0030 (size: 0x8)
...
{
    FLevelSequencePlayerOnCameraCut OnCameraCut;                                      // 0x0698 (size: 0x10)
    void OnLevelSequencePlayerCameraCutEvent(class UCameraComponent* CameraComponent);
    class ALevelSequenceActor* SequenceActor;                                         // 0x06A8 (size: 0x8)
