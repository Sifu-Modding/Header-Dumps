...
{
    FFrameNumber ForcedTime;                                                          // 0x0000 (size: 0x4)
    ESectionEvaluationFlags Flags;                                                    // 0x0008 (size: 0x1)
    uint8 bEvaluateInSequencePreRoll;                                                 // 0x0009 (size: 0x1)
    uint8 bEvaluateInSequencePostRoll;                                                // 0x0009 (size: 0x1)
...
struct FMovieSceneSpawnable
{
    ...
    bool bEvaluateTracksWhenNotSpawned;                                               // 0x0041 (size: 0x1)
...
struct FMovieSceneSubSequenceData
{
    ...
    int16 HierarchicalBias;                                                           // 0x0094 (size: 0x2)
    bool bHasHierarchicalEasing;                                                      // 0x0096 (size: 0x1)
...
{
    FMovieSceneEntitySystemGraph SystemGraph;                                         // 0x0238 (size: 0x138)
...
{
    FMovieSceneSequencePlayerOnPlay OnPlay;                                           // 0x0418 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnPlayReverse OnPlayReverse;                             // 0x0428 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnStop OnStop;                                           // 0x0438 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnPreStop OnPreStop;                                     // 0x0448 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnPause OnPause;                                         // 0x0458 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnFinished OnFinished;                                   // 0x0468 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    TEnumAsByte<EMovieScenePlayerStatus::Type> Status;                                // 0x0478 (size: 0x1)
    uint8 bReversePlayback;                                                           // 0x047C (size: 0x1)
    class UMovieSceneSequence* Sequence;                                              // 0x0480 (size: 0x8)
    FFrameNumber StartTime;                                                           // 0x0488 (size: 0x4)
    int32 DurationFrames;                                                             // 0x048C (size: 0x4)
    float DurationSubFrames;                                                          // 0x0490 (size: 0x4)
    int32 CurrentNumLoops;                                                            // 0x0494 (size: 0x4)
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x0498 (size: 0x14)
    FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                   // 0x04B0 (size: 0xE8)
    FMovieSceneSequenceReplProperties NetSyncProps;                                   // 0x0600 (size: 0x10)
    TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                 // 0x0610 (size: 0x10)
    class UMovieSceneSequenceTickManager* TickManager;                                // 0x0620 (size: 0x8)
    ...
    bool IsPaused();
    bool IsLooping();
    void GoToEndAndStop(EUpdatePositionMethod _eUpdatePositionMethod);
    int32 GetTotalNumberOfLoopWanted();
...
{
    TArray<class AActor*> SequenceActors;                                             // 0x0028 (size: 0x10)
...
{
    bool bPreviewOnly;                                                                // 0x0188 (size: 0x1)
...
class UMovieSceneSpawnTrack : public UMovieSceneTrack
{
    ...
    FGuid ObjectGuid;                                                                 // 0x0088 (size: 0x10)
...
class UMovieSceneSubSection : public UMovieSceneSection
{
    ...
    class UMovieSceneSequence* SubSequence;                                           // 0x0118 (size: 0x8)
    TLazyObjectPtr<class AActor> ActorToRecord;                                       // 0x0120 (size: 0x1C)
    FString TargetSequenceName;                                                       // 0x0140 (size: 0x10)
    FDirectoryPath TargetPathToRecordTo;                                              // 0x0150 (size: 0x10)
...
class UMovieSceneTrack : public UMovieSceneSignedObject
{
    ...
    FGuid EvaluationFieldGuid;                                                        // 0x0058 (size: 0x10)
    FMovieSceneTrackEvaluationField EvaluationField;                                  // 0x0068 (size: 0x10)
...
{
    TArray<class UMovieSceneSection*> SectionArray;                                   // 0x0088 (size: 0x10)

}; // Size: 0x98

class UTestMovieSceneTrack : public UMovieSceneTrack
{
    bool bHighPassFilter;                                                             // 0x0080 (size: 0x1)
    TArray<class UMovieSceneSection*> SectionArray;                                   // 0x0088 (size: 0x10)
