...
class ABP_FightingPlayer_C : public ABP_TPSCharacter_C
{
    ...
    class USphereComponent* CameraCollisionSphere;                                    // 0x1DB0 (size: 0x8)
    class UBP_PlayerScoringComponent_C* ScoringComponent;                             // 0x1DB8 (size: 0x8)
    class UOptionListenerComponent* OptionListener;                                   // 0x1DC0 (size: 0x8)
    class UBPStatsComponent_MainChar_C* BPStatsComponent;                             // 0x1DC8 (size: 0x8)
    class UNiagaraComponent* RainDrops;                                               // 0x1DD0 (size: 0x8)
    class USCDialogComponent* MCDialogComponent;                                      // 0x1DD8 (size: 0x8)
    class UPostProcessComponent* PostProcessComponent;                                // 0x1DE0 (size: 0x8)
    class UASMPlayerComponent* ASMPlayer;                                             // 0x1DE8 (size: 0x8)
    class UInteractionDetectionComponent* InteractionDetection;                       // 0x1DF0 (size: 0x8)
    class UCameraComponentThird* CameraComponentThird1;                               // 0x1DF8 (size: 0x8)
    class UPlayerFightingComponent* PlayerFighting;                                   // 0x1E00 (size: 0x8)
    float XRayTimeline_2_AlphaValue_B99E789F4B750E1312AB4DB6E056F422;                 // 0x1E08 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> XRayTimeline_2__Direction_B99E789F4B750E1312AB4DB6E056F422; // 0x1E0C (size: 0x1)
    class UTimelineComponent* XRayTimeline_2;                                         // 0x1E10 (size: 0x8)
    float XRayTimeline_AlphaValue_C27522E24AFDF504DF184D94796D8722;                   // 0x1E18 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> XRayTimeline__Direction_C27522E24AFDF504DF184D94796D8722; // 0x1E1C (size: 0x1)
    class UTimelineComponent* XRayTimeline;                                           // 0x1E20 (size: 0x8)
    float Timeline_0_NewTrack_0_28FEE0E141BC71288C77969330A5A359;                     // 0x1E28 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_28FEE0E141BC71288C77969330A5A359; // 0x1E2C (size: 0x1)
    class UTimelineComponent* Timeline_0;                                             // 0x1E30 (size: 0x8)
    TEnumAsByte<ETimelineDirection::Type> TransitionReal_ExposureTimeline__Direction_EC9658C94CFB8EC3D7E940A54DEE458A; // 0x1E38 (size: 0x1)
    class UTimelineComponent* TransitionReal_ExposureTimeline;                        // 0x1E40 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Hitted_Light;                              // 0x1E48 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Hitted_Medium;                             // 0x1E50 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Hitted_Strong;                             // 0x1E58 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Hit_Light;                                 // 0x1E60 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Hit_Medium;                                // 0x1E68 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Hit_Strong;                                // 0x1E70 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Absorb;                                    // 0x1E78 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Guardbreak;                                // 0x1E80 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Guard;                                     // 0x1E88 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> ParrySuccess;                              // 0x1E90 (size: 0x8)
    TSubclassOf<class UMatineeCameraShake> Parried;                                   // 0x1E98 (size: 0x8)
    bool activate_material_alpha;                                                     // 0x1EA0 (size: 0x1)
    class UMaterialInstanceDynamic* skinMaterialInstance;                             // 0x1EA8 (size: 0x8)
    float minDistToOcclude;                                                           // 0x1EB0 (size: 0x4)
    bool stopHealthBarBelowUpdate;                                                    // 0x1EB4 (size: 0x1)
    FBP_FightingPlayer_CEventHit EventHit;                                            // 0x1EB8 (size: 0x10)
    void EventHit();
    float HasHit;                                                                     // 0x1EC8 (size: 0x4)
    float WasHitted;                                                                  // 0x1ECC (size: 0x4)
    float Score;                                                                      // 0x1ED0 (size: 0x4)
    FBP_FightingPlayer_CBP_FP_Pressed BP_FP_Pressed;                                  // 0x1ED8 (size: 0x10)
    void BP_FP_Pressed(class ABP_FightingPlayer_C* PressingPlayer);
    FBP_FightingPlayer_CBP_FP_Released BP_FP_Released;                                // 0x1EE8 (size: 0x10)
    void BP_FP_Released(class ABP_FightingPlayer_C* ReleasingPlayer);
    float Hit_ShakeScreen_Coef;                                                       // 0x1EF8 (size: 0x4)
    FName CurrentAttack;                                                              // 0x1EFC (size: 0x8)
    bool IsTeleporting;                                                               // 0x1F04 (size: 0x1)
    TArray<FVector> PendingTeleportLocation;                                          // 0x1F08 (size: 0x10)
    TArray<FRotator> PendingTeleportRotation;                                         // 0x1F18 (size: 0x10)
    bool DeadWithDelay;                                                               // 0x1F28 (size: 0x1)
    uint8 PendingTeleportIndex;                                                       // 0x1F29 (size: 0x1)
    FRotator TargetRotation;                                                          // 0x1F2C (size: 0xC)
    FRotator CharacterRotation;                                                       // 0x1F38 (size: 0xC)
    float Target/CharacterRotationDifference;                                         // 0x1F44 (size: 0x4)
    float RotationRateMultiplier;                                                     // 0x1F48 (size: 0x4)
    bool TakedownModeInput;                                                           // 0x1F4C (size: 0x1)
    bool TakedownMode;                                                                // 0x1F4D (size: 0x1)
    class AActor* KillerActor;                                                        // 0x1F50 (size: 0x8)
    float BasePendantLightIntensity;                                                  // 0x1F58 (size: 0x4)
    float PendantLightShineFactor;                                                    // 0x1F5C (size: 0x4)
    TArray<int32> AgeSwitchVoice;                                                     // 0x1F60 (size: 0x10)
    class UMaterialInstanceDynamic* FocusModeMID;                                     // 0x1F70 (size: 0x8)
    int32 ID_FocusModeMID;                                                            // 0x1F78 (size: 0x4)
    class AActor* FocusCurrentActorSelected;                                          // 0x1F80 (size: 0x8)
    class ABP_FocusVitalPointsFX_C* VitalPointsFX_PO;                                 // 0x1F88 (size: 0x8)
    class AVitalPointActor* VitalPointSelected;                                       // 0x1F90 (size: 0x8)
    FTimerHandle FocusFadeOutTimerHandle;                                             // 0x1F98 (size: 0x8)
    float HealthBonusByCharge;                                                        // 0x1FA0 (size: 0x4)
    float HealthBonusByKill;                                                          // 0x1FA4 (size: 0x4)
    bool CanUpdateVisualAging;                                                        // 0x1FA8 (size: 0x1)
    bool ForceHideHealth;                                                             // 0x1FA9 (size: 0x1)
    float MotionBlur_InitAmount;                                                      // 0x1FAC (size: 0x4)
    int32 MotionBlur_InitTgtFPS;                                                      // 0x1FB0 (size: 0x4)
    class UMaterialInstanceDynamic* PPDizzyMID;                                       // 0x1FB8 (size: 0x8)
    int32 IDDizzyMID;                                                                 // 0x1FC0 (size: 0x4)
    float DizzyReductionEffectDuration;                                               // 0x1FC4 (size: 0x4)
    float LastDizzyReduction;                                                         // 0x1FC8 (size: 0x4)
    int32 RealTransitionPP_ID;                                                        // 0x1FCC (size: 0x4)
    bool bWasUsingCustomExposure;                                                     // 0x1FD0 (size: 0x1)
    class UAkAudioEvent* RealTransition_AkEvent;                                      // 0x1FD8 (size: 0x8)
    float ExposureMutliplier;                                                         // 0x1FE0 (size: 0x4)
    FTimerHandle FadeIn_TimerHandle;                                                  // 0x1FE8 (size: 0x8)
    class UAkComponent* Real Transition AkComponent;                                  // 0x1FF0 (size: 0x8)
    float HealthBonusByTakedown;                                                      // 0x1FF8 (size: 0x4)
    uint8 onGoingOrderAttackID;                                                       // 0x1FFC (size: 0x1)
    TArray<class AActor*> hittedAIs;                                                  // 0x2000 (size: 0x10)
    class ACharacter* Pending XRayTarget;                                             // 0x2010 (size: 0x8)
    class AFightingCharacter* BindedLockMoveTarget;                                   // 0x2018 (size: 0x8)
    class ACharacter* CurrentXRayTarget;                                              // 0x2020 (size: 0x8)
    bool FadeOutSwap;                                                                 // 0x2028 (size: 0x1)
    bool FadeOut Target Lost;                                                         // 0x2029 (size: 0x1)
    float StructureBonusOnAvoid;                                                      // 0x202C (size: 0x4)
    float CharegGainCurve_DistanceMultiplier;                                         // 0x2030 (size: 0x4)
    FCameraLookAtServiceBehavior FocusLookAt;                                         // 0x2038 (size: 0xE0)
    int32 FocusLookatHandle;                                                          // 0x2118 (size: 0x4)
    int32 DeathPP_ID;                                                                 // 0x211C (size: 0x4)
    class UMaterial* DeathPP_Material;                                                // 0x2120 (size: 0x8)
    int32 AvailabilityLayerID;                                                        // 0x2128 (size: 0x4)
    bool b_InputsAreDisabled;                                                         // 0x212C (size: 0x1)
    TArray<TSoftObjectPtr<UMaterialInterface>> LevelSelectMaterials_Temp;             // 0x2130 (size: 0x10)
    class UCameraModifier* HighlightCameraModifier;                                   // 0x2140 (size: 0x8)
    FTimerHandle TauntDelay;                                                          // 0x2148 (size: 0x8)
    ECameraTransitionState CameraAnimDrivenState;                                     // 0x2150 (size: 0x1)
    FTimerHandle XRayAlertedTimer;                                                    // 0x2158 (size: 0x8)
    FName Row Name;                                                                   // 0x2160 (size: 0x8)
    TMap<class FString, class FLinearColor> XRay_Color;                               // 0x2168 (size: 0x50)
    class AActor* AttachedProp;                                                       // 0x21B8 (size: 0x8)
    bool bSnowOnCharacter;                                                            // 0x21C0 (size: 0x1)
    bool bRainOnCharacter;                                                            // 0x21C1 (size: 0x1)
    bool bAshesOnCharacter;                                                           // 0x21C2 (size: 0x1)
    class UMaterialInterface* DesaturationMaterial;                                   // 0x21C8 (size: 0x8)
