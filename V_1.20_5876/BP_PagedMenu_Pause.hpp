...
class UBP_PagedMenu_Pause_C : public UMenuWidget
{
    ...
    class UBP_Notif_AgeDeathCounter_C* BP_PauseAgeDeath;                              // 0x0410 (size: 0x8)
    class UImage* Icon;                                                               // 0x0418 (size: 0x8)
    class UBP_Btn_InputTip_C* Input_ZoomItem;                                         // 0x0420 (size: 0x8)
    class UBP_Btn_InputTip_C* InputTip_Exit²;                                         // 0x0428 (size: 0x8)
    class UBP_Btn_InputTip_C* InputTip_Navigate;                                      // 0x0430 (size: 0x8)
    class UBP_Btn_InputTip_C* InputTip_Remapping;                                     // 0x0438 (size: 0x8)
    class UBP_Btn_InputTip_C* InputTip_Scroll;                                        // 0x0440 (size: 0x8)
    class UBP_Btn_InputTip_C* InputTip_ZoomIn;                                        // 0x0448 (size: 0x8)
    class UBP_Btn_InputTip_C* InputTip_ZoomOut;                                       // 0x0450 (size: 0x8)
    class UImage* Line;                                                               // 0x0458 (size: 0x8)
    class UTextBlock* Stamp_Number;                                                   // 0x0460 (size: 0x8)
    class UBorder* STAMPS;                                                            // 0x0468 (size: 0x8)
    class UBP_Notif_Currency_C* Widget_CurrencyTotal;                                 // 0x0470 (size: 0x8)
    class UWidgetSwitcher* WidgetSwitcher_0;                                          // 0x0478 (size: 0x8)
    bool bPlayEnterSound;                                                             // 0x0480 (size: 0x1)
