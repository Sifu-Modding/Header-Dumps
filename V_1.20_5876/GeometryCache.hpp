...
{
    class UGeometryCacheComponent* GeometryCacheComponent;                            // 0x02B0 (size: 0x8)
...
{
    class UGeometryCache* GeometryCache;                                              // 0x04B8 (size: 0x8)
    bool bRunning;                                                                    // 0x04C0 (size: 0x1)
    bool bLooping;                                                                    // 0x04C1 (size: 0x1)
    float StartTimeOffset;                                                            // 0x04C4 (size: 0x4)
    float PlaybackSpeed;                                                              // 0x04C8 (size: 0x4)
    int32 NumTracks;                                                                  // 0x04CC (size: 0x4)
    float ElapsedTime;                                                                // 0x04D0 (size: 0x4)
    float Duration;                                                                   // 0x0504 (size: 0x4)
    bool bManualTick;                                                                 // 0x0508 (size: 0x1)
