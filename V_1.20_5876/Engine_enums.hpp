...
enum class EAnimNotifyPredictionBehavior {
    NoPredictionOnly = 0,
    PredictionOnly = 1,
    Both = 2,
    Count = 3,
    None = 4,
    EAnimNotifyPredictionBehavior_MAX = 5,
};
...
enum class EBlendProfileEditMode {
    Global = 0,
    PerComponent = 1,
    EBlendProfileEditMode_MAX = 2,
};
...
namespace EBlendType {
    enum Type {
        Normal = 0,
        Dynamic_LocoToAction = 1,
        Dynamic_ActionToAction = 2,
        Dynamic_ActionToLoco = 3,
        EBlendType_MAX = 4,
    };
}
...
enum ECollisionChannel {
    ...
    ECC_Destructible = 7,
    ECC_WWise = 8,
    ECC_EngineTraceChannel1 = 9,
    ECC_EngineTraceChannel2 = 10,
    ECC_EngineTraceChannel3 = 11,
    ECC_EngineTraceChannel4 = 12,
    ECC_EngineTraceChannel5 = 13,
    ECC_EngineTraceChannel6 = 14,
...
enum EDecalBlendMode {
    ...
    DBM_Emissive = 3,
    DBM_Selective = 4,
    DBM_DBuffer_ColorNormalRoughness = 5,
    DBM_DBuffer_Color = 6,
    DBM_DBuffer_ColorNormal = 7,
    DBM_DBuffer_ColorRoughness = 8,
    DBM_DBuffer_Normal = 9,
    DBM_DBuffer_NormalRoughness = 10,
    DBM_DBuffer_Roughness = 11,
    DBM_DBuffer_Emissive = 12,
    DBM_DBuffer_AlphaComposite = 13,
    DBM_DBuffer_EmissiveAlphaComposite = 14,
    DBM_Volumetric_DistanceFunction = 15,
    DBM_AlphaComposite = 16,
    DBM_AmbientOcclusion = 17,
    DBM_MAX = 18,
};
...
enum EMaterialWuguanCustomLightingMode {
    WUGUANCUSTOMLIGHTING = 0,
    WUGUANCUSTOMLIGHTING_DiffuseOnly = 1,
    WUGUANCUSTOMLIGHTING_None = 2,
    EMaterialWuguanCustomLightingMode_MAX = 3,
};
...
enum class EReflectionQuality {
    REFLECTIONQUALITY_Low = 0,
    REFLECTIONQUALITY_Medium = 1,
    REFLECTIONQUALITY_MAX = 2,
};
...
enum class ESceneCapturePrimitiveRenderFrequency {
    PRM_Default = 0,
    PRM_Odd = 1,
    PRM_Even = 2,
    PRM_MAX = 3,
...
enum class ESceneCapturePrimitiveRenderMode {
    ...
    PRM_UseShowOnlyListNoCulling = 3,
    PRM_MAX = 4,
};
...
enum EViewModeIndex {
    ...
    VMI_ForwardBaseColor = 250,
    VMI_ForwardRoughness = 251,
    VMI_ForwardMetallic = 252,
    VMI_ForwardEmissive = 249,
    VMI_ForwardNormal = 248,
    VMI_CollisionPerChannel = 253,
    VMI_Max = 254,
    VMI_Unknown = 255,
};
...
enum TextureGroup {
    ...
    TEXTUREGROUP_Noise = 1,
    TEXTUREGROUP_SpeArchi = 2,
    TEXTUREGROUP_SpeProps = 3,
    TEXTUREGROUP_CharaBasic = 4,
    TEXTUREGROUP_CharaMajor = 5,
    TEXTUREGROUP_VFXLight = 6,
    TEXTUREGROUP_Others = 7,
    TEXTUREGROUP_WorldNormalMap = 8,
    TEXTUREGROUP_WorldSpecular = 9,
    TEXTUREGROUP_Character = 10,
    TEXTUREGROUP_CharacterNormalMap = 11,
    TEXTUREGROUP_CharacterSpecular = 12,
    TEXTUREGROUP_Weapon = 13,
    TEXTUREGROUP_WeaponNormalMap = 14,
    TEXTUREGROUP_WeaponSpecular = 15,
    TEXTUREGROUP_Vehicle = 16,
    TEXTUREGROUP_VehicleNormalMap = 17,
    TEXTUREGROUP_VehicleSpecular = 18,
    TEXTUREGROUP_Cinematic = 19,
    TEXTUREGROUP_Effects = 20,
    TEXTUREGROUP_EffectsNotFiltered = 21,
    TEXTUREGROUP_Skybox = 22,
    TEXTUREGROUP_UI = 23,
    TEXTUREGROUP_Lightmap = 24,
    TEXTUREGROUP_RenderTarget = 25,
    TEXTUREGROUP_MobileFlattened = 26,
    TEXTUREGROUP_ProcBuilding_Face = 27,
    TEXTUREGROUP_ProcBuilding_LightMap = 28,
    ...
    TEXTUREGROUP_ReflectionCaptures = 41,
    ...
    TEXTUREGROUP_Project11 = 52,
    TEXTUREGROUP_Project12 = 53,
    TEXTUREGROUP_Project13 = 54,
    TEXTUREGROUP_Project14 = 55,
    TEXTUREGROUP_Project15 = 56,
    TEXTUREGROUP_MAX = 57,
};
