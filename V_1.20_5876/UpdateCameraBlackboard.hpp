...
class UUpdateCameraBlackboard_C : public UUpdateCameraBlackboardBTService
{
    ...
    void OrderStartingDynamicDelegate(uint8 bpp___ID__pf, class UOrderComponent* bpp___OrderComponent__pf);
    FNetOrderStructTakedown CallFunc_GetBaseNetOrderStruct__outNetOrderStruct_1;      // 0x18F0 (size: 0xD60)
    class UPlayerAnim* K2Node_DynamicCast_AsPlayer_Anim;                              // 0x2650 (size: 0x8)
    bool K2Node_DynamicCast_bSuccess_3;                                               // 0x2658 (size: 0x1)
    class AFightingCharacter* K2Node_DynamicCast_AsFighting_Character;                // 0x2660 (size: 0x8)
    bool K2Node_DynamicCast_bSuccess_4;                                               // 0x2668 (size: 0x1)
    bool K2Node_SwitchEnum_CmpSuccess_4;                                              // 0x2669 (size: 0x1)
    FUpdateCameraBlackboard_CK2Node_CreateDelegate_OutputDelegate_25 K2Node_CreateDelegate_OutputDelegate_25; // 0x266C (size: 0x10)
    void OrderStartingDynamicDelegate(uint8 bpp___ID__pf, class UOrderComponent* bpp___OrderComponent__pf);
    FUpdateCameraBlackboard_CK2Node_CreateDelegate_OutputDelegate_26 K2Node_CreateDelegate_OutputDelegate_26; // 0x267C (size: 0x10)
    void OrderStartingDynamicDelegate(uint8 bpp___ID__pf, class UOrderComponent* bpp___OrderComponent__pf);
    FNetOrderStructTakedown CallFunc_GetBaseNetOrderStruct__outNetOrderStruct_2;      // 0x2690 (size: 0xD60)
    FUpdateCameraBlackboard_CK2Node_CreateDelegate_OutputDelegate_27 K2Node_CreateDelegate_OutputDelegate_27; // 0x33F0 (size: 0x10)
    void DeathComponentDelegate();
    class AFightingCharacter* K2Node_DynamicCast_AsFighting_Character_1;              // 0x3400 (size: 0x8)
    bool K2Node_DynamicCast_bSuccess_5;                                               // 0x3408 (size: 0x1)
    FAnimNotifyEvent CallFunc_FindNotifyByClass__outFoundNotify;                      // 0x3410 (size: 0xB8)
    bool CallFunc_FindNotifyByClass__bOutFound;                                       // 0x34C8 (size: 0x1)
    uint8 K2Node_CustomEvent__ID_1;                                                   // 0x34C9 (size: 0x1)
    class UOrderComponent* K2Node_CustomEvent__OrderComponent_1;                      // 0x34D0 (size: 0x8)
    uint8 K2Node_CustomEvent__ID;                                                     // 0x34D8 (size: 0x1)
    class UOrderComponent* K2Node_CustomEvent__OrderComponent;                        // 0x34E0 (size: 0x8)
    bool CallFunc_IsHighPrioLDCameraOn_On_4;                                          // 0x34E8 (size: 0x1)
    bool Temp_bool_Variable_4;                                                        // 0x34E9 (size: 0x1)
    bool Temp_bool_Variable_5;                                                        // 0x34EA (size: 0x1)
    bool Temp_bool_Variable_6;                                                        // 0x34EB (size: 0x1)
    bool Temp_bool_Variable_7;                                                        // 0x34EC (size: 0x1)
    bool K2Node_Select_Default_1;                                                     // 0x34ED (size: 0x1)
