...
struct FActiveGameplayCue : public FFastArraySerializerItem
{
    ...
    FGameplayCueParameters Parameters;                                                // 0x0028 (size: 0xB8)
    bool bPredictivelyRemoved;                                                        // 0x00E0 (size: 0x1)
...
{
    FScalableFloat Coefficient;                                                       // 0x0000 (size: 0x20)
    FScalableFloat PreMultiplyAdditiveValue;                                          // 0x0020 (size: 0x20)
    FScalableFloat PostMultiplyAdditiveValue;                                         // 0x0040 (size: 0x20)
    FGameplayEffectAttributeCaptureDefinition BackingAttribute;                       // 0x0060 (size: 0x40)
    FCurveTableRowHandle AttributeCurve;                                              // 0x00A0 (size: 0x10)
    EAttributeBasedFloatCalculationType AttributeCalculationType;                     // 0x00B0 (size: 0x1)
    EGameplayModEvaluationChannel FinalChannel;                                       // 0x00B1 (size: 0x1)
    FGameplayTagContainer SourceTagFilter;                                            // 0x00B8 (size: 0x20)
    FGameplayTagContainer TargetTagFilter;                                            // 0x00D8 (size: 0x20)
...
struct FCustomCalculationBasedFloat
{
    ...
    FScalableFloat Coefficient;                                                       // 0x0008 (size: 0x20)
    FScalableFloat PreMultiplyAdditiveValue;                                          // 0x0028 (size: 0x20)
    FScalableFloat PostMultiplyAdditiveValue;                                         // 0x0048 (size: 0x20)
    FCurveTableRowHandle FinalLookupCurve;                                            // 0x0068 (size: 0x10)
...
struct FGameplayAbilitySpecDef
{
    ...
    FScalableFloat LevelScalableFloat;                                                // 0x0008 (size: 0x20)
    int32 InputID;                                                                    // 0x0028 (size: 0x4)
    EGameplayEffectGrantedAbilityRemovePolicy RemovalPolicy;                          // 0x002C (size: 0x1)
    class UObject* SourceObject;                                                      // 0x0030 (size: 0x8)
    FGameplayAbilitySpecHandle AssignedHandle;                                        // 0x0088 (size: 0x4)
...
{
    FHitResult HitResult;                                                             // 0x0008 (size: 0x8C)
    bool bHitReplaced;                                                                // 0x0094 (size: 0x1)
...
struct FGameplayCuePendingExecute
{
    ...
    FGameplayCueParameters CueParameters;                                             // 0x00B0 (size: 0xB8)
...
struct FGameplayEffectExecutionScopedModifierInfo
{
    ...
    FGameplayEffectModifierMagnitude ModifierMagnitude;                               // 0x0050 (size: 0x1A8)
    FGameplayModEvaluationChannelSettings EvaluationChannelSettings;                  // 0x01F8 (size: 0x1)
    FGameplayTagRequirements SourceTags;                                              // 0x0200 (size: 0x40)
    FGameplayTagRequirements TargetTags;                                              // 0x0240 (size: 0x40)
...
struct FGameplayEffectModifierMagnitude
{
    ...
    FScalableFloat ScalableFloatMagnitude;                                            // 0x0008 (size: 0x20)
    FAttributeBasedFloat AttributeBasedMagnitude;                                     // 0x0028 (size: 0xF8)
    FCustomCalculationBasedFloat CustomMagnitude;                                     // 0x0120 (size: 0x78)
    FSetByCallerFloat SetByCallerMagnitude;                                           // 0x0198 (size: 0x10)
...
struct FGameplayModifierInfo
{
    FGameplayAttribute Attribute;                                                     // 0x0000 (size: 0x38)
    TEnumAsByte<EGameplayModOp::Type> ModifierOp;                                     // 0x0038 (size: 0x1)
    FScalableFloat Magnitude;                                                         // 0x0040 (size: 0x20)
    FGameplayEffectModifierMagnitude ModifierMagnitude;                               // 0x0060 (size: 0x1A8)
    FGameplayModEvaluationChannelSettings EvaluationChannelSettings;                  // 0x0208 (size: 0x1)
    FGameplayTagRequirements SourceTags;                                              // 0x0210 (size: 0x40)
    FGameplayTagRequirements TargetTags;                                              // 0x0250 (size: 0x40)
...
{
    class UAbilitySystemComponent* Owner;                                             // 0x01B0 (size: 0x8)
...
{
    class UAbilitySystemComponent* AbilitySystemComponent;                            // 0x0350 (size: 0x8)

}; // Size: 0x360

class AGameplayAbilityTargetActor : public AActor
{
    bool ShouldProduceTargetDataOnServer;                                             // 0x02B0 (size: 0x1)
    FGameplayAbilityTargetingLocationInfo StartLocation;                              // 0x02C0 (size: 0x70)
    class APlayerController* MasterPC;                                                // 0x0360 (size: 0x8)
    class UGameplayAbility* OwningAbility;                                            // 0x0368 (size: 0x8)
    bool bDestroyOnConfirmation;                                                      // 0x0370 (size: 0x1)
    class AActor* SourceActor;                                                        // 0x0378 (size: 0x8)
    FWorldReticleParameters ReticleParams;                                            // 0x0380 (size: 0xC)
    TSubclassOf<class AGameplayAbilityWorldReticle> ReticleClass;                     // 0x0390 (size: 0x8)
    FGameplayTargetDataFilterHandle Filter;                                           // 0x0398 (size: 0x10)
    bool bDebug;                                                                      // 0x03A8 (size: 0x1)
    class UAbilitySystemComponent* GenericDelegateBoundASC;                           // 0x03C0 (size: 0x8)
...
{
    UClass* PlacedActorClass;                                                         // 0x0400 (size: 0x8)
    class UMaterialInterface* PlacedActorMaterial;                                    // 0x0408 (size: 0x8)

}; // Size: 0x420

class AGameplayAbilityTargetActor_GroundTrace : public AGameplayAbilityTargetActor_Trace
{
    float CollisionRadius;                                                            // 0x03E0 (size: 0x4)
    float CollisionHeight;                                                            // 0x03E4 (size: 0x4)

}; // Size: 0x400

class AGameplayAbilityTargetActor_Radius : public AGameplayAbilityTargetActor
{
    float Radius;                                                                     // 0x03C8 (size: 0x4)
...
{
    float MaxRange;                                                                   // 0x03C8 (size: 0x4)
    FCollisionProfileName TraceProfile;                                               // 0x03CC (size: 0x8)
    bool bTraceAffectsAimPitch;                                                       // 0x03D4 (size: 0x1)

}; // Size: 0x3E0

class AGameplayAbilityWorldReticle : public AActor
{
    FWorldReticleParameters Parameters;                                               // 0x02B0 (size: 0xC)
    bool bFaceOwnerFlat;                                                              // 0x02BC (size: 0x1)
    bool bSnapToTargetedActor;                                                        // 0x02BD (size: 0x1)
    bool bIsTargetValid;                                                              // 0x02BE (size: 0x1)
    bool bIsTargetAnActor;                                                            // 0x02BF (size: 0x1)
    class APlayerController* MasterPC;                                                // 0x02C0 (size: 0x8)
    class AActor* TargetingActor;                                                     // 0x02C8 (size: 0x8)
...
{
    class UCapsuleComponent* CollisionComponent;                                      // 0x02D0 (size: 0x8)
    TArray<class UActorComponent*> VisualizationComponents;                           // 0x02D8 (size: 0x10)

}; // Size: 0x2F0

class AGameplayCueNotify_Actor : public AActor
{
    bool bAutoDestroyOnRemove;                                                        // 0x02B0 (size: 0x1)
    float AutoDestroyDelay;                                                           // 0x02B4 (size: 0x4)
    bool WarnIfTimelineIsStillRunning;                                                // 0x02B8 (size: 0x1)
    bool WarnIfLatentActionIsStillRunning;                                            // 0x02B9 (size: 0x1)
    FGameplayTag GameplayCueTag;                                                      // 0x02BC (size: 0x8)
    FName GameplayCueName;                                                            // 0x02C4 (size: 0x8)
    bool bAutoAttachToOwner;                                                          // 0x02CC (size: 0x1)
    bool IsOverride;                                                                  // 0x02CD (size: 0x1)
    bool bUniqueInstancePerInstigator;                                                // 0x02CE (size: 0x1)
    bool bUniqueInstancePerSourceObject;                                              // 0x02CF (size: 0x1)
    bool bAllowMultipleOnActiveEvents;                                                // 0x02D0 (size: 0x1)
    bool bAllowMultipleWhileActiveEvents;                                             // 0x02D1 (size: 0x1)
    int32 NumPreallocatedInstances;                                                   // 0x02D4 (size: 0x4)
...
{
    TArray<FAttributeDefaults> DefaultStartingData;                                   // 0x0140 (size: 0x10)
    TArray<class UAttributeSet*> SpawnedAttributes;                                   // 0x0150 (size: 0x10)
    FName AffectedAnimInstanceTag;                                                    // 0x0160 (size: 0x8)
    float OutgoingDuration;                                                           // 0x0300 (size: 0x4)
    float IncomingDuration;                                                           // 0x0304 (size: 0x4)
    TArray<FString> ClientDebugStrings;                                               // 0x0328 (size: 0x10)
    TArray<FString> ServerDebugStrings;                                               // 0x0338 (size: 0x10)
    bool UserAbilityActivationInhibited;                                              // 0x03A0 (size: 0x1)
    bool ReplicationProxyEnabled;                                                     // 0x03A1 (size: 0x1)
    bool bSuppressGrantAbility;                                                       // 0x03A2 (size: 0x1)
    bool bSuppressGameplayCues;                                                       // 0x03A3 (size: 0x1)
    TArray<class AGameplayAbilityTargetActor*> SpawnedTargetActors;                   // 0x03A8 (size: 0x10)
    class AActor* OwnerActor;                                                         // 0x03E0 (size: 0x8)
    class AActor* AvatarActor;                                                        // 0x03E8 (size: 0x8)
    FGameplayAbilitySpecContainer ActivatableAbilities;                               // 0x0400 (size: 0x120)
    TArray<class UGameplayAbility*> AllReplicatedInstancedAbilities;                  // 0x0550 (size: 0x10)
    FGameplayAbilityRepAnimMontage RepAnimMontageInfo;                                // 0x0760 (size: 0x30)
    bool bCachedIsNetSimulated;                                                       // 0x0790 (size: 0x1)
    bool bPendingMontageRep;                                                          // 0x0791 (size: 0x1)
    FGameplayAbilityLocalAnimMontage LocalAnimMontageInfo;                            // 0x0798 (size: 0x28)
    FActiveGameplayEffectsContainer ActiveGameplayEffects;                            // 0x0860 (size: 0x478)
    FActiveGameplayCueContainer ActiveGameplayCues;                                   // 0x0CD8 (size: 0x128)
    FActiveGameplayCueContainer MinimalReplicationGameplayCues;                       // 0x0E00 (size: 0x128)
    TArray<uint8> BlockedAbilityBindings;                                             // 0x1050 (size: 0x10)
    FMinimalReplicationTagCountMap MinimalReplicationTags;                            // 0x1188 (size: 0x60)
    FReplicatedPredictionKeyMap ReplicatedPredictionKeyMap;                           // 0x1200 (size: 0x118)
...
class UAbilitySystemTestAttributeSet : public UAttributeSet
{
    ...
    float Mana;                                                                       // 0x003C (size: 0x4)
    float MaxMana;                                                                    // 0x0040 (size: 0x4)
    float Damage;                                                                     // 0x0044 (size: 0x4)
    float SpellDamage;                                                                // 0x0048 (size: 0x4)
    float PhysicalDamage;                                                             // 0x004C (size: 0x4)
    float CritChance;                                                                 // 0x0050 (size: 0x4)
    float CritMultiplier;                                                             // 0x0054 (size: 0x4)
    float ArmorDamageReduction;                                                       // 0x0058 (size: 0x4)
    float DodgeChance;                                                                // 0x005C (size: 0x4)
    float LifeSteal;                                                                  // 0x0060 (size: 0x4)
    float Strength;                                                                   // 0x0064 (size: 0x4)
    float StackingAttribute1;                                                         // 0x0068 (size: 0x4)
    float StackingAttribute2;                                                         // 0x006C (size: 0x4)
    float NoStackAttribute;                                                           // 0x0070 (size: 0x4)
...
class UAbilityTask_ApplyRootMotionMoveToForce : public UAbilityTask_ApplyRootMotion_Base
{
    ...
    class UCurveVector* PathOffsetCurve;                                              // 0x00F8 (size: 0x8)
    FVector PathOffsetAmplitude;                                                      // 0x0100 (size: 0xC)
...
{
    FName ForceName;                                                                  // 0x0084 (size: 0x8)
    ERootMotionFinishVelocityMode FinishVelocityMode;                                 // 0x008C (size: 0x1)
    FVector FinishSetVelocity;                                                        // 0x0090 (size: 0xC)
    float FinishClampVelocity;                                                        // 0x009C (size: 0x4)
...
{
    FAbilityTask_MoveToLocationOnTargetLocationReached OnTargetLocationReached;       // 0x0088 (size: 0x10)
    void MoveToLocationDelegate();
    FVector StartLocation;                                                            // 0x009C (size: 0xC)
    FVector TargetLocation;                                                           // 0x00A8 (size: 0xC)
    float DurationOfMovement;                                                         // 0x00B4 (size: 0x4)
    class UCurveFloat* LerpCurve;                                                     // 0x00C0 (size: 0x8)
    class UCurveVector* LerpCurveVector;                                              // 0x00C8 (size: 0x8)
...
class UGameplayAbility : public UObject
{
    ...
    bool bIsCancelable;                                                               // 0x0391 (size: 0x1)
    bool bIsBlockingOtherAbilities;                                                   // 0x0392 (size: 0x1)
...
class UGameplayEffect : public UObject
{
    ...
    FGameplayEffectModifierMagnitude DurationMagnitude;                               // 0x0038 (size: 0x1A8)
    FScalableFloat Period;                                                            // 0x01E0 (size: 0x20)
    bool bExecutePeriodicEffectOnApplication;                                         // 0x0200 (size: 0x1)
    EGameplayEffectPeriodInhibitionRemovedPolicy PeriodicInhibitionPolicy;            // 0x0201 (size: 0x1)
    TArray<FGameplayModifierInfo> Modifiers;                                          // 0x0208 (size: 0x10)
    TArray<FGameplayEffectExecutionDefinition> Executions;                            // 0x0218 (size: 0x10)
    FScalableFloat ChanceToApplyToTarget;                                             // 0x0228 (size: 0x20)
    TArray<class TSubclassOf<UGameplayEffectCustomApplicationRequirement>> ApplicationRequirements; // 0x0248 (size: 0x10)
    TArray<class TSubclassOf<UGameplayEffect>> TargetEffectClasses;                   // 0x0258 (size: 0x10)
    TArray<FConditionalGameplayEffect> ConditionalGameplayEffects;                    // 0x0268 (size: 0x10)
    TArray<class TSubclassOf<UGameplayEffect>> OverflowEffects;                       // 0x0278 (size: 0x10)
    bool bDenyOverflowApplication;                                                    // 0x0288 (size: 0x1)
    bool bClearStackOnOverflow;                                                       // 0x0289 (size: 0x1)
    TArray<class TSubclassOf<UGameplayEffect>> PrematureExpirationEffectClasses;      // 0x0290 (size: 0x10)
    TArray<class TSubclassOf<UGameplayEffect>> RoutineExpirationEffectClasses;        // 0x02A0 (size: 0x10)
    bool bRequireModifierSuccessToTriggerCues;                                        // 0x02B0 (size: 0x1)
    bool bSuppressStackingCues;                                                       // 0x02B1 (size: 0x1)
    TArray<FGameplayEffectCue> GameplayCues;                                          // 0x02B8 (size: 0x10)
    class UGameplayEffectUIData* UIData;                                              // 0x02C8 (size: 0x8)
    FInheritedTagContainer InheritableGameplayEffectTags;                             // 0x02D0 (size: 0x60)
    FInheritedTagContainer InheritableOwnedTagsContainer;                             // 0x0330 (size: 0x60)
    FGameplayTagRequirements OngoingTagRequirements;                                  // 0x0390 (size: 0x40)
    FGameplayTagRequirements OngoingTagHardRequirements;                              // 0x03D0 (size: 0x40)
    FGameplayTagRequirements ApplicationTagRequirements;                              // 0x0410 (size: 0x40)
    FGameplayTagRequirements RemovalTagRequirements;                                  // 0x0450 (size: 0x40)
    FInheritedTagContainer RemoveGameplayEffectsWithTags;                             // 0x0490 (size: 0x60)
    FGameplayTagRequirements GrantedApplicationImmunityTags;                          // 0x04F0 (size: 0x40)
    FGameplayEffectQuery GrantedApplicationImmunityQuery;                             // 0x0530 (size: 0x150)
    FGameplayEffectQuery RemoveGameplayEffectQuery;                                   // 0x0688 (size: 0x150)
    EGameplayEffectStackingType StackingType;                                         // 0x07D9 (size: 0x1)
    int32 StackLimitCount;                                                            // 0x07DC (size: 0x4)
    EGameplayEffectStackingDurationPolicy StackDurationRefreshPolicy;                 // 0x07E0 (size: 0x1)
    EGameplayEffectStackingPeriodPolicy StackPeriodResetPolicy;                       // 0x07E1 (size: 0x1)
    EGameplayEffectStackingExpirationPolicy StackExpirationPolicy;                    // 0x07E2 (size: 0x1)
    TArray<FGameplayAbilitySpecDef> GrantedAbilities;                                 // 0x07E8 (size: 0x10)
