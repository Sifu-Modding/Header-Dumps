...
class UBP_Menu_NewGameSettings_C : public UGraphOptionsMenu
{
    ...
    class UBP_Btn_InputTip_C* BtnStart;                                               // 0x08C0 (size: 0x8)
    class UTextBlock* BtnText;                                                        // 0x08C8 (size: 0x8)
    class UTextBlock* BtnText_1;                                                      // 0x08D0 (size: 0x8)
    class UTextBlock* BtnText_2;                                                      // 0x08D8 (size: 0x8)
    class UTextBlock* BtnText_3;                                                      // 0x08E0 (size: 0x8)
    class UTextBlock* BtnText_4;                                                      // 0x08E8 (size: 0x8)
    class UTextBlock* BtnText_5;                                                      // 0x08F0 (size: 0x8)
    class UTextBlock* BtnText_6;                                                      // 0x08F8 (size: 0x8)
    class UCanvasPanel* CanvasPanel_205;                                              // 0x0900 (size: 0x8)
    class UBP_Btn_SpinBox_C* difficulty;                                              // 0x0908 (size: 0x8)
    class UVerticalBox* Difficuly_easy;                                               // 0x0910 (size: 0x8)
    class UVerticalBox* Difficuly_Hard;                                               // 0x0918 (size: 0x8)
    class UVerticalBox* Difficuly_Normal;                                             // 0x0920 (size: 0x8)
    class UBP_Btn_InputTip_C* InputTip_Back;                                          // 0x0928 (size: 0x8)
    class UVerticalBox* Keep_Skills_progress;                                         // 0x0930 (size: 0x8)
    class UImage* Line;                                                               // 0x0938 (size: 0x8)
    class UImage* Line_2;                                                             // 0x0940 (size: 0x8)
    class UBP_Btn_SpinBox_C* skillImport;                                             // 0x0948 (size: 0x8)
    class UVerticalBox* Start_Fresh;                                                  // 0x0950 (size: 0x8)
    class UWidgetSwitcher* WidgetSwitcher_0;                                          // 0x0958 (size: 0x8)
    class UButtonUserWidget* FocusedCombo;                                            // 0x0960 (size: 0x8)
    bool AudioApplied;                                                                // 0x0968 (size: 0x1)
    class UBP_Btn_Difficulty_C* FocusedOption;                                        // 0x0970 (size: 0x8)
    TMap<class FString, class FText> AudioLanguageMap;                                // 0x0978 (size: 0x50)
    class UPlayerFightingComponent* PlayerFightingComp;                               // 0x09C8 (size: 0x8)
    bool NewGame;                                                                     // 0x09D0 (size: 0x1)
    class UWidget* FocusedWidget;                                                     // 0x09D8 (size: 0x8)
