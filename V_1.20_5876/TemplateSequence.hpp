...
{
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x02B8 (size: 0x14)
    class UTemplateSequencePlayer* SequencePlayer;                                    // 0x02D0 (size: 0x8)
    FSoftObjectPath TemplateSequence;                                                 // 0x02D8 (size: 0x18)
