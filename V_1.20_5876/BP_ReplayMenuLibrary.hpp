...
class UBP_ReplayMenuLibrary_C : public UBlueprintFunctionLibrary
{
    ...
    void CreateFinalEditPopup(class APlayerController* OwningPlayer, FText TitleText, FText PrimaryText, FText SecondaryText, FText BottomText, bool Animated, FText YesText, FText NoText, class UObject* __WorldContext, class UBP_Menu_Popup_Validation_C*& PopupWidget);
