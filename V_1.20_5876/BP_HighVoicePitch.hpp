#ifndef UE4SS_SDK_BP_HighVoicePitch_HPP
#define UE4SS_SDK_BP_HighVoicePitch_HPP

class UBP_HighVoicePitch_C : public UBP_GameplayCheatMaster_C
{
    ...
    void ExecuteUbergraph_BP_HighVoicePitch(int32 EntryPoint);
}; // Size: 0x48
