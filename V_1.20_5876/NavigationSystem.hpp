...
{
    FNavAgentSelector SupportedAgents;                                                // 0x02E8 (size: 0x4)

}; // Size: 0x2F0

class ANavModifierVolume : public AVolume
{
    TSubclassOf<class UNavArea> AreaClass;                                            // 0x02F0 (size: 0x8)
...
{
    class UNavigationSystemConfig* NavigationSystemConfig;                            // 0x02B0 (size: 0x8)
    ENavSystemOverridePolicy OverridePolicy;                                          // 0x02B8 (size: 0x1)
    uint8 bLoadOnClient;                                                              // 0x02B9 (size: 0x1)

}; // Size: 0x2C0

class ANavigationData : public AActor
{
    class UPrimitiveComponent* RenderingComp;                                         // 0x02B8 (size: 0x8)
    FNavDataConfig NavDataConfig;                                                     // 0x02C0 (size: 0x78)
...
{
    class UCapsuleComponent* CapsuleComponent;                                        // 0x02C0 (size: 0x8)
    class UNavigationInvokerComponent* InvokerComponent;                              // 0x02C8 (size: 0x8)
    uint8 bActAsNavigationInvoker;                                                    // 0x02D0 (size: 0x1)
    FNavAgentProperties NavAgentProps;                                                // 0x02D8 (size: 0x30)
    FVector QueryingExtent;                                                           // 0x0308 (size: 0xC)
    class ANavigationData* MyNavData;                                                 // 0x0318 (size: 0x8)
    FVector ProjectedLocation;                                                        // 0x0320 (size: 0xC)
    uint8 bProjectedLocationValid;                                                    // 0x032C (size: 0x1)
    uint8 bSearchStart;                                                               // 0x032C (size: 0x1)
    float CostLimitFactor;                                                            // 0x0330 (size: 0x4)
    float MinimumCostLimit;                                                           // 0x0334 (size: 0x4)
    uint8 bBacktracking;                                                              // 0x0338 (size: 0x1)
    uint8 bUseHierarchicalPathfinding;                                                // 0x0338 (size: 0x1)
    uint8 bGatherDetailedInfo;                                                        // 0x0338 (size: 0x1)
    uint8 bDrawDistanceToWall;                                                        // 0x0338 (size: 0x1)
    uint8 bShowNodePool;                                                              // 0x0338 (size: 0x1)
    uint8 bShowBestPath;                                                              // 0x0338 (size: 0x1)
    uint8 bShowDiffWithPreviousStep;                                                  // 0x0338 (size: 0x1)
    uint8 bShouldBeVisibleInGame;                                                     // 0x0338 (size: 0x1)
    TEnumAsByte<ENavCostDisplay::Type> CostDisplayMode;                               // 0x033C (size: 0x1)
    FVector2D TextCanvasOffset;                                                       // 0x0340 (size: 0x8)
    uint8 bPathExist;                                                                 // 0x0348 (size: 0x1)
    uint8 bPathIsPartial;                                                             // 0x0348 (size: 0x1)
    uint8 bPathSearchOutOfNodes;                                                      // 0x0348 (size: 0x1)
    float PathfindingTime;                                                            // 0x034C (size: 0x4)
    float PathCost;                                                                   // 0x0350 (size: 0x4)
    int32 PathfindingSteps;                                                           // 0x0354 (size: 0x4)
    class ANavigationTestingActor* OtherActor;                                        // 0x0358 (size: 0x8)
    TSubclassOf<class UNavigationQueryFilter> FilterClass;                            // 0x0360 (size: 0x8)
    int32 ShowStepIndex;                                                              // 0x0368 (size: 0x4)
    float OffsetFromCornersDistance;                                                  // 0x036C (size: 0x4)
...
class ARecastNavMesh : public ANavigationData
{
    ...
    uint8 bDrawMarkedForbiddenPolys;                                                  // 0x04B9 (size: 0x1)
    uint8 bDistinctlyDrawTilesBeingBuilt;                                             // 0x04BA (size: 0x1)
    float DrawOffset;                                                                 // 0x04BC (size: 0x4)
    bool bForceStatic;                                                                // 0x04C0 (size: 0x1)
    uint8 bFixedTilePoolSize;                                                         // 0x04C4 (size: 0x1)
    int32 TilePoolSize;                                                               // 0x04C8 (size: 0x4)
    float TileSizeUU;                                                                 // 0x04CC (size: 0x4)
    float CellSize;                                                                   // 0x04D0 (size: 0x4)
    float CellHeight;                                                                 // 0x04D4 (size: 0x4)
    float AgentRadius;                                                                // 0x04D8 (size: 0x4)
    float AgentHeight;                                                                // 0x04DC (size: 0x4)
    float AgentMaxSlope;                                                              // 0x04E0 (size: 0x4)
    float AgentMaxStepHeight;                                                         // 0x04E4 (size: 0x4)
    float MinRegionArea;                                                              // 0x04E8 (size: 0x4)
    float MergeRegionSize;                                                            // 0x04EC (size: 0x4)
    float MaxSimplificationError;                                                     // 0x04F0 (size: 0x4)
    int32 MaxSimultaneousTileGenerationJobsCount;                                     // 0x04F4 (size: 0x4)
    int32 TileNumberHardLimit;                                                        // 0x04F8 (size: 0x4)
    int32 PolyRefTileBits;                                                            // 0x04FC (size: 0x4)
    int32 PolyRefNavPolyBits;                                                         // 0x0500 (size: 0x4)
    int32 PolyRefSaltBits;                                                            // 0x0504 (size: 0x4)
    FVector NavMeshOriginOffset;                                                      // 0x0508 (size: 0xC)
    float DefaultDrawDistance;                                                        // 0x0514 (size: 0x4)
    float DefaultMaxSearchNodes;                                                      // 0x0518 (size: 0x4)
    float DefaultMaxHierarchicalSearchNodes;                                          // 0x051C (size: 0x4)
    TEnumAsByte<ERecastPartitioning::Type> RegionPartitioning;                        // 0x0520 (size: 0x1)
    TEnumAsByte<ERecastPartitioning::Type> LayerPartitioning;                         // 0x0521 (size: 0x1)
    int32 RegionChunkSplits;                                                          // 0x0524 (size: 0x4)
    int32 LayerChunkSplits;                                                           // 0x0528 (size: 0x4)
    uint8 bSortNavigationAreasByCost;                                                 // 0x052C (size: 0x1)
    uint8 bPerformVoxelFiltering;                                                     // 0x052C (size: 0x1)
    uint8 bMarkLowHeightAreas;                                                        // 0x052C (size: 0x1)
    uint8 bUseExtraTopCellWhenMarkingAreas;                                           // 0x052C (size: 0x1)
    uint8 bFilterLowSpanSequences;                                                    // 0x052C (size: 0x1)
    uint8 bFilterLowSpanFromTileCache;                                                // 0x052C (size: 0x1)
    uint8 bDoFullyAsyncNavDataGathering;                                              // 0x052C (size: 0x1)
    uint8 bUseBetterOffsetsFromCorners;                                               // 0x052C (size: 0x1)
    uint8 bStoreEmptyTileLayers;                                                      // 0x052D (size: 0x1)
    uint8 bUseVirtualFilters;                                                         // 0x052D (size: 0x1)
    uint8 bAllowNavLinkAsPathEnd;                                                     // 0x052D (size: 0x1)
    uint8 bUseVoxelCache;                                                             // 0x052D (size: 0x1)
    float TileSetUpdateInterval;                                                      // 0x0530 (size: 0x4)
    float HeuristicScale;                                                             // 0x0534 (size: 0x4)
    float VerticalDeviationFromGroundCompensation;                                    // 0x0538 (size: 0x4)
...
{
    TArray<FNavigationLink> Links;                                                    // 0x0498 (size: 0x10)
...
class UNavLinkCustomComponent : public UNavRelevantComponent
{
    ...
    FVector LinkRelativeStart;                                                        // 0x0114 (size: 0xC)
    FVector LinkRelativeEnd;                                                          // 0x0120 (size: 0xC)
    TEnumAsByte<ENavLinkDirection::Type> LinkDirection;                               // 0x012C (size: 0x1)
    uint8 bLinkEnabled;                                                               // 0x0130 (size: 0x1)
    bool bFreezeAgentSimulationWhenUsingSmartLink;                                    // 0x0134 (size: 0x1)
    uint8 bNotifyWhenEnabled;                                                         // 0x0138 (size: 0x1)
    uint8 bNotifyWhenDisabled;                                                        // 0x0138 (size: 0x1)
    uint8 bCreateBoxObstacle;                                                         // 0x0138 (size: 0x1)
    FVector ObstacleOffset;                                                           // 0x013C (size: 0xC)
    FVector ObstacleExtent;                                                           // 0x0148 (size: 0xC)
...
class UNavModifierComponent : public UNavRelevantComponent
{
    ...
    FVector FailsafeExtent;                                                           // 0x00F8 (size: 0xC)
    uint8 bIncludeAgentHeight;                                                        // 0x0104 (size: 0x1)
...
{
    uint8 bAttachToOwnersRoot;                                                        // 0x00E4 (size: 0x1)
...
{
    float TileGenerationRadius;                                                       // 0x00C0 (size: 0x4)
    float TileRemovalRadius;                                                          // 0x00C4 (size: 0x4)
