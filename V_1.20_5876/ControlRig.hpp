...
{
    TArray<FCachedRigElement> BoneIndices;                                            // 0x0000 (size: 0x10)
...
{
    class AActor* ActorToTrack;                                                       // 0x02B0 (size: 0x8)
    TSubclassOf<class UControlRig> ControlRigClass;                                   // 0x02B8 (size: 0x8)
    bool bRefreshOnTick;                                                              // 0x02C0 (size: 0x1)
    bool bIsSelectable;                                                               // 0x02C1 (size: 0x1)
    class UMaterialInterface* MaterialOverride;                                       // 0x02C8 (size: 0x8)
    FString ColorParameter;                                                           // 0x02D0 (size: 0x10)
    bool bCastShadows;                                                                // 0x02E0 (size: 0x1)
    class USceneComponent* ActorRootComponent;                                        // 0x02E8 (size: 0x8)
    class UControlRig* ControlRig;                                                    // 0x02F0 (size: 0x8)
    TArray<FName> ControlNames;                                                       // 0x02F8 (size: 0x10)
    TArray<FTransform> GizmoTransforms;                                               // 0x0308 (size: 0x10)
...
class AControlRigGizmoActor : public AActor
{
    ...
    FName ControlName;                                                                // 0x02C4 (size: 0x8)
    FName ColorParameterName;                                                         // 0x02CC (size: 0x8)
    uint8 bEnabled;                                                                   // 0x02D4 (size: 0x1)
    uint8 bSelected;                                                                  // 0x02D4 (size: 0x1)
    uint8 bSelectable;                                                                // 0x02D4 (size: 0x1)
...
{
    TSubclassOf<class UControlRig> ControlRigClass;                                   // 0x0490 (size: 0x8)
    FControlRigComponentOnPostInitializeDelegate OnPostInitializeDelegate;            // 0x0498 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPreSetupDelegate OnPreSetupDelegate;                        // 0x04A8 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPostSetupDelegate OnPostSetupDelegate;                      // 0x04B8 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPreUpdateDelegate OnPreUpdateDelegate;                      // 0x04C8 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    FControlRigComponentOnPostUpdateDelegate OnPostUpdateDelegate;                    // 0x04D8 (size: 0x10)
    void ControlRigComponentDelegate(class UControlRigComponent* Component);
    TArray<FControlRigComponentMappedElement> MappedElements;                         // 0x04E8 (size: 0x10)
    bool bResetTransformBeforeTick;                                                   // 0x04F8 (size: 0x1)
    bool bResetInitialsBeforeSetup;                                                   // 0x04F9 (size: 0x1)
    bool bUpdateRigOnTick;                                                            // 0x04FA (size: 0x1)
    bool bUpdateInEditor;                                                             // 0x04FB (size: 0x1)
    bool bDrawBones;                                                                  // 0x04FC (size: 0x1)
    class UControlRig* ControlRig;                                                    // 0x0500 (size: 0x8)
...
class UMovieSceneControlRigParameterSection : public UMovieSceneParameterSection
{
    ...
    TArray<bool> ControlsMask;                                                        // 0x0150 (size: 0x10)
    FMovieSceneTransformMask TransformMask;                                           // 0x0160 (size: 0x4)
    bool bAdditive;                                                                   // 0x0164 (size: 0x1)
    bool bApplyBoneFilter;                                                            // 0x0165 (size: 0x1)
    FInputBlendPose BoneFilter;                                                       // 0x0168 (size: 0x10)
    FMovieSceneFloatChannel Weight;                                                   // 0x0178 (size: 0xA0)
    TMap<class FName, class FChannelMapInfo> ControlChannelMap;                       // 0x0218 (size: 0x50)
    TArray<FEnumParameterNameAndCurve> EnumParameterNamesAndCurves;                   // 0x0268 (size: 0x10)
    TArray<FIntegerParameterNameAndCurve> IntegerParameterNamesAndCurves;             // 0x0278 (size: 0x10)

}; // Size: 0x2F0

class UMovieSceneControlRigParameterTrack : public UMovieSceneNameableTrack
{
    class UControlRig* ControlRig;                                                    // 0x0088 (size: 0x8)
    class UMovieSceneSection* SectionToKey;                                           // 0x0090 (size: 0x8)
    TArray<class UMovieSceneSection*> Sections;                                       // 0x0098 (size: 0x10)
    FName TrackName;                                                                  // 0x00A8 (size: 0x8)
