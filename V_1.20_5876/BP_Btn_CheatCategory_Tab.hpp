...
class UBP_Btn_CheatCategory_Tab_C : public UButtonUserWidget
{
    ...
    bool VerticalMenu;                                                                // 0x0867 (size: 0x1)
    bool IsBtnGreyed;                                                                 // 0x0868 (size: 0x1)
    bool IsBtnSelected;                                                               // 0x0869 (size: 0x1)
    bool IsBtnFocused;                                                                // 0x086A (size: 0x1)
    int32 DefaultTextSize;                                                            // 0x086C (size: 0x4)
    int32 TitleTextSize;                                                              // 0x0870 (size: 0x4)
    TEnumAsByte<EHorizontalAlignment> TextAlignment;                                  // 0x0874 (size: 0x1)
    FText PropertyTitleFalse;                                                         // 0x0878 (size: 0x18)
    FText PropertyTitleTrue;                                                          // 0x0890 (size: 0x18)
    bool bUsePropertyValueForTitleText;                                               // 0x08A8 (size: 0x1)
    FBP_Btn_CheatCategory_Tab_COnPropertyUpdateDispatcher OnPropertyUpdateDispatcher; // 0x08B0 (size: 0x10)
