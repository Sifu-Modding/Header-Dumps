...
{
    class UEnvQuery* QueryTemplate;                                                   // 0x0550 (size: 0x8)
    TArray<FEnvNamedValue> QueryParams;                                               // 0x0558 (size: 0x10)
    TArray<FAIDynamicParam> QueryConfig;                                              // 0x0568 (size: 0x10)
    float TimeLimitPerStep;                                                           // 0x0578 (size: 0x4)
    int32 StepToDebugDraw;                                                            // 0x057C (size: 0x4)
    EEnvQueryHightlightMode HighlightMode;                                            // 0x0580 (size: 0x1)
    uint8 bDrawLabels;                                                                // 0x0584 (size: 0x1)
    uint8 bDrawFailedItems;                                                           // 0x0584 (size: 0x1)
    uint8 bReRunQueryOnlyOnFinishedMove;                                              // 0x0584 (size: 0x1)
    uint8 bShouldBeVisibleInGame;                                                     // 0x0584 (size: 0x1)
    uint8 bTickDuringGame;                                                            // 0x0584 (size: 0x1)
    TEnumAsByte<EEnvQueryRunMode::Type> QueryingMode;                                 // 0x0588 (size: 0x1)
    FNavAgentProperties NavAgentProperties;                                           // 0x0590 (size: 0x30)
...
{
    TArray<FNavigationLink> PointLinks;                                               // 0x02C0 (size: 0x10)
    TArray<FNavigationSegmentLink> SegmentLinks;                                      // 0x02D0 (size: 0x10)
    class UNavLinkCustomComponent* SmartLinkComp;                                     // 0x02E0 (size: 0x8)
    bool bSmartLinkIsRelevant;                                                        // 0x02E8 (size: 0x1)
    FNavLinkProxyOnSmartLinkReached OnSmartLinkReached;                               // 0x02F0 (size: 0x10)
...
{
    TArray<class UAISenseConfig*> SensesConfig;                                       // 0x00C0 (size: 0x10)
    TSubclassOf<class UAISense> DominantSense;                                        // 0x00D0 (size: 0x8)
    class AAIController* AIOwner;                                                     // 0x00E8 (size: 0x8)
    FAIPerceptionComponentOnPerceptionUpdated OnPerceptionUpdated;                    // 0x0170 (size: 0x10)
    void PerceptionUpdatedDelegate(const TArray<class AActor*>& UpdatedActors);
    FAIPerceptionComponentOnTargetPerceptionUpdated OnTargetPerceptionUpdated;        // 0x0180 (size: 0x10)
    void ActorPerceptionUpdatedDelegate(class AActor* Actor, FAIStimulus Stimulus);
    FAIPerceptionComponentOnTargetPerceptionInfoUpdated OnTargetPerceptionInfoUpdated; // 0x0190 (size: 0x10)
...
{
    uint8 bAutoRegisterAsSource;                                                      // 0x00C0 (size: 0x1)
    TArray<class TSubclassOf<UAISense>> RegisterAsSourceForSenses;                    // 0x00C8 (size: 0x10)
...
class UAISenseEvent_Sight : public UAISenseEvent
{
    FAISightEvent Event;                                                              // 0x0028 (size: 0x18)
...
{
    TArray<FAISightEvent> RegisteredEvents;                                           // 0x0148 (size: 0x10)
    int32 MaxTracesPerTick;                                                           // 0x0178 (size: 0x4)
    int32 MinQueriesPerTimeSliceCheck;                                                // 0x017C (size: 0x4)
    double MaxTimeSlicePerTick;                                                       // 0x0180 (size: 0x8)
    float HighImportanceQueryDistanceThreshold;                                       // 0x0188 (size: 0x4)
    float MaxQueryImportance;                                                         // 0x0190 (size: 0x4)
    float SightLimitQueryImportance;                                                  // 0x0194 (size: 0x4)
...
class UBTService_RunEQS : public UBTService_BlackboardBase
{
    ...
    bool bWantsBBResetOnQueryFailed;                                                  // 0x00E0 (size: 0x1)
    FBlackboardKeySelector EQSPauseBlackboardKey;                                     // 0x00E8 (size: 0x28)
...
{
    TArray<class UBTNode*> NodeInstances;                                             // 0x0138 (size: 0x10)
...
{
    class UBrainComponent* BrainComp;                                                 // 0x00C0 (size: 0x8)
    class UBlackboardData* DefaultBlackboardAsset;                                    // 0x00C8 (size: 0x8)
    class UBlackboardData* BlackboardAsset;                                           // 0x00D0 (size: 0x8)
    TArray<class UBlackboardKeyType*> KeyInstances;                                   // 0x00F8 (size: 0x10)
...
{
    class UBlackboardComponent* BlackboardComp;                                       // 0x00C8 (size: 0x8)
...
{
    FVector CrowdAgentMoveDirection;                                                  // 0x0278 (size: 0xC)
...
{
    class UNavLocalGridManager* GridManager;                                          // 0x0260 (size: 0x8)
...
{
    class UNavMovementComponent* MovementComp;                                        // 0x00F8 (size: 0x8)
    class ANavigationData* MyNavData;                                                 // 0x0108 (size: 0x8)
...
{
    class APawn* ControlledPawn;                                                      // 0x00C0 (size: 0x8)
    TArray<FPawnActionStack> ActionStacks;                                            // 0x00C8 (size: 0x10)
    TArray<FPawnActionEvent> ActionEvents;                                            // 0x00D8 (size: 0x10)
    class UPawnAction* CurrentAction;                                                 // 0x00E8 (size: 0x8)
...
{
    float HearingThreshold;                                                           // 0x00C0 (size: 0x4)
    float LOSHearingThreshold;                                                        // 0x00C4 (size: 0x4)
    float SightRadius;                                                                // 0x00C8 (size: 0x4)
    float SensingInterval;                                                            // 0x00CC (size: 0x4)
    float HearingMaxSoundAge;                                                         // 0x00D0 (size: 0x4)
    uint8 bEnableSensingUpdates;                                                      // 0x00D4 (size: 0x1)
    uint8 bOnlySensePlayers;                                                          // 0x00D4 (size: 0x1)
    uint8 bSeePawns;                                                                  // 0x00D4 (size: 0x1)
    uint8 bHearNoises;                                                                // 0x00D4 (size: 0x1)
    FPawnSensingComponentOnSeePawn OnSeePawn;                                         // 0x00E0 (size: 0x10)
    void SeePawnDelegate(class APawn* Pawn);
    FPawnSensingComponentOnHearNoise OnHearNoise;                                     // 0x00F0 (size: 0x10)
    void HearNoiseDelegate(class APawn* Instigator, const FVector& Location, float Volume);
    float PeripheralVisionAngle;                                                      // 0x0100 (size: 0x4)
    float PeripheralVisionCosine;                                                     // 0x0104 (size: 0x4)
