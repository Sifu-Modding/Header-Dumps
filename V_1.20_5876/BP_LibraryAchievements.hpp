...
class UBP_LibraryAchievements_C : public UBlueprintFunctionLibrary
{
    ...
    void PlatformPercentageCompletion(int32 bpp__Value__pf, int32 bpp__CompletionValue__pf, class UObject* bpp____WorldContext__pf, float& bpp__Percentage__pf, float& bpp__Debug__pf);
