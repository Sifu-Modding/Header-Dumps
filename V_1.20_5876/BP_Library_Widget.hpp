...
class UBP_Library_Widget_C : public UBlueprintFunctionLibrary
{
    ...
    void Get EllipticPosition(FVector2D bpp__Radius__pf, float bpp__Angle__pf, class UObject* bpp____WorldContext__pf, FVector2D& bpp__Pos2D__pf);
    void GetWidgetRatio(FGeometry bpp__WidgetSize__pf, class UObject* bpp____WorldContext__pf, FVector2D& bpp__WidgetRatio__pf);
    void GetScreenCenter2DPos(class UObject* bpp____WorldContext__pf, FVector2D& bpp__2DPos__pf);
    void GetScreenAngle(FVector2D bpp__2DPos__pf, class UObject* bpp____WorldContext__pf, float& bpp__Angle__pf);
