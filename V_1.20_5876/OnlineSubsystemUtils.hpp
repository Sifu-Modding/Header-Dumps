...
{
    float BeaconConnectionInitialTimeout;                                             // 0x02B8 (size: 0x4)
    float BeaconConnectionTimeout;                                                    // 0x02BC (size: 0x4)
    class UNetDriver* NetDriver;                                                      // 0x02C0 (size: 0x8)

}; // Size: 0x2E0

class AOnlineBeaconClient : public AOnlineBeacon
{
    class AOnlineBeaconHostObject* BeaconOwner;                                       // 0x02E0 (size: 0x8)
    class UNetConnection* BeaconConnection;                                           // 0x02E8 (size: 0x8)
    EBeaconConnectionState ConnectionState;                                           // 0x02F0 (size: 0x1)
...
{
    int32 ListenPort;                                                                 // 0x02E0 (size: 0x4)
    TArray<class AOnlineBeaconClient*> ClientActors;                                  // 0x02E8 (size: 0x10)

}; // Size: 0x3A0

class AOnlineBeaconHostObject : public AActor
{
    FString BeaconTypeName;                                                           // 0x02B0 (size: 0x10)
    TSubclassOf<class AOnlineBeaconClient> ClientBeaconActorClass;                    // 0x02C0 (size: 0x8)
    TArray<class AOnlineBeaconClient*> ClientActors;                                  // 0x02C8 (size: 0x10)

}; // Size: 0x2E0

class APartyBeaconClient : public AOnlineBeaconClient
{
    FString DestSessionId;                                                            // 0x0370 (size: 0x10)
    FPartyReservation PendingReservation;                                             // 0x0380 (size: 0x50)
...
{
    class UPartyBeaconState* State;                                                   // 0x02D8 (size: 0x8)
    bool bLogoutOnSessionTimeout;                                                     // 0x0340 (size: 0x1)
    float SessionTimeoutSecs;                                                         // 0x0344 (size: 0x4)
    float TravelSessionTimeoutSecs;                                                   // 0x0348 (size: 0x4)
...
{
    FString DestSessionId;                                                            // 0x0370 (size: 0x10)
    FSpectatorReservation PendingReservation;                                         // 0x0380 (size: 0x78)
    ESpectatorClientRequestType RequestType;                                          // 0x03F8 (size: 0x1)
    bool bPendingReservationSent;                                                     // 0x03F9 (size: 0x1)
    bool bCancelReservation;                                                          // 0x03FA (size: 0x1)
...
{
    class USpectatorBeaconState* State;                                               // 0x02D8 (size: 0x8)
    bool bLogoutOnSessionTimeout;                                                     // 0x0340 (size: 0x1)
    float SessionTimeoutSecs;                                                         // 0x0344 (size: 0x4)
    float TravelSessionTimeoutSecs;                                                   // 0x0348 (size: 0x4)
...
{
    float SocketErrorDisconnectDelay;                                                 // 0x1B90 (size: 0x4)
