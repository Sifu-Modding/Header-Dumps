...
class UBP_Menu_Options_Gameplay_C : public UGameplayOptionsMenu
{
    ...
    class UBP_Btn_SpinBox_C* AdvancedVibration;
    class UHorizontalBox* Border_InputsnoAnim;
    class UBP_Menu_Option_InfoPanel_C* BP_Menu_Option_InfoPanel;
    class UBP_Btn_SpinBox_Clicked_C* Btn_Difficulty;
    class UBP_Btn_SpinBox_C* CameraAnimDrivenSurrounding;
    class UBP_Btn_SpinBox_C* CameraShake;
    class UBP_Btn_SpinBox_C* CameraSpeed;
    class UScrollBox* GameplayScroll;
    class UBP_Btn_SpinBox_C* HideClueVFX;
    class UBP_Btn_InputTip_C* InputTip_Back;
    class UBP_Btn_InputTip_C* InputTip_Default;
    class UBP_Btn_SpinBox_C* InvertCameraX;
    class UBP_Btn_SpinBox_C* InvertCameraY;
    class UBP_Btn_SpinBox_C* SmoothEffect;
    class UBP_Btn_SpinBox_C* Vibration;
    float ValueHUDSize;
