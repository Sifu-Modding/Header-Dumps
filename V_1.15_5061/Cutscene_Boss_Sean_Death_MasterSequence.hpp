#ifndef UE4SS_SDK_Cutscene_Boss_Sean_Death_MasterSequence_HPP
#define UE4SS_SDK_Cutscene_Boss_Sean_Death_MasterSequence_HPP
...
class USequenceDirector_C : public UWGLevelSequence
{
    ...
    void SequenceEvent_SetMusicState();
